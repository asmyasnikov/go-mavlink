...
func (e ACCELCAL_VEHICLE_POS) String() string {
	...
	case ACCELCAL_VEHICLE_POS_LEVEL:
		return "ACCELCAL_VEHICLE_POS_LEVEL"
	case ACCELCAL_VEHICLE_POS_LEFT:
		return "ACCELCAL_VEHICLE_POS_LEFT"
	case ACCELCAL_VEHICLE_POS_RIGHT:
		return "ACCELCAL_VEHICLE_POS_RIGHT"
	case ACCELCAL_VEHICLE_POS_NOSEDOWN:
		return "ACCELCAL_VEHICLE_POS_NOSEDOWN"
	case ACCELCAL_VEHICLE_POS_NOSEUP:
		return "ACCELCAL_VEHICLE_POS_NOSEUP"
	case ACCELCAL_VEHICLE_POS_BACK:
		return "ACCELCAL_VEHICLE_POS_BACK"
	case ACCELCAL_VEHICLE_POS_SUCCESS:
		return "ACCELCAL_VEHICLE_POS_SUCCESS"
	case ACCELCAL_VEHICLE_POS_FAILED:
		return "ACCELCAL_VEHICLE_POS_FAILED"
	default:
		return fmt.Sprintf("ACCELCAL_VEHICLE_POS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e HEADING_TYPE) String() string {
	...
	case HEADING_TYPE_COURSE_OVER_GROUND:
		return "HEADING_TYPE_COURSE_OVER_GROUND"
	case HEADING_TYPE_HEADING:
		return "HEADING_TYPE_HEADING"
	default:
		return fmt.Sprintf("HEADING_TYPE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e SPEED_TYPE) String() string {
	...
	case SPEED_TYPE_AIRSPEED:
		return "SPEED_TYPE_AIRSPEED"
	case SPEED_TYPE_GROUNDSPEED:
		return "SPEED_TYPE_GROUNDSPEED"
	default:
...
func (e MAV_CMD) String() string {
	...
	case MAV_CMD_DO_SET_RESUME_REPEAT_DIST:
		return "MAV_CMD_DO_SET_RESUME_REPEAT_DIST"
	case MAV_CMD_NAV_ALTITUDE_WAIT:
		return "MAV_CMD_NAV_ALTITUDE_WAIT"
	case MAV_CMD_POWER_OFF_INITIATED:
		return "MAV_CMD_POWER_OFF_INITIATED"
	case MAV_CMD_SOLO_BTN_FLY_CLICK:
		return "MAV_CMD_SOLO_BTN_FLY_CLICK"
	case MAV_CMD_SOLO_BTN_FLY_HOLD:
		return "MAV_CMD_SOLO_BTN_FLY_HOLD"
	case MAV_CMD_SOLO_BTN_PAUSE_CLICK:
		return "MAV_CMD_SOLO_BTN_PAUSE_CLICK"
	case MAV_CMD_FIXED_MAG_CAL:
		return "MAV_CMD_FIXED_MAG_CAL"
	case MAV_CMD_FIXED_MAG_CAL_FIELD:
		return "MAV_CMD_FIXED_MAG_CAL_FIELD"
	case MAV_CMD_DO_START_MAG_CAL:
		return "MAV_CMD_DO_START_MAG_CAL"
	case MAV_CMD_DO_ACCEPT_MAG_CAL:
		return "MAV_CMD_DO_ACCEPT_MAG_CAL"
	case MAV_CMD_DO_CANCEL_MAG_CAL:
		return "MAV_CMD_DO_CANCEL_MAG_CAL"
	case MAV_CMD_ACCELCAL_VEHICLE_POS:
		return "MAV_CMD_ACCELCAL_VEHICLE_POS"
	case MAV_CMD_DO_SEND_BANNER:
		return "MAV_CMD_DO_SEND_BANNER"
	case MAV_CMD_SET_FACTORY_TEST_MODE:
		return "MAV_CMD_SET_FACTORY_TEST_MODE"
	case MAV_CMD_GIMBAL_RESET:
		return "MAV_CMD_GIMBAL_RESET"
	case MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS:
		return "MAV_CMD_GIMBAL_AXIS_CALIBRATION_STATUS"
	case MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION:
		return "MAV_CMD_GIMBAL_REQUEST_AXIS_CALIBRATION"
	case MAV_CMD_GIMBAL_FULL_RESET:
		return "MAV_CMD_GIMBAL_FULL_RESET"
	case MAV_CMD_FLASH_BOOTLOADER:
		return "MAV_CMD_FLASH_BOOTLOADER"
	case MAV_CMD_BATTERY_RESET:
		return "MAV_CMD_BATTERY_RESET"
	case MAV_CMD_DEBUG_TRAP:
		return "MAV_CMD_DEBUG_TRAP"
	case MAV_CMD_SCRIPTING:
		return "MAV_CMD_SCRIPTING"
	case MAV_CMD_GUIDED_CHANGE_SPEED:
		return "MAV_CMD_GUIDED_CHANGE_SPEED"
	case MAV_CMD_GUIDED_CHANGE_ALTITUDE:
		return "MAV_CMD_GUIDED_CHANGE_ALTITUDE"
	case MAV_CMD_GUIDED_CHANGE_HEADING:
		return "MAV_CMD_GUIDED_CHANGE_HEADING"
	...
	case MAV_CMD_DO_SET_ACTUATOR:
		return "MAV_CMD_DO_SET_ACTUATOR"
	...
	case MAV_CMD_DO_SET_ROI_SYSID:
		return "MAV_CMD_DO_SET_ROI_SYSID"
	...
	case MAV_CMD_DO_GRIPPER:
		return "MAV_CMD_DO_GRIPPER"
	case MAV_CMD_DO_AUTOTUNE_ENABLE:
		return "MAV_CMD_DO_AUTOTUNE_ENABLE"
	...
	case MAV_CMD_PARAM_TRANSACTION:
		return "MAV_CMD_PARAM_TRANSACTION"
	case MAV_CMD_DO_GIMBAL_MANAGER_PITCHYAW:
		return "MAV_CMD_DO_GIMBAL_MANAGER_PITCHYAW"
	case MAV_CMD_DO_GIMBAL_MANAGER_CONFIGURE:
		return "MAV_CMD_DO_GIMBAL_MANAGER_CONFIGURE"
	...
	case MAV_CMD_CAMERA_TRACK_POINT:
		return "MAV_CMD_CAMERA_TRACK_POINT"
	case MAV_CMD_CAMERA_TRACK_RECTANGLE:
		return "MAV_CMD_CAMERA_TRACK_RECTANGLE"
	case MAV_CMD_CAMERA_STOP_TRACKING:
		return "MAV_CMD_CAMERA_STOP_TRACKING"
	...
	case MAV_CMD_FIXED_MAG_CAL_YAW:
		return "MAV_CMD_FIXED_MAG_CAL_YAW"
	case MAV_CMD_DO_WINCH:
		return "MAV_CMD_DO_WINCH"
...
func (e SCRIPTING_CMD) String() string {
	...
	case SCRIPTING_CMD_REPL_START:
		return "SCRIPTING_CMD_REPL_START"
	case SCRIPTING_CMD_REPL_STOP:
		return "SCRIPTING_CMD_REPL_STOP"
	default:
...
func (e LIMITS_STATE) String() string {
	...
	case LIMITS_TRIGGERED:
		return "LIMITS_TRIGGERED"
	case LIMITS_RECOVERING:
		return "LIMITS_RECOVERING"
	case LIMITS_RECOVERED:
		return "LIMITS_RECOVERED"
	default:
		return fmt.Sprintf("LIMITS_STATE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e LIMIT_MODULE) String() string {
	switch e {
	case LIMIT_GPSLOCK:
		return "LIMIT_GPSLOCK"
	case LIMIT_GEOFENCE:
		return "LIMIT_GEOFENCE"
	case LIMIT_ALTITUDE:
		return "LIMIT_ALTITUDE"
	default:
		return fmt.Sprintf("LIMIT_MODULE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e CAMERA_STATUS_TYPES) String() string {
	...
	case CAMERA_STATUS_TYPE_HEARTBEAT:
		return "CAMERA_STATUS_TYPE_HEARTBEAT"
	case CAMERA_STATUS_TYPE_TRIGGER:
		return "CAMERA_STATUS_TYPE_TRIGGER"
	case CAMERA_STATUS_TYPE_DISCONNECT:
		return "CAMERA_STATUS_TYPE_DISCONNECT"
	case CAMERA_STATUS_TYPE_ERROR:
		return "CAMERA_STATUS_TYPE_ERROR"
	case CAMERA_STATUS_TYPE_LOWBATT:
		return "CAMERA_STATUS_TYPE_LOWBATT"
	case CAMERA_STATUS_TYPE_LOWSTORE:
		return "CAMERA_STATUS_TYPE_LOWSTORE"
	case CAMERA_STATUS_TYPE_LOWSTOREV:
		return "CAMERA_STATUS_TYPE_LOWSTOREV"
	default:
		return fmt.Sprintf("CAMERA_STATUS_TYPES_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e CAMERA_FEEDBACK_FLAGS) String() string {
	...
	case CAMERA_FEEDBACK_PHOTO:
		return "CAMERA_FEEDBACK_PHOTO"
	case CAMERA_FEEDBACK_VIDEO:
		return "CAMERA_FEEDBACK_VIDEO"
	case CAMERA_FEEDBACK_BADEXPOSURE:
		return "CAMERA_FEEDBACK_BADEXPOSURE"
	case CAMERA_FEEDBACK_CLOSEDLOOP:
		return "CAMERA_FEEDBACK_CLOSEDLOOP"
	case CAMERA_FEEDBACK_OPENLOOP:
		return "CAMERA_FEEDBACK_OPENLOOP"
	default:
...
func (e MAV_MODE_GIMBAL) String() string {
	...
	case MAV_MODE_GIMBAL_UNINITIALIZED:
		return "MAV_MODE_GIMBAL_UNINITIALIZED"
	case MAV_MODE_GIMBAL_CALIBRATING_PITCH:
		return "MAV_MODE_GIMBAL_CALIBRATING_PITCH"
	case MAV_MODE_GIMBAL_CALIBRATING_ROLL:
		return "MAV_MODE_GIMBAL_CALIBRATING_ROLL"
	case MAV_MODE_GIMBAL_CALIBRATING_YAW:
		return "MAV_MODE_GIMBAL_CALIBRATING_YAW"
	case MAV_MODE_GIMBAL_INITIALIZED:
		return "MAV_MODE_GIMBAL_INITIALIZED"
	case MAV_MODE_GIMBAL_ACTIVE:
		return "MAV_MODE_GIMBAL_ACTIVE"
	case MAV_MODE_GIMBAL_RATE_CMD_TIMEOUT:
		return "MAV_MODE_GIMBAL_RATE_CMD_TIMEOUT"
	default:
		return fmt.Sprintf("MAV_MODE_GIMBAL_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GIMBAL_AXIS) String() string {
	...
	case GIMBAL_AXIS_YAW:
		return "GIMBAL_AXIS_YAW"
	case GIMBAL_AXIS_PITCH:
		return "GIMBAL_AXIS_PITCH"
	case GIMBAL_AXIS_ROLL:
		return "GIMBAL_AXIS_ROLL"
	default:
...
func (e GIMBAL_AXIS_CALIBRATION_STATUS) String() string {
	...
	case GIMBAL_AXIS_CALIBRATION_STATUS_IN_PROGRESS:
		return "GIMBAL_AXIS_CALIBRATION_STATUS_IN_PROGRESS"
	case GIMBAL_AXIS_CALIBRATION_STATUS_SUCCEEDED:
		return "GIMBAL_AXIS_CALIBRATION_STATUS_SUCCEEDED"
	case GIMBAL_AXIS_CALIBRATION_STATUS_FAILED:
		return "GIMBAL_AXIS_CALIBRATION_STATUS_FAILED"
	default:
		return fmt.Sprintf("GIMBAL_AXIS_CALIBRATION_STATUS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GIMBAL_AXIS_CALIBRATION_REQUIRED) String() string {
	...
	case GIMBAL_AXIS_CALIBRATION_REQUIRED_UNKNOWN:
		return "GIMBAL_AXIS_CALIBRATION_REQUIRED_UNKNOWN"
	case GIMBAL_AXIS_CALIBRATION_REQUIRED_TRUE:
		return "GIMBAL_AXIS_CALIBRATION_REQUIRED_TRUE"
	case GIMBAL_AXIS_CALIBRATION_REQUIRED_FALSE:
		return "GIMBAL_AXIS_CALIBRATION_REQUIRED_FALSE"
	default:
...
func (e GOPRO_HEARTBEAT_STATUS) String() string {
	...
	default:
		return fmt.Sprintf("GOPRO_HEARTBEAT_STATUS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_REQUEST_STATUS) String() string {
	...
	case GOPRO_REQUEST_SUCCESS:
		return "GOPRO_REQUEST_SUCCESS"
	case GOPRO_REQUEST_FAILED:
		return "GOPRO_REQUEST_FAILED"
	default:
...
func (e GOPRO_COMMAND) String() string {
	...
	case GOPRO_COMMAND_POWER:
		return "GOPRO_COMMAND_POWER"
	case GOPRO_COMMAND_CAPTURE_MODE:
		return "GOPRO_COMMAND_CAPTURE_MODE"
	case GOPRO_COMMAND_SHUTTER:
		return "GOPRO_COMMAND_SHUTTER"
	case GOPRO_COMMAND_BATTERY:
		return "GOPRO_COMMAND_BATTERY"
	case GOPRO_COMMAND_MODEL:
		return "GOPRO_COMMAND_MODEL"
	case GOPRO_COMMAND_VIDEO_SETTINGS:
		return "GOPRO_COMMAND_VIDEO_SETTINGS"
	case GOPRO_COMMAND_LOW_LIGHT:
		return "GOPRO_COMMAND_LOW_LIGHT"
	case GOPRO_COMMAND_PHOTO_RESOLUTION:
		return "GOPRO_COMMAND_PHOTO_RESOLUTION"
	case GOPRO_COMMAND_PHOTO_BURST_RATE:
		return "GOPRO_COMMAND_PHOTO_BURST_RATE"
	case GOPRO_COMMAND_PROTUNE:
		return "GOPRO_COMMAND_PROTUNE"
	case GOPRO_COMMAND_PROTUNE_WHITE_BALANCE:
		return "GOPRO_COMMAND_PROTUNE_WHITE_BALANCE"
	case GOPRO_COMMAND_PROTUNE_COLOUR:
		return "GOPRO_COMMAND_PROTUNE_COLOUR"
	case GOPRO_COMMAND_PROTUNE_GAIN:
		return "GOPRO_COMMAND_PROTUNE_GAIN"
	case GOPRO_COMMAND_PROTUNE_SHARPNESS:
		return "GOPRO_COMMAND_PROTUNE_SHARPNESS"
	case GOPRO_COMMAND_PROTUNE_EXPOSURE:
		return "GOPRO_COMMAND_PROTUNE_EXPOSURE"
	case GOPRO_COMMAND_TIME:
		return "GOPRO_COMMAND_TIME"
	case GOPRO_COMMAND_CHARGING:
		return "GOPRO_COMMAND_CHARGING"
	default:
		return fmt.Sprintf("GOPRO_COMMAND_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_CAPTURE_MODE) String() string {
	...
	case GOPRO_CAPTURE_MODE_VIDEO:
		return "GOPRO_CAPTURE_MODE_VIDEO"
	case GOPRO_CAPTURE_MODE_PHOTO:
		return "GOPRO_CAPTURE_MODE_PHOTO"
	case GOPRO_CAPTURE_MODE_BURST:
		return "GOPRO_CAPTURE_MODE_BURST"
	case GOPRO_CAPTURE_MODE_TIME_LAPSE:
		return "GOPRO_CAPTURE_MODE_TIME_LAPSE"
	case GOPRO_CAPTURE_MODE_MULTI_SHOT:
		return "GOPRO_CAPTURE_MODE_MULTI_SHOT"
	case GOPRO_CAPTURE_MODE_PLAYBACK:
		return "GOPRO_CAPTURE_MODE_PLAYBACK"
	case GOPRO_CAPTURE_MODE_SETUP:
		return "GOPRO_CAPTURE_MODE_SETUP"
	case GOPRO_CAPTURE_MODE_UNKNOWN:
		return "GOPRO_CAPTURE_MODE_UNKNOWN"
	default:
...
func (e GOPRO_RESOLUTION) String() string {
	...
	case GOPRO_RESOLUTION_480p:
		return "GOPRO_RESOLUTION_480p"
	case GOPRO_RESOLUTION_720p:
		return "GOPRO_RESOLUTION_720p"
	case GOPRO_RESOLUTION_960p:
		return "GOPRO_RESOLUTION_960p"
	case GOPRO_RESOLUTION_1080p:
		return "GOPRO_RESOLUTION_1080p"
	case GOPRO_RESOLUTION_1440p:
		return "GOPRO_RESOLUTION_1440p"
	case GOPRO_RESOLUTION_2_7k_17_9:
		return "GOPRO_RESOLUTION_2_7k_17_9"
	case GOPRO_RESOLUTION_2_7k_16_9:
		return "GOPRO_RESOLUTION_2_7k_16_9"
	case GOPRO_RESOLUTION_2_7k_4_3:
		return "GOPRO_RESOLUTION_2_7k_4_3"
	case GOPRO_RESOLUTION_4k_16_9:
		return "GOPRO_RESOLUTION_4k_16_9"
	case GOPRO_RESOLUTION_4k_17_9:
		return "GOPRO_RESOLUTION_4k_17_9"
	case GOPRO_RESOLUTION_720p_SUPERVIEW:
		return "GOPRO_RESOLUTION_720p_SUPERVIEW"
	case GOPRO_RESOLUTION_1080p_SUPERVIEW:
		return "GOPRO_RESOLUTION_1080p_SUPERVIEW"
	case GOPRO_RESOLUTION_2_7k_SUPERVIEW:
		return "GOPRO_RESOLUTION_2_7k_SUPERVIEW"
	case GOPRO_RESOLUTION_4k_SUPERVIEW:
		return "GOPRO_RESOLUTION_4k_SUPERVIEW"
	default:
		return fmt.Sprintf("GOPRO_RESOLUTION_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_FRAME_RATE) String() string {
	...
	case GOPRO_FRAME_RATE_12:
		return "GOPRO_FRAME_RATE_12"
	case GOPRO_FRAME_RATE_15:
		return "GOPRO_FRAME_RATE_15"
	case GOPRO_FRAME_RATE_24:
		return "GOPRO_FRAME_RATE_24"
	case GOPRO_FRAME_RATE_25:
		return "GOPRO_FRAME_RATE_25"
	case GOPRO_FRAME_RATE_30:
		return "GOPRO_FRAME_RATE_30"
	case GOPRO_FRAME_RATE_48:
		return "GOPRO_FRAME_RATE_48"
	case GOPRO_FRAME_RATE_50:
		return "GOPRO_FRAME_RATE_50"
	case GOPRO_FRAME_RATE_60:
		return "GOPRO_FRAME_RATE_60"
	case GOPRO_FRAME_RATE_80:
		return "GOPRO_FRAME_RATE_80"
	case GOPRO_FRAME_RATE_90:
		return "GOPRO_FRAME_RATE_90"
	case GOPRO_FRAME_RATE_100:
		return "GOPRO_FRAME_RATE_100"
	case GOPRO_FRAME_RATE_120:
		return "GOPRO_FRAME_RATE_120"
	case GOPRO_FRAME_RATE_240:
		return "GOPRO_FRAME_RATE_240"
	case GOPRO_FRAME_RATE_12_5:
		return "GOPRO_FRAME_RATE_12_5"
	default:
		return fmt.Sprintf("GOPRO_FRAME_RATE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_FIELD_OF_VIEW) String() string {
	...
	case GOPRO_FIELD_OF_VIEW_WIDE:
		return "GOPRO_FIELD_OF_VIEW_WIDE"
	case GOPRO_FIELD_OF_VIEW_MEDIUM:
		return "GOPRO_FIELD_OF_VIEW_MEDIUM"
	case GOPRO_FIELD_OF_VIEW_NARROW:
		return "GOPRO_FIELD_OF_VIEW_NARROW"
	default:
		return fmt.Sprintf("GOPRO_FIELD_OF_VIEW_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_VIDEO_SETTINGS_FLAGS) String() string {
	...
	case GOPRO_VIDEO_SETTINGS_TV_MODE:
		return "GOPRO_VIDEO_SETTINGS_TV_MODE"
	default:
...
func (e GOPRO_PHOTO_RESOLUTION) String() string {
	...
	case GOPRO_PHOTO_RESOLUTION_5MP_MEDIUM:
		return "GOPRO_PHOTO_RESOLUTION_5MP_MEDIUM"
	case GOPRO_PHOTO_RESOLUTION_7MP_MEDIUM:
		return "GOPRO_PHOTO_RESOLUTION_7MP_MEDIUM"
	case GOPRO_PHOTO_RESOLUTION_7MP_WIDE:
		return "GOPRO_PHOTO_RESOLUTION_7MP_WIDE"
	case GOPRO_PHOTO_RESOLUTION_10MP_WIDE:
		return "GOPRO_PHOTO_RESOLUTION_10MP_WIDE"
	case GOPRO_PHOTO_RESOLUTION_12MP_WIDE:
		return "GOPRO_PHOTO_RESOLUTION_12MP_WIDE"
	default:
		return fmt.Sprintf("GOPRO_PHOTO_RESOLUTION_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_PROTUNE_WHITE_BALANCE) String() string {
	...
	case GOPRO_PROTUNE_WHITE_BALANCE_AUTO:
		return "GOPRO_PROTUNE_WHITE_BALANCE_AUTO"
	case GOPRO_PROTUNE_WHITE_BALANCE_3000K:
		return "GOPRO_PROTUNE_WHITE_BALANCE_3000K"
	case GOPRO_PROTUNE_WHITE_BALANCE_5500K:
		return "GOPRO_PROTUNE_WHITE_BALANCE_5500K"
	case GOPRO_PROTUNE_WHITE_BALANCE_6500K:
		return "GOPRO_PROTUNE_WHITE_BALANCE_6500K"
	case GOPRO_PROTUNE_WHITE_BALANCE_RAW:
		return "GOPRO_PROTUNE_WHITE_BALANCE_RAW"
	default:
		return fmt.Sprintf("GOPRO_PROTUNE_WHITE_BALANCE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_PROTUNE_COLOUR) String() string {
	...
	case GOPRO_PROTUNE_COLOUR_STANDARD:
		return "GOPRO_PROTUNE_COLOUR_STANDARD"
	case GOPRO_PROTUNE_COLOUR_NEUTRAL:
		return "GOPRO_PROTUNE_COLOUR_NEUTRAL"
	default:
...
func (e GOPRO_PROTUNE_GAIN) String() string {
	...
	case GOPRO_PROTUNE_GAIN_400:
		return "GOPRO_PROTUNE_GAIN_400"
	case GOPRO_PROTUNE_GAIN_800:
		return "GOPRO_PROTUNE_GAIN_800"
	case GOPRO_PROTUNE_GAIN_1600:
		return "GOPRO_PROTUNE_GAIN_1600"
	case GOPRO_PROTUNE_GAIN_3200:
		return "GOPRO_PROTUNE_GAIN_3200"
	case GOPRO_PROTUNE_GAIN_6400:
		return "GOPRO_PROTUNE_GAIN_6400"
	default:
		return fmt.Sprintf("GOPRO_PROTUNE_GAIN_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_PROTUNE_SHARPNESS) String() string {
	...
	case GOPRO_PROTUNE_SHARPNESS_LOW:
		return "GOPRO_PROTUNE_SHARPNESS_LOW"
	case GOPRO_PROTUNE_SHARPNESS_MEDIUM:
		return "GOPRO_PROTUNE_SHARPNESS_MEDIUM"
	case GOPRO_PROTUNE_SHARPNESS_HIGH:
		return "GOPRO_PROTUNE_SHARPNESS_HIGH"
	default:
...
func (e GOPRO_PROTUNE_EXPOSURE) String() string {
	...
	case GOPRO_PROTUNE_EXPOSURE_NEG_5_0:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_5_0"
	case GOPRO_PROTUNE_EXPOSURE_NEG_4_5:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_4_5"
	case GOPRO_PROTUNE_EXPOSURE_NEG_4_0:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_4_0"
	case GOPRO_PROTUNE_EXPOSURE_NEG_3_5:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_3_5"
	case GOPRO_PROTUNE_EXPOSURE_NEG_3_0:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_3_0"
	case GOPRO_PROTUNE_EXPOSURE_NEG_2_5:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_2_5"
	case GOPRO_PROTUNE_EXPOSURE_NEG_2_0:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_2_0"
	case GOPRO_PROTUNE_EXPOSURE_NEG_1_5:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_1_5"
	case GOPRO_PROTUNE_EXPOSURE_NEG_1_0:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_1_0"
	case GOPRO_PROTUNE_EXPOSURE_NEG_0_5:
		return "GOPRO_PROTUNE_EXPOSURE_NEG_0_5"
	case GOPRO_PROTUNE_EXPOSURE_ZERO:
		return "GOPRO_PROTUNE_EXPOSURE_ZERO"
	case GOPRO_PROTUNE_EXPOSURE_POS_0_5:
		return "GOPRO_PROTUNE_EXPOSURE_POS_0_5"
	case GOPRO_PROTUNE_EXPOSURE_POS_1_0:
		return "GOPRO_PROTUNE_EXPOSURE_POS_1_0"
	case GOPRO_PROTUNE_EXPOSURE_POS_1_5:
		return "GOPRO_PROTUNE_EXPOSURE_POS_1_5"
	case GOPRO_PROTUNE_EXPOSURE_POS_2_0:
		return "GOPRO_PROTUNE_EXPOSURE_POS_2_0"
	case GOPRO_PROTUNE_EXPOSURE_POS_2_5:
		return "GOPRO_PROTUNE_EXPOSURE_POS_2_5"
	case GOPRO_PROTUNE_EXPOSURE_POS_3_0:
		return "GOPRO_PROTUNE_EXPOSURE_POS_3_0"
	case GOPRO_PROTUNE_EXPOSURE_POS_3_5:
		return "GOPRO_PROTUNE_EXPOSURE_POS_3_5"
	case GOPRO_PROTUNE_EXPOSURE_POS_4_0:
		return "GOPRO_PROTUNE_EXPOSURE_POS_4_0"
	case GOPRO_PROTUNE_EXPOSURE_POS_4_5:
		return "GOPRO_PROTUNE_EXPOSURE_POS_4_5"
	case GOPRO_PROTUNE_EXPOSURE_POS_5_0:
		return "GOPRO_PROTUNE_EXPOSURE_POS_5_0"
	default:
		return fmt.Sprintf("GOPRO_PROTUNE_EXPOSURE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e GOPRO_CHARGING) String() string {
	...
	case GOPRO_CHARGING_DISABLED:
		return "GOPRO_CHARGING_DISABLED"
	case GOPRO_CHARGING_ENABLED:
		return "GOPRO_CHARGING_ENABLED"
	default:
...
func (e GOPRO_MODEL) String() string {
	...
	case GOPRO_MODEL_UNKNOWN:
		return "GOPRO_MODEL_UNKNOWN"
	case GOPRO_MODEL_HERO_3_PLUS_SILVER:
		return "GOPRO_MODEL_HERO_3_PLUS_SILVER"
	case GOPRO_MODEL_HERO_3_PLUS_BLACK:
		return "GOPRO_MODEL_HERO_3_PLUS_BLACK"
	case GOPRO_MODEL_HERO_4_SILVER:
		return "GOPRO_MODEL_HERO_4_SILVER"
	case GOPRO_MODEL_HERO_4_BLACK:
		return "GOPRO_MODEL_HERO_4_BLACK"
	default:
...
func (e GOPRO_BURST_RATE) String() string {
	...
	case GOPRO_BURST_RATE_3_IN_1_SECOND:
		return "GOPRO_BURST_RATE_3_IN_1_SECOND"
	case GOPRO_BURST_RATE_5_IN_1_SECOND:
		return "GOPRO_BURST_RATE_5_IN_1_SECOND"
	case GOPRO_BURST_RATE_10_IN_1_SECOND:
		return "GOPRO_BURST_RATE_10_IN_1_SECOND"
	case GOPRO_BURST_RATE_10_IN_2_SECOND:
		return "GOPRO_BURST_RATE_10_IN_2_SECOND"
	case GOPRO_BURST_RATE_10_IN_3_SECOND:
		return "GOPRO_BURST_RATE_10_IN_3_SECOND"
	case GOPRO_BURST_RATE_30_IN_1_SECOND:
		return "GOPRO_BURST_RATE_30_IN_1_SECOND"
	case GOPRO_BURST_RATE_30_IN_2_SECOND:
		return "GOPRO_BURST_RATE_30_IN_2_SECOND"
	case GOPRO_BURST_RATE_30_IN_3_SECOND:
		return "GOPRO_BURST_RATE_30_IN_3_SECOND"
	case GOPRO_BURST_RATE_30_IN_6_SECOND:
		return "GOPRO_BURST_RATE_30_IN_6_SECOND"
	default:
		return fmt.Sprintf("GOPRO_BURST_RATE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e LED_CONTROL_PATTERN) String() string {
	...
	case LED_CONTROL_PATTERN_OFF:
		return "LED_CONTROL_PATTERN_OFF"
	case LED_CONTROL_PATTERN_FIRMWAREUPDATE:
		return "LED_CONTROL_PATTERN_FIRMWAREUPDATE"
	case LED_CONTROL_PATTERN_CUSTOM:
		return "LED_CONTROL_PATTERN_CUSTOM"
	default:
...
func (e EKF_STATUS_FLAGS) String() string {
	...
	case EKF_VELOCITY_HORIZ:
		return "EKF_VELOCITY_HORIZ"
	case EKF_VELOCITY_VERT:
		return "EKF_VELOCITY_VERT"
	case EKF_POS_HORIZ_REL:
		return "EKF_POS_HORIZ_REL"
	case EKF_POS_HORIZ_ABS:
		return "EKF_POS_HORIZ_ABS"
	case EKF_POS_VERT_ABS:
		return "EKF_POS_VERT_ABS"
	case EKF_POS_VERT_AGL:
		return "EKF_POS_VERT_AGL"
	case EKF_CONST_POS_MODE:
		return "EKF_CONST_POS_MODE"
	case EKF_PRED_POS_HORIZ_REL:
		return "EKF_PRED_POS_HORIZ_REL"
	case EKF_PRED_POS_HORIZ_ABS:
		return "EKF_PRED_POS_HORIZ_ABS"
	case EKF_UNINITIALIZED:
		return "EKF_UNINITIALIZED"
	default:
		return fmt.Sprintf("EKF_STATUS_FLAGS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e PID_TUNING_AXIS) String() string {
	...
	case PID_TUNING_ROLL:
		return "PID_TUNING_ROLL"
	case PID_TUNING_PITCH:
		return "PID_TUNING_PITCH"
	case PID_TUNING_YAW:
		return "PID_TUNING_YAW"
	case PID_TUNING_ACCZ:
		return "PID_TUNING_ACCZ"
	case PID_TUNING_STEER:
		return "PID_TUNING_STEER"
	case PID_TUNING_LANDING:
		return "PID_TUNING_LANDING"
	default:
		return fmt.Sprintf("PID_TUNING_AXIS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS) String() string {
	...
	case MAV_REMOTE_LOG_DATA_BLOCK_STOP:
		return "MAV_REMOTE_LOG_DATA_BLOCK_STOP"
	case MAV_REMOTE_LOG_DATA_BLOCK_START:
		return "MAV_REMOTE_LOG_DATA_BLOCK_START"
	default:
...
func (e MAV_REMOTE_LOG_DATA_BLOCK_STATUSES) String() string {
	...
	case MAV_REMOTE_LOG_DATA_BLOCK_NACK:
		return "MAV_REMOTE_LOG_DATA_BLOCK_NACK"
	case MAV_REMOTE_LOG_DATA_BLOCK_ACK:
		return "MAV_REMOTE_LOG_DATA_BLOCK_ACK"
	default:
		return fmt.Sprintf("MAV_REMOTE_LOG_DATA_BLOCK_STATUSES_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e DEVICE_OP_BUSTYPE) String() string {
	...
	case DEVICE_OP_BUSTYPE_I2C:
		return "DEVICE_OP_BUSTYPE_I2C"
	case DEVICE_OP_BUSTYPE_SPI:
		return "DEVICE_OP_BUSTYPE_SPI"
	default:
...
func (e DEEPSTALL_STAGE) String() string {
	...
	case DEEPSTALL_STAGE_FLY_TO_LANDING:
		return "DEEPSTALL_STAGE_FLY_TO_LANDING"
	case DEEPSTALL_STAGE_ESTIMATE_WIND:
		return "DEEPSTALL_STAGE_ESTIMATE_WIND"
	case DEEPSTALL_STAGE_WAIT_FOR_BREAKOUT:
		return "DEEPSTALL_STAGE_WAIT_FOR_BREAKOUT"
	case DEEPSTALL_STAGE_FLY_TO_ARC:
		return "DEEPSTALL_STAGE_FLY_TO_ARC"
	case DEEPSTALL_STAGE_ARC:
		return "DEEPSTALL_STAGE_ARC"
	case DEEPSTALL_STAGE_APPROACH:
		return "DEEPSTALL_STAGE_APPROACH"
	case DEEPSTALL_STAGE_LAND:
		return "DEEPSTALL_STAGE_LAND"
	default:
...
func (e PLANE_MODE) String() string {
	...
	case PLANE_MODE_QAUTOTUNE:
		return "PLANE_MODE_QAUTOTUNE"
	case PLANE_MODE_QACRO:
		return "PLANE_MODE_QACRO"
	default:
...
func (e COPTER_MODE) String() string {
	...
	case COPTER_MODE_DRIFT:
		return "COPTER_MODE_DRIFT"
	case COPTER_MODE_SPORT:
		return "COPTER_MODE_SPORT"
	case COPTER_MODE_FLIP:
		return "COPTER_MODE_FLIP"
	case COPTER_MODE_AUTOTUNE:
		return "COPTER_MODE_AUTOTUNE"
...
func (e ROVER_MODE) String() string {
	...
	case ROVER_MODE_INITIALIZING:
		return "ROVER_MODE_INITIALIZING"
	default:
		return fmt.Sprintf("ROVER_MODE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e TRACKER_MODE) String() string {
	...
	case TRACKER_MODE_MANUAL:
		return "TRACKER_MODE_MANUAL"
	case TRACKER_MODE_STOP:
		return "TRACKER_MODE_STOP"
	case TRACKER_MODE_SCAN:
		return "TRACKER_MODE_SCAN"
	case TRACKER_MODE_SERVO_TEST:
		return "TRACKER_MODE_SERVO_TEST"
	case TRACKER_MODE_AUTO:
		return "TRACKER_MODE_AUTO"
	case TRACKER_MODE_INITIALIZING:
		return "TRACKER_MODE_INITIALIZING"
	default:
...
func (e OSD_PARAM_CONFIG_TYPE) String() string {
	switch e {
	case OSD_PARAM_NONE:
		return "OSD_PARAM_NONE"
	case OSD_PARAM_SERIAL_PROTOCOL:
		return "OSD_PARAM_SERIAL_PROTOCOL"
	case OSD_PARAM_SERVO_FUNCTION:
		return "OSD_PARAM_SERVO_FUNCTION"
	case OSD_PARAM_AUX_FUNCTION:
		return "OSD_PARAM_AUX_FUNCTION"
	case OSD_PARAM_FLIGHT_MODE:
		return "OSD_PARAM_FLIGHT_MODE"
	case OSD_PARAM_FAILSAFE_ACTION:
		return "OSD_PARAM_FAILSAFE_ACTION"
	case OSD_PARAM_FAILSAFE_ACTION_1:
		return "OSD_PARAM_FAILSAFE_ACTION_1"
	case OSD_PARAM_FAILSAFE_ACTION_2:
		return "OSD_PARAM_FAILSAFE_ACTION_2"
	case OSD_PARAM_NUM_TYPES:
		return "OSD_PARAM_NUM_TYPES"
	default:
		return fmt.Sprintf("OSD_PARAM_CONFIG_TYPE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e OSD_PARAM_CONFIG_ERROR) String() string {
	...
	case OSD_PARAM_SUCCESS:
		return "OSD_PARAM_SUCCESS"
	case OSD_PARAM_INVALID_SCREEN:
		return "OSD_PARAM_INVALID_SCREEN"
	case OSD_PARAM_INVALID_PARAMETER_INDEX:
		return "OSD_PARAM_INVALID_PARAMETER_INDEX"
	case OSD_PARAM_INVALID_PARAMETER:
		return "OSD_PARAM_INVALID_PARAMETER"
	default:
...
func (e MAV_SYS_STATUS_SENSOR) String() string {
	...
	case MAV_SYS_STATUS_OBSTACLE_AVOIDANCE:
		return "MAV_SYS_STATUS_OBSTACLE_AVOIDANCE"
	default:
...
func (e MAV_FRAME) String() string {
	...
	case MAV_FRAME_RESERVED_13:
		return "MAV_FRAME_RESERVED_13"
	case MAV_FRAME_RESERVED_14:
		return "MAV_FRAME_RESERVED_14"
	case MAV_FRAME_RESERVED_15:
		return "MAV_FRAME_RESERVED_15"
	case MAV_FRAME_RESERVED_16:
		return "MAV_FRAME_RESERVED_16"
	case MAV_FRAME_RESERVED_17:
		return "MAV_FRAME_RESERVED_17"
	case MAV_FRAME_RESERVED_18:
		return "MAV_FRAME_RESERVED_18"
	case MAV_FRAME_RESERVED_19:
		return "MAV_FRAME_RESERVED_19"
	case MAV_FRAME_LOCAL_FRD:
		return "MAV_FRAME_LOCAL_FRD"
	case MAV_FRAME_LOCAL_FLU:
		return "MAV_FRAME_LOCAL_FLU"
	default:
...
func (e FENCE_MITIGATE) String() string {
	...
	case FENCE_MITIGATE_UNKNOWN:
		return "FENCE_MITIGATE_UNKNOWN"
	case FENCE_MITIGATE_NONE:
		return "FENCE_MITIGATE_NONE"
	case FENCE_MITIGATE_VEL_LIMIT:
		return "FENCE_MITIGATE_VEL_LIMIT"
	default:
...
func (e MAV_MOUNT_MODE) String() string {
	...
	case MAV_MOUNT_MODE_SYSID_TARGET:
		return "MAV_MOUNT_MODE_SYSID_TARGET"
	case MAV_MOUNT_MODE_HOME_LOCATION:
		return "MAV_MOUNT_MODE_HOME_LOCATION"
	default:
...
func (e GIMBAL_DEVICE_CAP_FLAGS) String() string {
	...
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_RETRACT:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_RETRACT"
	...
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_AXIS:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_AXIS"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_FOLLOW:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_FOLLOW"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_LOCK:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_ROLL_LOCK"
	...
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_FOLLOW:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_FOLLOW"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_LOCK:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_PITCH_LOCK"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_AXIS:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_AXIS"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_FOLLOW:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_FOLLOW"
	case GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_LOCK:
		return "GIMBAL_DEVICE_CAP_FLAGS_HAS_YAW_LOCK"
	case GIMBAL_DEVICE_CAP_FLAGS_SUPPORTS_INFINITE_YAW:
		return "GIMBAL_DEVICE_CAP_FLAGS_SUPPORTS_INFINITE_YAW"
	default:
...
func (e GIMBAL_MANAGER_CAP_FLAGS) String() string {
	...
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_RETRACT:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_RETRACT"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_NEUTRAL:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_NEUTRAL"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_AXIS:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_AXIS"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_FOLLOW:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_FOLLOW"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_LOCK:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_ROLL_LOCK"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_AXIS:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_AXIS"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_FOLLOW:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_FOLLOW"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_LOCK:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_PITCH_LOCK"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_AXIS:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_AXIS"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_FOLLOW:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_FOLLOW"
	case GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_LOCK:
		return "GIMBAL_MANAGER_CAP_FLAGS_HAS_YAW_LOCK"
	case GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_INFINITE_YAW:
		return "GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_INFINITE_YAW"
	case GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL:
		return "GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL"
	case GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL:
		return "GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL"
	default:
...
func (e GIMBAL_DEVICE_FLAGS) String() string {
	...
	case GIMBAL_DEVICE_FLAGS_RETRACT:
		return "GIMBAL_DEVICE_FLAGS_RETRACT"
	case GIMBAL_DEVICE_FLAGS_NEUTRAL:
		return "GIMBAL_DEVICE_FLAGS_NEUTRAL"
	case GIMBAL_DEVICE_FLAGS_ROLL_LOCK:
		return "GIMBAL_DEVICE_FLAGS_ROLL_LOCK"
	case GIMBAL_DEVICE_FLAGS_PITCH_LOCK:
		return "GIMBAL_DEVICE_FLAGS_PITCH_LOCK"
	case GIMBAL_DEVICE_FLAGS_YAW_LOCK:
		return "GIMBAL_DEVICE_FLAGS_YAW_LOCK"
	default:
...
func (e GIMBAL_MANAGER_FLAGS) String() string {
	...
	case GIMBAL_MANAGER_FLAGS_RETRACT:
		return "GIMBAL_MANAGER_FLAGS_RETRACT"
	case GIMBAL_MANAGER_FLAGS_NEUTRAL:
		return "GIMBAL_MANAGER_FLAGS_NEUTRAL"
	case GIMBAL_MANAGER_FLAGS_ROLL_LOCK:
		return "GIMBAL_MANAGER_FLAGS_ROLL_LOCK"
	case GIMBAL_MANAGER_FLAGS_PITCH_LOCK:
		return "GIMBAL_MANAGER_FLAGS_PITCH_LOCK"
	case GIMBAL_MANAGER_FLAGS_YAW_LOCK:
		return "GIMBAL_MANAGER_FLAGS_YAW_LOCK"
	default:
...
func (e GIMBAL_DEVICE_ERROR_FLAGS) String() string {
	...
	case GIMBAL_DEVICE_ERROR_FLAGS_AT_ROLL_LIMIT:
		return "GIMBAL_DEVICE_ERROR_FLAGS_AT_ROLL_LIMIT"
	case GIMBAL_DEVICE_ERROR_FLAGS_AT_PITCH_LIMIT:
		return "GIMBAL_DEVICE_ERROR_FLAGS_AT_PITCH_LIMIT"
	case GIMBAL_DEVICE_ERROR_FLAGS_AT_YAW_LIMIT:
		return "GIMBAL_DEVICE_ERROR_FLAGS_AT_YAW_LIMIT"
	case GIMBAL_DEVICE_ERROR_FLAGS_ENCODER_ERROR:
		return "GIMBAL_DEVICE_ERROR_FLAGS_ENCODER_ERROR"
	case GIMBAL_DEVICE_ERROR_FLAGS_POWER_ERROR:
		return "GIMBAL_DEVICE_ERROR_FLAGS_POWER_ERROR"
	case GIMBAL_DEVICE_ERROR_FLAGS_MOTOR_ERROR:
		return "GIMBAL_DEVICE_ERROR_FLAGS_MOTOR_ERROR"
	case GIMBAL_DEVICE_ERROR_FLAGS_SOFTWARE_ERROR:
		return "GIMBAL_DEVICE_ERROR_FLAGS_SOFTWARE_ERROR"
	case GIMBAL_DEVICE_ERROR_FLAGS_COMMS_ERROR:
		return "GIMBAL_DEVICE_ERROR_FLAGS_COMMS_ERROR"
	case GIMBAL_DEVICE_ERROR_FLAGS_CALIBRATION_RUNNING:
		return "GIMBAL_DEVICE_ERROR_FLAGS_CALIBRATION_RUNNING"
	default:
...
func (e GRIPPER_ACTIONS) String() string {
	...
	case GRIPPER_ACTION_RELEASE:
		return "GRIPPER_ACTION_RELEASE"
	case GRIPPER_ACTION_GRAB:
		return "GRIPPER_ACTION_GRAB"
	default:
...
func (e WINCH_ACTIONS) String() string {
	switch e {
	case WINCH_RELAXED:
		return "WINCH_RELAXED"
	case WINCH_RELATIVE_LENGTH_CONTROL:
		return "WINCH_RELATIVE_LENGTH_CONTROL"
	case WINCH_RATE_CONTROL:
		return "WINCH_RATE_CONTROL"
	default:
...
func (e ESC_CONNECTION_TYPE) String() string {
	...
	case ESC_CONNECTION_TYPE_PPM:
		return "ESC_CONNECTION_TYPE_PPM"
	case ESC_CONNECTION_TYPE_SERIAL:
		return "ESC_CONNECTION_TYPE_SERIAL"
	case ESC_CONNECTION_TYPE_ONESHOT:
		return "ESC_CONNECTION_TYPE_ONESHOT"
	case ESC_CONNECTION_TYPE_I2C:
		return "ESC_CONNECTION_TYPE_I2C"
	case ESC_CONNECTION_TYPE_CAN:
		return "ESC_CONNECTION_TYPE_CAN"
	case ESC_CONNECTION_TYPE_DSHOT:
		return "ESC_CONNECTION_TYPE_DSHOT"
	default:
...
func (e ESC_FAILURE_FLAGS) String() string {
	...
	case ESC_FAILURE_NONE:
		return "ESC_FAILURE_NONE"
	case ESC_FAILURE_OVER_CURRENT:
		return "ESC_FAILURE_OVER_CURRENT"
	case ESC_FAILURE_OVER_VOLTAGE:
		return "ESC_FAILURE_OVER_VOLTAGE"
	case ESC_FAILURE_OVER_TEMPERATURE:
		return "ESC_FAILURE_OVER_TEMPERATURE"
	case ESC_FAILURE_OVER_RPM:
		return "ESC_FAILURE_OVER_RPM"
	case ESC_FAILURE_INCONSISTENT_CMD:
		return "ESC_FAILURE_INCONSISTENT_CMD"
	case ESC_FAILURE_MOTOR_STUCK:
		return "ESC_FAILURE_MOTOR_STUCK"
	case ESC_FAILURE_GENERIC:
		return "ESC_FAILURE_GENERIC"
	default:
...
func (e ORBIT_YAW_BEHAVIOUR) String() string {
	...
	case ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TO_CIRCLE_CENTER:
		return "ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TO_CIRCLE_CENTER"
	case ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING:
		return "ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING"
	case ORBIT_YAW_BEHAVIOUR_UNCONTROLLED:
		return "ORBIT_YAW_BEHAVIOUR_UNCONTROLLED"
	case ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE:
		return "ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE"
	case ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED:
		return "ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED"
	default:
...
func (e WIFI_CONFIG_AP_RESPONSE) String() string {
	...
	case WIFI_CONFIG_AP_RESPONSE_UNDEFINED:
		return "WIFI_CONFIG_AP_RESPONSE_UNDEFINED"
	case WIFI_CONFIG_AP_RESPONSE_ACCEPTED:
		return "WIFI_CONFIG_AP_RESPONSE_ACCEPTED"
	case WIFI_CONFIG_AP_RESPONSE_REJECTED:
		return "WIFI_CONFIG_AP_RESPONSE_REJECTED"
	case WIFI_CONFIG_AP_RESPONSE_MODE_ERROR:
		return "WIFI_CONFIG_AP_RESPONSE_MODE_ERROR"
	case WIFI_CONFIG_AP_RESPONSE_SSID_ERROR:
		return "WIFI_CONFIG_AP_RESPONSE_SSID_ERROR"
	case WIFI_CONFIG_AP_RESPONSE_PASSWORD_ERROR:
		return "WIFI_CONFIG_AP_RESPONSE_PASSWORD_ERROR"
	default:
...
func (e CELLULAR_CONFIG_RESPONSE) String() string {
	...
	case CELLULAR_CONFIG_RESPONSE_ACCEPTED:
		return "CELLULAR_CONFIG_RESPONSE_ACCEPTED"
	case CELLULAR_CONFIG_RESPONSE_APN_ERROR:
		return "CELLULAR_CONFIG_RESPONSE_APN_ERROR"
	case CELLULAR_CONFIG_RESPONSE_PIN_ERROR:
		return "CELLULAR_CONFIG_RESPONSE_PIN_ERROR"
	case CELLULAR_CONFIG_RESPONSE_REJECTED:
		return "CELLULAR_CONFIG_RESPONSE_REJECTED"
	case CELLULAR_CONFIG_BLOCKED_PUK_REQUIRED:
		return "CELLULAR_CONFIG_BLOCKED_PUK_REQUIRED"
	default:
...
func (e WIFI_CONFIG_AP_MODE) String() string {
	...
	case WIFI_CONFIG_AP_MODE_UNDEFINED:
		return "WIFI_CONFIG_AP_MODE_UNDEFINED"
	case WIFI_CONFIG_AP_MODE_AP:
		return "WIFI_CONFIG_AP_MODE_AP"
	case WIFI_CONFIG_AP_MODE_STATION:
		return "WIFI_CONFIG_AP_MODE_STATION"
	case WIFI_CONFIG_AP_MODE_DISABLED:
		return "WIFI_CONFIG_AP_MODE_DISABLED"
	default:
...
func (e COMP_METADATA_TYPE) String() string {
	...
	case COMP_METADATA_TYPE_VERSION:
		return "COMP_METADATA_TYPE_VERSION"
...
func (e PARAM_TRANSACTION_TRANSPORT) String() string {
	...
	case PARAM_TRANSACTION_TRANSPORT_PARAM:
		return "PARAM_TRANSACTION_TRANSPORT_PARAM"
	case PARAM_TRANSACTION_TRANSPORT_PARAM_EXT:
		return "PARAM_TRANSACTION_TRANSPORT_PARAM_EXT"
	default:
...
func (e PARAM_TRANSACTION_ACTION) String() string {
	...
	case PARAM_TRANSACTION_ACTION_START:
		return "PARAM_TRANSACTION_ACTION_START"
	case PARAM_TRANSACTION_ACTION_COMMIT:
		return "PARAM_TRANSACTION_ACTION_COMMIT"
	case PARAM_TRANSACTION_ACTION_CANCEL:
		return "PARAM_TRANSACTION_ACTION_CANCEL"
	default:
...
func (e SERIAL_CONTROL_DEV) String() string {
	...
	case SERIAL_CONTROL_SERIAL0:
		return "SERIAL_CONTROL_SERIAL0"
	case SERIAL_CONTROL_SERIAL1:
		return "SERIAL_CONTROL_SERIAL1"
	case SERIAL_CONTROL_SERIAL2:
		return "SERIAL_CONTROL_SERIAL2"
	case SERIAL_CONTROL_SERIAL3:
		return "SERIAL_CONTROL_SERIAL3"
	case SERIAL_CONTROL_SERIAL4:
		return "SERIAL_CONTROL_SERIAL4"
	case SERIAL_CONTROL_SERIAL5:
		return "SERIAL_CONTROL_SERIAL5"
	case SERIAL_CONTROL_SERIAL6:
		return "SERIAL_CONTROL_SERIAL6"
	case SERIAL_CONTROL_SERIAL7:
		return "SERIAL_CONTROL_SERIAL7"
	case SERIAL_CONTROL_SERIAL8:
		return "SERIAL_CONTROL_SERIAL8"
	case SERIAL_CONTROL_SERIAL9:
		return "SERIAL_CONTROL_SERIAL9"
	default:
...
func (e MAV_ESTIMATOR_TYPE) String() string {
	...
	case MAV_ESTIMATOR_TYPE_UNKNOWN:
		return "MAV_ESTIMATOR_TYPE_UNKNOWN"
	...
	case MAV_ESTIMATOR_TYPE_MOCAP:
		return "MAV_ESTIMATOR_TYPE_MOCAP"
	case MAV_ESTIMATOR_TYPE_LIDAR:
		return "MAV_ESTIMATOR_TYPE_LIDAR"
	case MAV_ESTIMATOR_TYPE_AUTOPILOT:
		return "MAV_ESTIMATOR_TYPE_AUTOPILOT"
	default:
...
func (e MAV_BATTERY_MODE) String() string {
	...
	case MAV_BATTERY_MODE_UNKNOWN:
		return "MAV_BATTERY_MODE_UNKNOWN"
	case MAV_BATTERY_MODE_AUTO_DISCHARGING:
		return "MAV_BATTERY_MODE_AUTO_DISCHARGING"
	case MAV_BATTERY_MODE_HOT_SWAP:
		return "MAV_BATTERY_MODE_HOT_SWAP"
	default:
...
func (e MAV_BATTERY_FAULT) String() string {
	...
	case MAV_BATTERY_FAULT_DEEP_DISCHARGE:
		return "MAV_BATTERY_FAULT_DEEP_DISCHARGE"
	case MAV_BATTERY_FAULT_SPIKES:
		return "MAV_BATTERY_FAULT_SPIKES"
	case MAV_BATTERY_FAULT_CELL_FAIL:
		return "MAV_BATTERY_FAULT_CELL_FAIL"
	case MAV_BATTERY_FAULT_OVER_CURRENT:
		return "MAV_BATTERY_FAULT_OVER_CURRENT"
	case MAV_BATTERY_FAULT_OVER_TEMPERATURE:
		return "MAV_BATTERY_FAULT_OVER_TEMPERATURE"
	case MAV_BATTERY_FAULT_UNDER_TEMPERATURE:
		return "MAV_BATTERY_FAULT_UNDER_TEMPERATURE"
	case MAV_BATTERY_FAULT_INCOMPATIBLE_VOLTAGE:
		return "MAV_BATTERY_FAULT_INCOMPATIBLE_VOLTAGE"
	default:
...
func (e MAV_GENERATOR_STATUS_FLAG) String() string {
	...
	case MAV_GENERATOR_STATUS_FLAG_OFF:
		return "MAV_GENERATOR_STATUS_FLAG_OFF"
	case MAV_GENERATOR_STATUS_FLAG_READY:
		return "MAV_GENERATOR_STATUS_FLAG_READY"
	case MAV_GENERATOR_STATUS_FLAG_GENERATING:
		return "MAV_GENERATOR_STATUS_FLAG_GENERATING"
	case MAV_GENERATOR_STATUS_FLAG_CHARGING:
		return "MAV_GENERATOR_STATUS_FLAG_CHARGING"
	case MAV_GENERATOR_STATUS_FLAG_REDUCED_POWER:
		return "MAV_GENERATOR_STATUS_FLAG_REDUCED_POWER"
	case MAV_GENERATOR_STATUS_FLAG_MAXPOWER:
		return "MAV_GENERATOR_STATUS_FLAG_MAXPOWER"
	case MAV_GENERATOR_STATUS_FLAG_OVERTEMP_WARNING:
		return "MAV_GENERATOR_STATUS_FLAG_OVERTEMP_WARNING"
	case MAV_GENERATOR_STATUS_FLAG_OVERTEMP_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_OVERTEMP_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING:
		return "MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING"
	case MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING:
		return "MAV_GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING"
	case MAV_GENERATOR_STATUS_FLAG_COOLING_WARNING:
		return "MAV_GENERATOR_STATUS_FLAG_COOLING_WARNING"
	case MAV_GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_BATTERY_UNDERVOLT_FAULT:
		return "MAV_GENERATOR_STATUS_FLAG_BATTERY_UNDERVOLT_FAULT"
	case MAV_GENERATOR_STATUS_FLAG_START_INHIBITED:
		return "MAV_GENERATOR_STATUS_FLAG_START_INHIBITED"
	case MAV_GENERATOR_STATUS_FLAG_MAINTENANCE_REQUIRED:
		return "MAV_GENERATOR_STATUS_FLAG_MAINTENANCE_REQUIRED"
	case MAV_GENERATOR_STATUS_FLAG_WARMING_UP:
		return "MAV_GENERATOR_STATUS_FLAG_WARMING_UP"
	case MAV_GENERATOR_STATUS_FLAG_IDLE:
		return "MAV_GENERATOR_STATUS_FLAG_IDLE"
	default:
...
func (e ADSB_FLAGS) String() string {
	...
	case ADSB_FLAGS_VERTICAL_VELOCITY_VALID:
		return "ADSB_FLAGS_VERTICAL_VELOCITY_VALID"
	case ADSB_FLAGS_BARO_VALID:
		return "ADSB_FLAGS_BARO_VALID"
	case ADSB_FLAGS_SOURCE_UAT:
		return "ADSB_FLAGS_SOURCE_UAT"
	default:
...
func (e CAMERA_CAP_FLAGS) String() string {
	...
	case CAMERA_CAP_FLAGS_HAS_TRACKING_POINT:
		return "CAMERA_CAP_FLAGS_HAS_TRACKING_POINT"
	case CAMERA_CAP_FLAGS_HAS_TRACKING_RECTANGLE:
		return "CAMERA_CAP_FLAGS_HAS_TRACKING_RECTANGLE"
	case CAMERA_CAP_FLAGS_HAS_TRACKING_GEO_STATUS:
		return "CAMERA_CAP_FLAGS_HAS_TRACKING_GEO_STATUS"
	default:
...
func (e CAMERA_TRACKING_STATUS_FLAGS) String() string {
	...
	case CAMERA_TRACKING_STATUS_FLAGS_IDLE:
		return "CAMERA_TRACKING_STATUS_FLAGS_IDLE"
	case CAMERA_TRACKING_STATUS_FLAGS_ACTIVE:
		return "CAMERA_TRACKING_STATUS_FLAGS_ACTIVE"
	case CAMERA_TRACKING_STATUS_FLAGS_ERROR:
		return "CAMERA_TRACKING_STATUS_FLAGS_ERROR"
	default:
...
func (e CAMERA_TRACKING_MODE) String() string {
	...
	case CAMERA_TRACKING_NONE:
		return "CAMERA_TRACKING_NONE"
	case CAMERA_TRACKING_POINT:
		return "CAMERA_TRACKING_POINT"
	case CAMERA_TRACKING_RECTANGLE:
		return "CAMERA_TRACKING_RECTANGLE"
	default:
...
func (e CAMERA_TRACKING_TARGET_DATA) String() string {
	...
	case CAMERA_TRACKING_TARGET_NONE:
		return "CAMERA_TRACKING_TARGET_NONE"
	case CAMERA_TRACKING_TARGET_EMBEDDED:
		return "CAMERA_TRACKING_TARGET_EMBEDDED"
	case CAMERA_TRACKING_TARGET_RENDERED:
		return "CAMERA_TRACKING_TARGET_RENDERED"
	case CAMERA_TRACKING_TARGET_IN_STATUS:
		return "CAMERA_TRACKING_TARGET_IN_STATUS"
	default:
...
func (e ATTITUDE_TARGET_TYPEMASK) String() string {
	...
	case ATTITUDE_TARGET_TYPEMASK_BODY_ROLL_RATE_IGNORE:
		return "ATTITUDE_TARGET_TYPEMASK_BODY_ROLL_RATE_IGNORE"
	case ATTITUDE_TARGET_TYPEMASK_BODY_PITCH_RATE_IGNORE:
		return "ATTITUDE_TARGET_TYPEMASK_BODY_PITCH_RATE_IGNORE"
	case ATTITUDE_TARGET_TYPEMASK_BODY_YAW_RATE_IGNORE:
		return "ATTITUDE_TARGET_TYPEMASK_BODY_YAW_RATE_IGNORE"
	case ATTITUDE_TARGET_TYPEMASK_THROTTLE_IGNORE:
		return "ATTITUDE_TARGET_TYPEMASK_THROTTLE_IGNORE"
	case ATTITUDE_TARGET_TYPEMASK_ATTITUDE_IGNORE:
		return "ATTITUDE_TARGET_TYPEMASK_ATTITUDE_IGNORE"
	default:
...
func (e CELLULAR_STATUS_FLAG) String() string {
	...
	case CELLULAR_STATUS_FLAG_UNKNOWN:
		return "CELLULAR_STATUS_FLAG_UNKNOWN"
	case CELLULAR_STATUS_FLAG_FAILED:
		return "CELLULAR_STATUS_FLAG_FAILED"
	case CELLULAR_STATUS_FLAG_INITIALIZING:
		return "CELLULAR_STATUS_FLAG_INITIALIZING"
	case CELLULAR_STATUS_FLAG_LOCKED:
		return "CELLULAR_STATUS_FLAG_LOCKED"
	case CELLULAR_STATUS_FLAG_DISABLED:
		return "CELLULAR_STATUS_FLAG_DISABLED"
	case CELLULAR_STATUS_FLAG_DISABLING:
		return "CELLULAR_STATUS_FLAG_DISABLING"
	case CELLULAR_STATUS_FLAG_ENABLING:
		return "CELLULAR_STATUS_FLAG_ENABLING"
	case CELLULAR_STATUS_FLAG_ENABLED:
		return "CELLULAR_STATUS_FLAG_ENABLED"
	case CELLULAR_STATUS_FLAG_SEARCHING:
		return "CELLULAR_STATUS_FLAG_SEARCHING"
	case CELLULAR_STATUS_FLAG_REGISTERED:
		return "CELLULAR_STATUS_FLAG_REGISTERED"
	case CELLULAR_STATUS_FLAG_DISCONNECTING:
		return "CELLULAR_STATUS_FLAG_DISCONNECTING"
	case CELLULAR_STATUS_FLAG_CONNECTING:
		return "CELLULAR_STATUS_FLAG_CONNECTING"
	case CELLULAR_STATUS_FLAG_CONNECTED:
		return "CELLULAR_STATUS_FLAG_CONNECTED"
	default:
...
func (e CELLULAR_NETWORK_FAILED_REASON) String() string {
	...
	case CELLULAR_NETWORK_FAILED_REASON_NONE:
		return "CELLULAR_NETWORK_FAILED_REASON_NONE"
	case CELLULAR_NETWORK_FAILED_REASON_UNKNOWN:
		return "CELLULAR_NETWORK_FAILED_REASON_UNKNOWN"
	case CELLULAR_NETWORK_FAILED_REASON_SIM_MISSING:
		return "CELLULAR_NETWORK_FAILED_REASON_SIM_MISSING"
	case CELLULAR_NETWORK_FAILED_REASON_SIM_ERROR:
		return "CELLULAR_NETWORK_FAILED_REASON_SIM_ERROR"
	default:
...
func (e MAV_TUNNEL_PAYLOAD_TYPE) String() string {
	...
	case MAV_TUNNEL_PAYLOAD_TYPE_UNKNOWN:
		return "MAV_TUNNEL_PAYLOAD_TYPE_UNKNOWN"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED0:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED0"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED1:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED1"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED2:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED2"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED3:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED3"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED4:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED4"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED5:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED5"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED6:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED6"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED7:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED7"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED8:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED8"
	case MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED9:
		return "MAV_TUNNEL_PAYLOAD_TYPE_STORM32_RESERVED9"
	default:
...
func (e MAV_ODID_ID_TYPE) String() string {
	...
	case MAV_ODID_ID_TYPE_NONE:
		return "MAV_ODID_ID_TYPE_NONE"
	case MAV_ODID_ID_TYPE_SERIAL_NUMBER:
		return "MAV_ODID_ID_TYPE_SERIAL_NUMBER"
	case MAV_ODID_ID_TYPE_CAA_REGISTRATION_ID:
		return "MAV_ODID_ID_TYPE_CAA_REGISTRATION_ID"
	case MAV_ODID_ID_TYPE_UTM_ASSIGNED_UUID:
		return "MAV_ODID_ID_TYPE_UTM_ASSIGNED_UUID"
	default:
...
func (e MAV_ODID_UA_TYPE) String() string {
	...
	case MAV_ODID_UA_TYPE_GYROPLANE:
		return "MAV_ODID_UA_TYPE_GYROPLANE"
	...
	case MAV_ODID_UA_TYPE_GLIDER:
		return "MAV_ODID_UA_TYPE_GLIDER"
	...
	case MAV_ODID_UA_TYPE_CAPTIVE_BALLOON:
		return "MAV_ODID_UA_TYPE_CAPTIVE_BALLOON"
	...
	case MAV_ODID_UA_TYPE_TETHERED_POWERED_AIRCRAFT:
		return "MAV_ODID_UA_TYPE_TETHERED_POWERED_AIRCRAFT"
...
func (e MAV_ODID_STATUS) String() string {
	...
	case MAV_ODID_STATUS_UNDECLARED:
		return "MAV_ODID_STATUS_UNDECLARED"
	case MAV_ODID_STATUS_GROUND:
		return "MAV_ODID_STATUS_GROUND"
	case MAV_ODID_STATUS_AIRBORNE:
		return "MAV_ODID_STATUS_AIRBORNE"
	case MAV_ODID_STATUS_EMERGENCY:
		return "MAV_ODID_STATUS_EMERGENCY"
	default:
...
func (e MAV_ODID_HEIGHT_REF) String() string {
	...
	case MAV_ODID_HEIGHT_REF_OVER_TAKEOFF:
		return "MAV_ODID_HEIGHT_REF_OVER_TAKEOFF"
	case MAV_ODID_HEIGHT_REF_OVER_GROUND:
		return "MAV_ODID_HEIGHT_REF_OVER_GROUND"
	default:
...
func (e MAV_ODID_AUTH_TYPE) String() string {
	...
	case MAV_ODID_AUTH_TYPE_NONE:
		return "MAV_ODID_AUTH_TYPE_NONE"
	case MAV_ODID_AUTH_TYPE_UAS_ID_SIGNATURE:
		return "MAV_ODID_AUTH_TYPE_UAS_ID_SIGNATURE"
	case MAV_ODID_AUTH_TYPE_OPERATOR_ID_SIGNATURE:
		return "MAV_ODID_AUTH_TYPE_OPERATOR_ID_SIGNATURE"
	case MAV_ODID_AUTH_TYPE_MESSAGE_SET_SIGNATURE:
		return "MAV_ODID_AUTH_TYPE_MESSAGE_SET_SIGNATURE"
	case MAV_ODID_AUTH_TYPE_NETWORK_REMOTE_ID:
		return "MAV_ODID_AUTH_TYPE_NETWORK_REMOTE_ID"
	default:
...
func (e MAV_ODID_DESC_TYPE) String() string {
	...
	case MAV_ODID_DESC_TYPE_TEXT:
		return "MAV_ODID_DESC_TYPE_TEXT"
	default:
...
func (e MAV_ODID_OPERATOR_LOCATION_TYPE) String() string {
	...
	case MAV_ODID_OPERATOR_LOCATION_TYPE_TAKEOFF:
		return "MAV_ODID_OPERATOR_LOCATION_TYPE_TAKEOFF"
	case MAV_ODID_OPERATOR_LOCATION_TYPE_LIVE_GNSS:
		return "MAV_ODID_OPERATOR_LOCATION_TYPE_LIVE_GNSS"
	case MAV_ODID_OPERATOR_LOCATION_TYPE_FIXED:
		return "MAV_ODID_OPERATOR_LOCATION_TYPE_FIXED"
	default:
...
func (e MAV_ODID_CLASSIFICATION_TYPE) String() string {
	...
	case MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED:
		return "MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED"
	case MAV_ODID_CLASSIFICATION_TYPE_EU:
		return "MAV_ODID_CLASSIFICATION_TYPE_EU"
	default:
...
func (e MAV_ODID_CATEGORY_EU) String() string {
	...
	case MAV_ODID_CATEGORY_EU_UNDECLARED:
		return "MAV_ODID_CATEGORY_EU_UNDECLARED"
	case MAV_ODID_CATEGORY_EU_OPEN:
		return "MAV_ODID_CATEGORY_EU_OPEN"
	case MAV_ODID_CATEGORY_EU_SPECIFIC:
		return "MAV_ODID_CATEGORY_EU_SPECIFIC"
	case MAV_ODID_CATEGORY_EU_CERTIFIED:
		return "MAV_ODID_CATEGORY_EU_CERTIFIED"
	default:
...
func (e MAV_ODID_CLASS_EU) String() string {
	...
	case MAV_ODID_CLASS_EU_UNDECLARED:
		return "MAV_ODID_CLASS_EU_UNDECLARED"
	case MAV_ODID_CLASS_EU_CLASS_0:
		return "MAV_ODID_CLASS_EU_CLASS_0"
	case MAV_ODID_CLASS_EU_CLASS_1:
		return "MAV_ODID_CLASS_EU_CLASS_1"
	case MAV_ODID_CLASS_EU_CLASS_2:
		return "MAV_ODID_CLASS_EU_CLASS_2"
	case MAV_ODID_CLASS_EU_CLASS_3:
		return "MAV_ODID_CLASS_EU_CLASS_3"
	case MAV_ODID_CLASS_EU_CLASS_4:
		return "MAV_ODID_CLASS_EU_CLASS_4"
	case MAV_ODID_CLASS_EU_CLASS_5:
		return "MAV_ODID_CLASS_EU_CLASS_5"
	case MAV_ODID_CLASS_EU_CLASS_6:
		return "MAV_ODID_CLASS_EU_CLASS_6"
	default:
...
func (e MAV_ODID_OPERATOR_ID_TYPE) String() string {
	...
	case MAV_ODID_OPERATOR_ID_TYPE_CAA:
		return "MAV_ODID_OPERATOR_ID_TYPE_CAA"
	default:
...
func (e TUNE_FORMAT) String() string {
	...
	case TUNE_FORMAT_QBASIC1_1:
		return "TUNE_FORMAT_QBASIC1_1"
	case TUNE_FORMAT_MML_MODERN:
		return "TUNE_FORMAT_MML_MODERN"
	default:
...
func (e COMPONENT_CAP_FLAGS) String() string {
	...
	case COMPONENT_CAP_FLAGS_PARAM:
		return "COMPONENT_CAP_FLAGS_PARAM"
	case COMPONENT_CAP_FLAGS_PARAM_EXT:
		return "COMPONENT_CAP_FLAGS_PARAM_EXT"
	default:
...
func (e AIS_TYPE) String() string {
	...
	case AIS_TYPE_UNKNOWN:
		return "AIS_TYPE_UNKNOWN"
	case AIS_TYPE_RESERVED_1:
		return "AIS_TYPE_RESERVED_1"
	case AIS_TYPE_RESERVED_2:
		return "AIS_TYPE_RESERVED_2"
	case AIS_TYPE_RESERVED_3:
		return "AIS_TYPE_RESERVED_3"
	case AIS_TYPE_RESERVED_4:
		return "AIS_TYPE_RESERVED_4"
	case AIS_TYPE_RESERVED_5:
		return "AIS_TYPE_RESERVED_5"
	case AIS_TYPE_RESERVED_6:
		return "AIS_TYPE_RESERVED_6"
	case AIS_TYPE_RESERVED_7:
		return "AIS_TYPE_RESERVED_7"
	case AIS_TYPE_RESERVED_8:
		return "AIS_TYPE_RESERVED_8"
	case AIS_TYPE_RESERVED_9:
		return "AIS_TYPE_RESERVED_9"
	case AIS_TYPE_RESERVED_10:
		return "AIS_TYPE_RESERVED_10"
	case AIS_TYPE_RESERVED_11:
		return "AIS_TYPE_RESERVED_11"
	case AIS_TYPE_RESERVED_12:
		return "AIS_TYPE_RESERVED_12"
	case AIS_TYPE_RESERVED_13:
		return "AIS_TYPE_RESERVED_13"
	case AIS_TYPE_RESERVED_14:
		return "AIS_TYPE_RESERVED_14"
	case AIS_TYPE_RESERVED_15:
		return "AIS_TYPE_RESERVED_15"
	case AIS_TYPE_RESERVED_16:
		return "AIS_TYPE_RESERVED_16"
	case AIS_TYPE_RESERVED_17:
		return "AIS_TYPE_RESERVED_17"
	case AIS_TYPE_RESERVED_18:
		return "AIS_TYPE_RESERVED_18"
	case AIS_TYPE_RESERVED_19:
		return "AIS_TYPE_RESERVED_19"
	case AIS_TYPE_WIG:
		return "AIS_TYPE_WIG"
	case AIS_TYPE_WIG_HAZARDOUS_A:
		return "AIS_TYPE_WIG_HAZARDOUS_A"
	case AIS_TYPE_WIG_HAZARDOUS_B:
		return "AIS_TYPE_WIG_HAZARDOUS_B"
	case AIS_TYPE_WIG_HAZARDOUS_C:
		return "AIS_TYPE_WIG_HAZARDOUS_C"
	case AIS_TYPE_WIG_HAZARDOUS_D:
		return "AIS_TYPE_WIG_HAZARDOUS_D"
	case AIS_TYPE_WIG_RESERVED_1:
		return "AIS_TYPE_WIG_RESERVED_1"
	case AIS_TYPE_WIG_RESERVED_2:
		return "AIS_TYPE_WIG_RESERVED_2"
	case AIS_TYPE_WIG_RESERVED_3:
		return "AIS_TYPE_WIG_RESERVED_3"
	case AIS_TYPE_WIG_RESERVED_4:
		return "AIS_TYPE_WIG_RESERVED_4"
	case AIS_TYPE_WIG_RESERVED_5:
		return "AIS_TYPE_WIG_RESERVED_5"
	case AIS_TYPE_FISHING:
		return "AIS_TYPE_FISHING"
	case AIS_TYPE_TOWING:
		return "AIS_TYPE_TOWING"
	case AIS_TYPE_TOWING_LARGE:
		return "AIS_TYPE_TOWING_LARGE"
	case AIS_TYPE_DREDGING:
		return "AIS_TYPE_DREDGING"
	case AIS_TYPE_DIVING:
		return "AIS_TYPE_DIVING"
	case AIS_TYPE_MILITARY:
		return "AIS_TYPE_MILITARY"
	case AIS_TYPE_SAILING:
		return "AIS_TYPE_SAILING"
	case AIS_TYPE_PLEASURE:
		return "AIS_TYPE_PLEASURE"
	case AIS_TYPE_RESERVED_20:
		return "AIS_TYPE_RESERVED_20"
	case AIS_TYPE_RESERVED_21:
		return "AIS_TYPE_RESERVED_21"
	case AIS_TYPE_HSC:
		return "AIS_TYPE_HSC"
	case AIS_TYPE_HSC_HAZARDOUS_A:
		return "AIS_TYPE_HSC_HAZARDOUS_A"
	case AIS_TYPE_HSC_HAZARDOUS_B:
		return "AIS_TYPE_HSC_HAZARDOUS_B"
	case AIS_TYPE_HSC_HAZARDOUS_C:
		return "AIS_TYPE_HSC_HAZARDOUS_C"
	case AIS_TYPE_HSC_HAZARDOUS_D:
		return "AIS_TYPE_HSC_HAZARDOUS_D"
	case AIS_TYPE_HSC_RESERVED_1:
		return "AIS_TYPE_HSC_RESERVED_1"
	case AIS_TYPE_HSC_RESERVED_2:
		return "AIS_TYPE_HSC_RESERVED_2"
	case AIS_TYPE_HSC_RESERVED_3:
		return "AIS_TYPE_HSC_RESERVED_3"
	case AIS_TYPE_HSC_RESERVED_4:
		return "AIS_TYPE_HSC_RESERVED_4"
	case AIS_TYPE_HSC_UNKNOWN:
		return "AIS_TYPE_HSC_UNKNOWN"
	case AIS_TYPE_PILOT:
		return "AIS_TYPE_PILOT"
	case AIS_TYPE_SAR:
		return "AIS_TYPE_SAR"
	case AIS_TYPE_TUG:
		return "AIS_TYPE_TUG"
	case AIS_TYPE_PORT_TENDER:
		return "AIS_TYPE_PORT_TENDER"
	case AIS_TYPE_ANTI_POLLUTION:
		return "AIS_TYPE_ANTI_POLLUTION"
	case AIS_TYPE_LAW_ENFORCEMENT:
		return "AIS_TYPE_LAW_ENFORCEMENT"
	case AIS_TYPE_SPARE_LOCAL_1:
		return "AIS_TYPE_SPARE_LOCAL_1"
	case AIS_TYPE_SPARE_LOCAL_2:
		return "AIS_TYPE_SPARE_LOCAL_2"
	case AIS_TYPE_MEDICAL_TRANSPORT:
		return "AIS_TYPE_MEDICAL_TRANSPORT"
	case AIS_TYPE_NONECOMBATANT:
		return "AIS_TYPE_NONECOMBATANT"
	case AIS_TYPE_PASSENGER:
		return "AIS_TYPE_PASSENGER"
	case AIS_TYPE_PASSENGER_HAZARDOUS_A:
		return "AIS_TYPE_PASSENGER_HAZARDOUS_A"
	case AIS_TYPE_PASSENGER_HAZARDOUS_B:
		return "AIS_TYPE_PASSENGER_HAZARDOUS_B"
	case AIS_TYPE_AIS_TYPE_PASSENGER_HAZARDOUS_C:
		return "AIS_TYPE_AIS_TYPE_PASSENGER_HAZARDOUS_C"
	case AIS_TYPE_PASSENGER_HAZARDOUS_D:
		return "AIS_TYPE_PASSENGER_HAZARDOUS_D"
	case AIS_TYPE_PASSENGER_RESERVED_1:
		return "AIS_TYPE_PASSENGER_RESERVED_1"
	case AIS_TYPE_PASSENGER_RESERVED_2:
		return "AIS_TYPE_PASSENGER_RESERVED_2"
	case AIS_TYPE_PASSENGER_RESERVED_3:
		return "AIS_TYPE_PASSENGER_RESERVED_3"
	case AIS_TYPE_AIS_TYPE_PASSENGER_RESERVED_4:
		return "AIS_TYPE_AIS_TYPE_PASSENGER_RESERVED_4"
	case AIS_TYPE_PASSENGER_UNKNOWN:
		return "AIS_TYPE_PASSENGER_UNKNOWN"
	case AIS_TYPE_CARGO:
		return "AIS_TYPE_CARGO"
	case AIS_TYPE_CARGO_HAZARDOUS_A:
		return "AIS_TYPE_CARGO_HAZARDOUS_A"
	case AIS_TYPE_CARGO_HAZARDOUS_B:
		return "AIS_TYPE_CARGO_HAZARDOUS_B"
	case AIS_TYPE_CARGO_HAZARDOUS_C:
		return "AIS_TYPE_CARGO_HAZARDOUS_C"
	case AIS_TYPE_CARGO_HAZARDOUS_D:
		return "AIS_TYPE_CARGO_HAZARDOUS_D"
	case AIS_TYPE_CARGO_RESERVED_1:
		return "AIS_TYPE_CARGO_RESERVED_1"
	case AIS_TYPE_CARGO_RESERVED_2:
		return "AIS_TYPE_CARGO_RESERVED_2"
	case AIS_TYPE_CARGO_RESERVED_3:
		return "AIS_TYPE_CARGO_RESERVED_3"
	case AIS_TYPE_CARGO_RESERVED_4:
		return "AIS_TYPE_CARGO_RESERVED_4"
	case AIS_TYPE_CARGO_UNKNOWN:
		return "AIS_TYPE_CARGO_UNKNOWN"
	case AIS_TYPE_TANKER:
		return "AIS_TYPE_TANKER"
	case AIS_TYPE_TANKER_HAZARDOUS_A:
		return "AIS_TYPE_TANKER_HAZARDOUS_A"
	case AIS_TYPE_TANKER_HAZARDOUS_B:
		return "AIS_TYPE_TANKER_HAZARDOUS_B"
	case AIS_TYPE_TANKER_HAZARDOUS_C:
		return "AIS_TYPE_TANKER_HAZARDOUS_C"
	case AIS_TYPE_TANKER_HAZARDOUS_D:
		return "AIS_TYPE_TANKER_HAZARDOUS_D"
	case AIS_TYPE_TANKER_RESERVED_1:
		return "AIS_TYPE_TANKER_RESERVED_1"
	case AIS_TYPE_TANKER_RESERVED_2:
		return "AIS_TYPE_TANKER_RESERVED_2"
	case AIS_TYPE_TANKER_RESERVED_3:
		return "AIS_TYPE_TANKER_RESERVED_3"
	case AIS_TYPE_TANKER_RESERVED_4:
		return "AIS_TYPE_TANKER_RESERVED_4"
	case AIS_TYPE_TANKER_UNKNOWN:
		return "AIS_TYPE_TANKER_UNKNOWN"
	case AIS_TYPE_OTHER:
		return "AIS_TYPE_OTHER"
	case AIS_TYPE_OTHER_HAZARDOUS_A:
		return "AIS_TYPE_OTHER_HAZARDOUS_A"
	case AIS_TYPE_OTHER_HAZARDOUS_B:
		return "AIS_TYPE_OTHER_HAZARDOUS_B"
	case AIS_TYPE_OTHER_HAZARDOUS_C:
		return "AIS_TYPE_OTHER_HAZARDOUS_C"
	case AIS_TYPE_OTHER_HAZARDOUS_D:
		return "AIS_TYPE_OTHER_HAZARDOUS_D"
	case AIS_TYPE_OTHER_RESERVED_1:
		return "AIS_TYPE_OTHER_RESERVED_1"
	case AIS_TYPE_OTHER_RESERVED_2:
		return "AIS_TYPE_OTHER_RESERVED_2"
	case AIS_TYPE_OTHER_RESERVED_3:
		return "AIS_TYPE_OTHER_RESERVED_3"
	case AIS_TYPE_OTHER_RESERVED_4:
		return "AIS_TYPE_OTHER_RESERVED_4"
	case AIS_TYPE_OTHER_UNKNOWN:
		return "AIS_TYPE_OTHER_UNKNOWN"
	default:
...
func (e AIS_NAV_STATUS) String() string {
	...
	case AIS_NAV_ANCHORED:
		return "AIS_NAV_ANCHORED"
	case AIS_NAV_UN_COMMANDED:
		return "AIS_NAV_UN_COMMANDED"
	case AIS_NAV_RESTRICTED_MANOEUVERABILITY:
		return "AIS_NAV_RESTRICTED_MANOEUVERABILITY"
	case AIS_NAV_DRAUGHT_CONSTRAINED:
		return "AIS_NAV_DRAUGHT_CONSTRAINED"
	case AIS_NAV_MOORED:
		return "AIS_NAV_MOORED"
	case AIS_NAV_AGROUND:
		return "AIS_NAV_AGROUND"
	case AIS_NAV_FISHING:
		return "AIS_NAV_FISHING"
	case AIS_NAV_SAILING:
		return "AIS_NAV_SAILING"
	case AIS_NAV_RESERVED_HSC:
		return "AIS_NAV_RESERVED_HSC"
	case AIS_NAV_RESERVED_WIG:
		return "AIS_NAV_RESERVED_WIG"
	case AIS_NAV_RESERVED_1:
		return "AIS_NAV_RESERVED_1"
	case AIS_NAV_RESERVED_2:
		return "AIS_NAV_RESERVED_2"
	case AIS_NAV_RESERVED_3:
		return "AIS_NAV_RESERVED_3"
	case AIS_NAV_AIS_SART:
		return "AIS_NAV_AIS_SART"
	case AIS_NAV_UNKNOWN:
		return "AIS_NAV_UNKNOWN"
	default:
...
func (e AIS_FLAGS) String() string {
	...
	case AIS_FLAGS_POSITION_ACCURACY:
		return "AIS_FLAGS_POSITION_ACCURACY"
	case AIS_FLAGS_VALID_COG:
		return "AIS_FLAGS_VALID_COG"
	case AIS_FLAGS_VALID_VELOCITY:
		return "AIS_FLAGS_VALID_VELOCITY"
	case AIS_FLAGS_HIGH_VELOCITY:
		return "AIS_FLAGS_HIGH_VELOCITY"
	case AIS_FLAGS_VALID_TURN_RATE:
		return "AIS_FLAGS_VALID_TURN_RATE"
	case AIS_FLAGS_TURN_RATE_SIGN_ONLY:
		return "AIS_FLAGS_TURN_RATE_SIGN_ONLY"
	case AIS_FLAGS_VALID_DIMENSIONS:
		return "AIS_FLAGS_VALID_DIMENSIONS"
	case AIS_FLAGS_LARGE_BOW_DIMENSION:
		return "AIS_FLAGS_LARGE_BOW_DIMENSION"
	case AIS_FLAGS_LARGE_STERN_DIMENSION:
		return "AIS_FLAGS_LARGE_STERN_DIMENSION"
	case AIS_FLAGS_LARGE_PORT_DIMENSION:
		return "AIS_FLAGS_LARGE_PORT_DIMENSION"
	case AIS_FLAGS_LARGE_STARBOARD_DIMENSION:
		return "AIS_FLAGS_LARGE_STARBOARD_DIMENSION"
	case AIS_FLAGS_VALID_CALLSIGN:
		return "AIS_FLAGS_VALID_CALLSIGN"
	case AIS_FLAGS_VALID_NAME:
		return "AIS_FLAGS_VALID_NAME"
	default:
...
func (e MAV_WINCH_STATUS_FLAG) String() string {
	...
	case MAV_WINCH_STATUS_HEALTHY:
		return "MAV_WINCH_STATUS_HEALTHY"
	case MAV_WINCH_STATUS_FULLY_RETRACTED:
		return "MAV_WINCH_STATUS_FULLY_RETRACTED"
	case MAV_WINCH_STATUS_MOVING:
		return "MAV_WINCH_STATUS_MOVING"
	case MAV_WINCH_STATUS_CLUTCH_ENGAGED:
		return "MAV_WINCH_STATUS_CLUTCH_ENGAGED"
	default:
...
func (e MAG_CAL_STATUS) String() string {
	...
	case MAG_CAL_NOT_STARTED:
		return "MAG_CAL_NOT_STARTED"
	case MAG_CAL_WAITING_TO_START:
		return "MAG_CAL_WAITING_TO_START"
	case MAG_CAL_RUNNING_STEP_ONE:
		return "MAG_CAL_RUNNING_STEP_ONE"
	case MAG_CAL_RUNNING_STEP_TWO:
		return "MAG_CAL_RUNNING_STEP_TWO"
	case MAG_CAL_SUCCESS:
		return "MAG_CAL_SUCCESS"
	case MAG_CAL_FAILED:
		return "MAG_CAL_FAILED"
	case MAG_CAL_BAD_ORIENTATION:
		return "MAG_CAL_BAD_ORIENTATION"
	case MAG_CAL_BAD_RADIUS:
		return "MAG_CAL_BAD_RADIUS"
	default:
...
func (e MAV_COMPONENT) String() string {
	...
	case MAV_COMP_ID_USER2:
		return "MAV_COMP_ID_USER2"
	case MAV_COMP_ID_USER3:
		return "MAV_COMP_ID_USER3"
	case MAV_COMP_ID_USER4:
		return "MAV_COMP_ID_USER4"
	case MAV_COMP_ID_USER5:
		return "MAV_COMP_ID_USER5"
	case MAV_COMP_ID_USER6:
		return "MAV_COMP_ID_USER6"
	case MAV_COMP_ID_USER7:
		return "MAV_COMP_ID_USER7"
	case MAV_COMP_ID_USER8:
		return "MAV_COMP_ID_USER8"
	case MAV_COMP_ID_USER9:
		return "MAV_COMP_ID_USER9"
	case MAV_COMP_ID_USER10:
		return "MAV_COMP_ID_USER10"
	case MAV_COMP_ID_USER11:
		return "MAV_COMP_ID_USER11"
	case MAV_COMP_ID_USER12:
		return "MAV_COMP_ID_USER12"
	case MAV_COMP_ID_USER13:
		return "MAV_COMP_ID_USER13"
	case MAV_COMP_ID_USER14:
		return "MAV_COMP_ID_USER14"
	case MAV_COMP_ID_USER15:
		return "MAV_COMP_ID_USER15"
	case MAV_COMP_ID_USER16:
		return "MAV_COMP_ID_USER16"
	case MAV_COMP_ID_USER17:
		return "MAV_COMP_ID_USER17"
	case MAV_COMP_ID_USER18:
		return "MAV_COMP_ID_USER18"
	case MAV_COMP_ID_USER19:
		return "MAV_COMP_ID_USER19"
	case MAV_COMP_ID_USER20:
		return "MAV_COMP_ID_USER20"
	case MAV_COMP_ID_USER21:
		return "MAV_COMP_ID_USER21"
	case MAV_COMP_ID_USER22:
		return "MAV_COMP_ID_USER22"
	case MAV_COMP_ID_USER23:
		return "MAV_COMP_ID_USER23"
	case MAV_COMP_ID_USER24:
		return "MAV_COMP_ID_USER24"
	case MAV_COMP_ID_USER25:
		return "MAV_COMP_ID_USER25"
	case MAV_COMP_ID_USER26:
		return "MAV_COMP_ID_USER26"
	case MAV_COMP_ID_USER27:
		return "MAV_COMP_ID_USER27"
	case MAV_COMP_ID_USER28:
		return "MAV_COMP_ID_USER28"
	case MAV_COMP_ID_USER29:
		return "MAV_COMP_ID_USER29"
	case MAV_COMP_ID_USER30:
		return "MAV_COMP_ID_USER30"
	case MAV_COMP_ID_USER31:
		return "MAV_COMP_ID_USER31"
	case MAV_COMP_ID_USER32:
		return "MAV_COMP_ID_USER32"
	case MAV_COMP_ID_USER33:
		return "MAV_COMP_ID_USER33"
	case MAV_COMP_ID_USER34:
		return "MAV_COMP_ID_USER34"
	case MAV_COMP_ID_USER35:
		return "MAV_COMP_ID_USER35"
	case MAV_COMP_ID_USER36:
		return "MAV_COMP_ID_USER36"
	case MAV_COMP_ID_USER37:
		return "MAV_COMP_ID_USER37"
	case MAV_COMP_ID_USER38:
		return "MAV_COMP_ID_USER38"
	case MAV_COMP_ID_USER39:
		return "MAV_COMP_ID_USER39"
	case MAV_COMP_ID_USER40:
		return "MAV_COMP_ID_USER40"
	case MAV_COMP_ID_USER41:
		return "MAV_COMP_ID_USER41"
	case MAV_COMP_ID_USER42:
		return "MAV_COMP_ID_USER42"
	case MAV_COMP_ID_USER43:
		return "MAV_COMP_ID_USER43"
	case MAV_COMP_ID_TELEMETRY_RADIO:
		return "MAV_COMP_ID_TELEMETRY_RADIO"
	case MAV_COMP_ID_USER45:
		return "MAV_COMP_ID_USER45"
	case MAV_COMP_ID_USER46:
		return "MAV_COMP_ID_USER46"
	case MAV_COMP_ID_USER47:
		return "MAV_COMP_ID_USER47"
	case MAV_COMP_ID_USER48:
		return "MAV_COMP_ID_USER48"
	case MAV_COMP_ID_USER49:
		return "MAV_COMP_ID_USER49"
	case MAV_COMP_ID_USER50:
		return "MAV_COMP_ID_USER50"
	case MAV_COMP_ID_USER51:
		return "MAV_COMP_ID_USER51"
	case MAV_COMP_ID_USER52:
		return "MAV_COMP_ID_USER52"
	case MAV_COMP_ID_USER53:
		return "MAV_COMP_ID_USER53"
	case MAV_COMP_ID_USER54:
		return "MAV_COMP_ID_USER54"
	case MAV_COMP_ID_USER55:
		return "MAV_COMP_ID_USER55"
	case MAV_COMP_ID_USER56:
		return "MAV_COMP_ID_USER56"
	case MAV_COMP_ID_USER57:
		return "MAV_COMP_ID_USER57"
	case MAV_COMP_ID_USER58:
		return "MAV_COMP_ID_USER58"
	case MAV_COMP_ID_USER59:
		return "MAV_COMP_ID_USER59"
	case MAV_COMP_ID_USER60:
		return "MAV_COMP_ID_USER60"
	case MAV_COMP_ID_USER61:
		return "MAV_COMP_ID_USER61"
	case MAV_COMP_ID_USER62:
		return "MAV_COMP_ID_USER62"
	case MAV_COMP_ID_USER63:
		return "MAV_COMP_ID_USER63"
	case MAV_COMP_ID_USER64:
		return "MAV_COMP_ID_USER64"
	case MAV_COMP_ID_USER65:
		return "MAV_COMP_ID_USER65"
	case MAV_COMP_ID_USER66:
		return "MAV_COMP_ID_USER66"
	case MAV_COMP_ID_USER67:
		return "MAV_COMP_ID_USER67"
	case MAV_COMP_ID_USER68:
		return "MAV_COMP_ID_USER68"
	case MAV_COMP_ID_USER69:
		return "MAV_COMP_ID_USER69"
	case MAV_COMP_ID_USER70:
		return "MAV_COMP_ID_USER70"
	case MAV_COMP_ID_USER71:
		return "MAV_COMP_ID_USER71"
	case MAV_COMP_ID_USER72:
		return "MAV_COMP_ID_USER72"
	case MAV_COMP_ID_USER73:
		return "MAV_COMP_ID_USER73"
	case MAV_COMP_ID_USER74:
		return "MAV_COMP_ID_USER74"
	case MAV_COMP_ID_USER75:
		return "MAV_COMP_ID_USER75"
	...
	case MAV_COMP_ID_ONBOARD_COMPUTER:
		return "MAV_COMP_ID_ONBOARD_COMPUTER"
	...
	case MAV_COMP_ID_PAIRING_MANAGER:
		return "MAV_COMP_ID_PAIRING_MANAGER"
	...
	case MAV_COMP_ID_ODID_TXRX_1:
		return "MAV_COMP_ID_ODID_TXRX_1"
	case MAV_COMP_ID_ODID_TXRX_2:
		return "MAV_COMP_ID_ODID_TXRX_2"
	case MAV_COMP_ID_ODID_TXRX_3:
		return "MAV_COMP_ID_ODID_TXRX_3"
	...
	case MAV_COMP_ID_TUNNEL_NODE:
		return "MAV_COMP_ID_TUNNEL_NODE"
...
func (e UAVIONIX_ADSB_OUT_DYNAMIC_STATE) String() string {
	...
	case UAVIONIX_ADSB_OUT_DYNAMIC_STATE_INTENT_CHANGE:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_STATE_INTENT_CHANGE"
	case UAVIONIX_ADSB_OUT_DYNAMIC_STATE_AUTOPILOT_ENABLED:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_STATE_AUTOPILOT_ENABLED"
	case UAVIONIX_ADSB_OUT_DYNAMIC_STATE_NICBARO_CROSSCHECKED:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_STATE_NICBARO_CROSSCHECKED"
	case UAVIONIX_ADSB_OUT_DYNAMIC_STATE_ON_GROUND:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_STATE_ON_GROUND"
	case UAVIONIX_ADSB_OUT_DYNAMIC_STATE_IDENT:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_STATE_IDENT"
	default:
		return fmt.Sprintf("UAVIONIX_ADSB_OUT_DYNAMIC_STATE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e UAVIONIX_ADSB_OUT_RF_SELECT) String() string {
	...
	case UAVIONIX_ADSB_OUT_RF_SELECT_STANDBY:
		return "UAVIONIX_ADSB_OUT_RF_SELECT_STANDBY"
	case UAVIONIX_ADSB_OUT_RF_SELECT_RX_ENABLED:
		return "UAVIONIX_ADSB_OUT_RF_SELECT_RX_ENABLED"
	case UAVIONIX_ADSB_OUT_RF_SELECT_TX_ENABLED:
		return "UAVIONIX_ADSB_OUT_RF_SELECT_TX_ENABLED"
	default:
...
func (e UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX) String() string {
	...
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_NONE_0:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_NONE_0"
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_NONE_1:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_NONE_1"
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_2D:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_2D"
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_3D:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_3D"
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_DGPS:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_DGPS"
	case UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_RTK:
		return "UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_RTK"
	default:
		return fmt.Sprintf("UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e UAVIONIX_ADSB_RF_HEALTH) String() string {
	...
	case UAVIONIX_ADSB_RF_HEALTH_INITIALIZING:
		return "UAVIONIX_ADSB_RF_HEALTH_INITIALIZING"
	case UAVIONIX_ADSB_RF_HEALTH_OK:
		return "UAVIONIX_ADSB_RF_HEALTH_OK"
	case UAVIONIX_ADSB_RF_HEALTH_FAIL_TX:
		return "UAVIONIX_ADSB_RF_HEALTH_FAIL_TX"
	case UAVIONIX_ADSB_RF_HEALTH_FAIL_RX:
		return "UAVIONIX_ADSB_RF_HEALTH_FAIL_RX"
	default:
...
func (e UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE) String() string {
	...
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_NO_DATA:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_NO_DATA"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L15M_W23M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L15M_W23M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L25M_W28P5M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L25M_W28P5M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L25_34M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L25_34M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L35_33M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L35_33M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L35_38M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L35_38M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L45_39P5M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L45_39P5M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L45_45M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L45_45M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L55_45M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L55_45M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L55_52M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L55_52M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L65_59P5M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L65_59P5M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L65_67M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L65_67M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L75_W72P5M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L75_W72P5M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L75_W80M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L75_W80M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L85_W80M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L85_W80M"
	case UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L85_W90M:
		return "UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_L85_W90M"
	default:
		return fmt.Sprintf("UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT) String() string {
	...
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_NO_DATA:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_NO_DATA"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_2M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_2M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_4M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_4M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_6M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_LEFT_6M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_0M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_0M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_2M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_2M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_4M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_4M"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_6M:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_RIGHT_6M"
	default:
		return fmt.Sprintf("UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT_ENUM_UNDEFINED_%d", int(e))
	}
}
...
func (e UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON) String() string {
	...
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON_NO_DATA:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON_NO_DATA"
	case UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON_APPLIED_BY_SENSOR:
		return "UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON_APPLIED_BY_SENSOR"
	default:
...
func (e UAVIONIX_ADSB_EMERGENCY_STATUS) String() string {
	...
	case UAVIONIX_ADSB_OUT_NO_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_NO_EMERGENCY"
	case UAVIONIX_ADSB_OUT_GENERAL_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_GENERAL_EMERGENCY"
	case UAVIONIX_ADSB_OUT_LIFEGUARD_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_LIFEGUARD_EMERGENCY"
	case UAVIONIX_ADSB_OUT_MINIMUM_FUEL_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_MINIMUM_FUEL_EMERGENCY"
	case UAVIONIX_ADSB_OUT_NO_COMM_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_NO_COMM_EMERGENCY"
	case UAVIONIX_ADSB_OUT_UNLAWFUL_INTERFERANCE_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_UNLAWFUL_INTERFERANCE_EMERGENCY"
	case UAVIONIX_ADSB_OUT_DOWNED_AIRCRAFT_EMERGENCY:
		return "UAVIONIX_ADSB_OUT_DOWNED_AIRCRAFT_EMERGENCY"
	case UAVIONIX_ADSB_OUT_RESERVED:
		return "UAVIONIX_ADSB_OUT_RESERVED"
	default:
		return fmt.Sprintf("UAVIONIX_ADSB_EMERGENCY_STATUS_ENUM_UNDEFINED_%d", int(e))
	}
}
...
type MountConfigure struct {
	TargetSystem    uint8          // System ID.
	TargetComponent uint8          // Component ID.
	MountMode       MAV_MOUNT_MODE `raw:"uint8"` // Mount operating mode.
...
type LimitsStatus struct {
	...
	LimitsState   LIMITS_STATE `raw:"uint8"` // State of AP_Limits.
	ModsEnabled   LIMIT_MODULE `raw:"uint8"` // AP_Limit_Module bitfield of enabled modules.
	ModsRequired  LIMIT_MODULE `raw:"uint8"` // AP_Limit_Module bitfield of required modules.
	ModsTriggered LIMIT_MODULE `raw:"uint8"` // AP_Limit_Module bitfield of triggered modules.
}
...
type RallyPoint struct {
	...
	Count           uint8       // Total number of points (for sanity checking).
	Flags           RALLY_FLAGS `raw:"uint8"` // Configuration flags.
}
...
type CameraStatus struct {
	...
	EventID      CAMERA_STATUS_TYPES `raw:"uint8"` // Event type.
}
...
type CameraFeedback struct {
	...
	TargetSystem uint8                 // System ID.
	CamIdx       uint8                 // Camera ID.
	Flags        CAMERA_FEEDBACK_FLAGS `raw:"uint8"` // Feedback flags.
}
...
type RemoteLogDataBlock struct {
	Seqno           MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS `raw:"uint32"` // Log data block sequence number.
	TargetSystem    uint8                              // System ID.
	TargetComponent uint8                              // Component ID.
...
type RemoteLogBlockStatus struct {
	...
	TargetSystem    uint8                              // System ID.
	TargetComponent uint8                              // Component ID.
	Status          MAV_REMOTE_LOG_DATA_BLOCK_STATUSES `raw:"uint8"` // Log data block status.
}
...
type EkfStatusReport struct {
	...
	Flags              EKF_STATUS_FLAGS `raw:"uint16"` // Flags.
}
...
type PidTuning struct {
	...
	Axis     PID_TUNING_AXIS `raw:"uint8"` // Axis.
}
...
type Deepstall struct {
	...
	Stage                  DEEPSTALL_STAGE `raw:"uint8"` // Deepstall stage.
}
...
type GoproHeartbeat struct {
	Status      GOPRO_HEARTBEAT_STATUS `raw:"uint8"` // Status.
	CaptureMode GOPRO_CAPTURE_MODE     `raw:"uint8"` // Current capture mode.
	Flags       GOPRO_HEARTBEAT_FLAGS  `raw:"uint8"` // Additional status bits.
}
...
type GoproGetRequest struct {
	TargetSystem    uint8         // System ID.
	TargetComponent uint8         // Component ID.
	CmdID           GOPRO_COMMAND `raw:"uint8"` // Command ID.
}
...
type GoproGetResponse struct {
	CmdID  GOPRO_COMMAND        `raw:"uint8"` // Command ID.
	Status GOPRO_REQUEST_STATUS `raw:"uint8"` // Status.
	Value  [4]uint8             // Value.
}
