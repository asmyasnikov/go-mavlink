...
func (e MAV_PREFLIGHT_STORAGE_ACTION) String() string {
	switch e {
	case MAV_PFS_CMD_READ_ALL:
		return "MAV_PFS_CMD_READ_ALL"
	case MAV_PFS_CMD_WRITE_ALL:
		return "MAV_PFS_CMD_WRITE_ALL"
	case MAV_PFS_CMD_CLEAR_ALL:
		return "MAV_PFS_CMD_CLEAR_ALL"
	case MAV_PFS_CMD_READ_SPECIFIC:
		return "MAV_PFS_CMD_READ_SPECIFIC"
	case MAV_PFS_CMD_WRITE_SPECIFIC:
		return "MAV_PFS_CMD_WRITE_SPECIFIC"
	case MAV_PFS_CMD_CLEAR_SPECIFIC:
		return "MAV_PFS_CMD_CLEAR_SPECIFIC"
	case MAV_PFS_CMD_DO_NOTHING:
		return "MAV_PFS_CMD_DO_NOTHING"
	default:
...
func (e MAV_CMD) String() string {
	...
	case MAV_CMD_PREFLIGHT_STORAGE_ADVANCED:
		return "MAV_CMD_PREFLIGHT_STORAGE_ADVANCED"
