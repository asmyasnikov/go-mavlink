...
func init() {
	mavlink.Register(MSG_ID_NAV_FILTER_BIAS, "MSG_ID_NAV_FILTER_BIAS", 32, 34, func(p *mavlink.Packet) mavlink.Message {
		msg := new(NavFilterBias)
		msg.Unpack(p)
		return msg
	})
	mavlink.Register(MSG_ID_RADIO_CALIBRATION, "MSG_ID_RADIO_CALIBRATION", 42, 71, func(p *mavlink.Packet) mavlink.Message {
		msg := new(RadioCalibration)
		msg.Unpack(p)
		return msg
	})
	mavlink.Register(MSG_ID_UALBERTA_SYS_STATUS, "MSG_ID_UALBERTA_SYS_STATUS", 3, 15, func(p *mavlink.Packet) mavlink.Message {
