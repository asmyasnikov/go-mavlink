...
func (e UALBERTA_AUTOPILOT_MODE) String() string {
	switch e {
	case MODE_MANUAL_DIRECT:
		return "MODE_MANUAL_DIRECT"
	case MODE_MANUAL_SCALED:
		return "MODE_MANUAL_SCALED"
	case MODE_AUTO_PID_ATT:
		return "MODE_AUTO_PID_ATT"
	case MODE_AUTO_PID_VEL:
		return "MODE_AUTO_PID_VEL"
	case MODE_AUTO_PID_POS:
		return "MODE_AUTO_PID_POS"
	default:
...
func (e UALBERTA_NAV_MODE) String() string {
	switch e {
	case NAV_AHRS_INIT:
		return "NAV_AHRS_INIT"
	case NAV_AHRS:
		return "NAV_AHRS"
	case NAV_INS_GPS_INIT:
		return "NAV_INS_GPS_INIT"
	case NAV_INS_GPS:
		return "NAV_INS_GPS"
	default:
