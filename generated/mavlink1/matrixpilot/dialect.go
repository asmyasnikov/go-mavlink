...
func (e MAV_PREFLIGHT_STORAGE_ACTION) String() string {
	if name, ok := map[MAV_PREFLIGHT_STORAGE_ACTION]string{MAV_PFS_CMD_READ_ALL: "MAV_PFS_CMD_READ_ALL", MAV_PFS_CMD_WRITE_ALL: "MAV_PFS_CMD_WRITE_ALL", MAV_PFS_CMD_CLEAR_ALL: "MAV_PFS_CMD_CLEAR_ALL", MAV_PFS_CMD_READ_SPECIFIC: "MAV_PFS_CMD_READ_SPECIFIC", MAV_PFS_CMD_WRITE_SPECIFIC: "MAV_PFS_CMD_WRITE_SPECIFIC", MAV_PFS_CMD_CLEAR_SPECIFIC: "MAV_PFS_CMD_CLEAR_SPECIFIC", MAV_PFS_CMD_DO_NOTHING: "MAV_PFS_CMD_DO_NOTHING"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_PREFLIGHT_STORAGE_ACTION_ENUM_UNDEFINED_%d", int(e))
}

// Bitmask return string representetion of intersects MAV_PREFLIGHT_STORAGE_ACTION enums
func (e MAV_PREFLIGHT_STORAGE_ACTION) Bitmask() string {
	bitmap := ""
	for _, entry := range []MAV_PREFLIGHT_STORAGE_ACTION{MAV_PFS_CMD_READ_ALL, MAV_PFS_CMD_WRITE_ALL, MAV_PFS_CMD_CLEAR_ALL, MAV_PFS_CMD_READ_SPECIFIC, MAV_PFS_CMD_WRITE_SPECIFIC, MAV_PFS_CMD_CLEAR_SPECIFIC, MAV_PFS_CMD_DO_NOTHING} {
		if e&entry > 0 {
			if len(bitmap) > 0 {
				bitmap += " | "
			}
