...
func (e GSM_LINK_TYPE) String() string {
	if name, ok := map[GSM_LINK_TYPE]string{GSM_LINK_TYPE_NONE: "GSM_LINK_TYPE_NONE", GSM_LINK_TYPE_UNKNOWN: "GSM_LINK_TYPE_UNKNOWN", GSM_LINK_TYPE_2G: "GSM_LINK_TYPE_2G", GSM_LINK_TYPE_3G: "GSM_LINK_TYPE_3G", GSM_LINK_TYPE_4G: "GSM_LINK_TYPE_4G"}[e]; ok {
		return name
	}
	return fmt.Sprintf("GSM_LINK_TYPE_ENUM_UNDEFINED_%d", int(e))
}

// Bitmask return string representetion of intersects GSM_LINK_TYPE enums
func (e GSM_LINK_TYPE) Bitmask() string {
	bitmap := ""
	for _, entry := range []GSM_LINK_TYPE{GSM_LINK_TYPE_NONE, GSM_LINK_TYPE_UNKNOWN, GSM_LINK_TYPE_2G, GSM_LINK_TYPE_3G, GSM_LINK_TYPE_4G} {
		if e&entry > 0 {
			if len(bitmap) > 0 {
				bitmap += " | "
			}
...
func (e GSM_MODEM_TYPE) String() string {
	if name, ok := map[GSM_MODEM_TYPE]string{GSM_MODEM_TYPE_UNKNOWN: "GSM_MODEM_TYPE_UNKNOWN", GSM_MODEM_TYPE_HUAWEI_E3372: "GSM_MODEM_TYPE_HUAWEI_E3372"}[e]; ok {
		return name
	}
	return fmt.Sprintf("GSM_MODEM_TYPE_ENUM_UNDEFINED_%d", int(e))
}

// Bitmask return string representetion of intersects GSM_MODEM_TYPE enums
func (e GSM_MODEM_TYPE) Bitmask() string {
	bitmap := ""
	for _, entry := range []GSM_MODEM_TYPE{GSM_MODEM_TYPE_UNKNOWN, GSM_MODEM_TYPE_HUAWEI_E3372} {
		if e&entry > 0 {
			if len(bitmap) > 0 {
				bitmap += " | "
			}
...
func (e FIRMWARE_VERSION_TYPE) String() string {
	if name, ok := map[FIRMWARE_VERSION_TYPE]string{FIRMWARE_VERSION_TYPE_DEV: "FIRMWARE_VERSION_TYPE_DEV", FIRMWARE_VERSION_TYPE_ALPHA: "FIRMWARE_VERSION_TYPE_ALPHA", FIRMWARE_VERSION_TYPE_BETA: "FIRMWARE_VERSION_TYPE_BETA", FIRMWARE_VERSION_TYPE_RC: "FIRMWARE_VERSION_TYPE_RC", FIRMWARE_VERSION_TYPE_OFFICIAL: "FIRMWARE_VERSION_TYPE_OFFICIAL"}[e]; ok {
		return name
	}
...
func (e HL_FAILURE_FLAG) String() string {
	if name, ok := map[HL_FAILURE_FLAG]string{HL_FAILURE_FLAG_GPS: "HL_FAILURE_FLAG_GPS", HL_FAILURE_FLAG_DIFFERENTIAL_PRESSURE: "HL_FAILURE_FLAG_DIFFERENTIAL_PRESSURE", HL_FAILURE_FLAG_ABSOLUTE_PRESSURE: "HL_FAILURE_FLAG_ABSOLUTE_PRESSURE", HL_FAILURE_FLAG_3D_ACCEL: "HL_FAILURE_FLAG_3D_ACCEL", HL_FAILURE_FLAG_3D_GYRO: "HL_FAILURE_FLAG_3D_GYRO", HL_FAILURE_FLAG_3D_MAG: "HL_FAILURE_FLAG_3D_MAG", HL_FAILURE_FLAG_TERRAIN: "HL_FAILURE_FLAG_TERRAIN", HL_FAILURE_FLAG_BATTERY: "HL_FAILURE_FLAG_BATTERY", HL_FAILURE_FLAG_RC_RECEIVER: "HL_FAILURE_FLAG_RC_RECEIVER", HL_FAILURE_FLAG_OFFBOARD_LINK: "HL_FAILURE_FLAG_OFFBOARD_LINK", HL_FAILURE_FLAG_ENGINE: "HL_FAILURE_FLAG_ENGINE", HL_FAILURE_FLAG_GEOFENCE: "HL_FAILURE_FLAG_GEOFENCE", HL_FAILURE_FLAG_ESTIMATOR: "HL_FAILURE_FLAG_ESTIMATOR", HL_FAILURE_FLAG_MISSION: "HL_FAILURE_FLAG_MISSION"}[e]; ok {
		return name
	}
	return fmt.Sprintf("HL_FAILURE_FLAG_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_GOTO) String() string {
	if name, ok := map[MAV_GOTO]string{MAV_GOTO_DO_HOLD: "MAV_GOTO_DO_HOLD", MAV_GOTO_DO_CONTINUE: "MAV_GOTO_DO_CONTINUE", MAV_GOTO_HOLD_AT_CURRENT_POSITION: "MAV_GOTO_HOLD_AT_CURRENT_POSITION", MAV_GOTO_HOLD_AT_SPECIFIED_POSITION: "MAV_GOTO_HOLD_AT_SPECIFIED_POSITION"}[e]; ok {
		return name
	}
...
func (e MAV_MODE) String() string {
	if name, ok := map[MAV_MODE]string{MAV_MODE_PREFLIGHT: "MAV_MODE_PREFLIGHT", MAV_MODE_STABILIZE_DISARMED: "MAV_MODE_STABILIZE_DISARMED", MAV_MODE_STABILIZE_ARMED: "MAV_MODE_STABILIZE_ARMED", MAV_MODE_MANUAL_DISARMED: "MAV_MODE_MANUAL_DISARMED", MAV_MODE_MANUAL_ARMED: "MAV_MODE_MANUAL_ARMED", MAV_MODE_GUIDED_DISARMED: "MAV_MODE_GUIDED_DISARMED", MAV_MODE_GUIDED_ARMED: "MAV_MODE_GUIDED_ARMED", MAV_MODE_AUTO_DISARMED: "MAV_MODE_AUTO_DISARMED", MAV_MODE_AUTO_ARMED: "MAV_MODE_AUTO_ARMED", MAV_MODE_TEST_DISARMED: "MAV_MODE_TEST_DISARMED", MAV_MODE_TEST_ARMED: "MAV_MODE_TEST_ARMED"}[e]; ok {
		return name
	}
...
func (e MAVLINK_DATA_STREAM_TYPE) String() string {
	if name, ok := map[MAVLINK_DATA_STREAM_TYPE]string{MAVLINK_DATA_STREAM_IMG_JPEG: "MAVLINK_DATA_STREAM_IMG_JPEG", MAVLINK_DATA_STREAM_IMG_BMP: "MAVLINK_DATA_STREAM_IMG_BMP", MAVLINK_DATA_STREAM_IMG_RAW8U: "MAVLINK_DATA_STREAM_IMG_RAW8U", MAVLINK_DATA_STREAM_IMG_RAW32U: "MAVLINK_DATA_STREAM_IMG_RAW32U", MAVLINK_DATA_STREAM_IMG_PGM: "MAVLINK_DATA_STREAM_IMG_PGM", MAVLINK_DATA_STREAM_IMG_PNG: "MAVLINK_DATA_STREAM_IMG_PNG"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAVLINK_DATA_STREAM_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e FENCE_ACTION) String() string {
	if name, ok := map[FENCE_ACTION]string{FENCE_ACTION_NONE: "FENCE_ACTION_NONE", FENCE_ACTION_GUIDED: "FENCE_ACTION_GUIDED", FENCE_ACTION_REPORT: "FENCE_ACTION_REPORT", FENCE_ACTION_GUIDED_THR_PASS: "FENCE_ACTION_GUIDED_THR_PASS", FENCE_ACTION_RTL: "FENCE_ACTION_RTL"}[e]; ok {
		return name
	}
	return fmt.Sprintf("FENCE_ACTION_ENUM_UNDEFINED_%d", int(e))
}
...
func (e FENCE_BREACH) String() string {
	if name, ok := map[FENCE_BREACH]string{FENCE_BREACH_NONE: "FENCE_BREACH_NONE", FENCE_BREACH_MINALT: "FENCE_BREACH_MINALT", FENCE_BREACH_MAXALT: "FENCE_BREACH_MAXALT", FENCE_BREACH_BOUNDARY: "FENCE_BREACH_BOUNDARY"}[e]; ok {
		return name
	}
	return fmt.Sprintf("FENCE_BREACH_ENUM_UNDEFINED_%d", int(e))
}
...
func (e FENCE_MITIGATE) String() string {
	if name, ok := map[FENCE_MITIGATE]string{FENCE_MITIGATE_UNKNOWN: "FENCE_MITIGATE_UNKNOWN", FENCE_MITIGATE_NONE: "FENCE_MITIGATE_NONE", FENCE_MITIGATE_VEL_LIMIT: "FENCE_MITIGATE_VEL_LIMIT"}[e]; ok {
		return name
	}
...
func (e MAV_MOUNT_MODE) String() string {
	if name, ok := map[MAV_MOUNT_MODE]string{MAV_MOUNT_MODE_RETRACT: "MAV_MOUNT_MODE_RETRACT", MAV_MOUNT_MODE_NEUTRAL: "MAV_MOUNT_MODE_NEUTRAL", MAV_MOUNT_MODE_MAVLINK_TARGETING: "MAV_MOUNT_MODE_MAVLINK_TARGETING", MAV_MOUNT_MODE_RC_TARGETING: "MAV_MOUNT_MODE_RC_TARGETING", MAV_MOUNT_MODE_GPS_POINT: "MAV_MOUNT_MODE_GPS_POINT", MAV_MOUNT_MODE_SYSID_TARGET: "MAV_MOUNT_MODE_SYSID_TARGET", MAV_MOUNT_MODE_HOME_LOCATION: "MAV_MOUNT_MODE_HOME_LOCATION"}[e]; ok {
		return name
	}
...
func (e GIMBAL_MANAGER_FLAGS) String() string {
	if name, ok := map[GIMBAL_MANAGER_FLAGS]string{GIMBAL_MANAGER_FLAGS_RETRACT: "GIMBAL_MANAGER_FLAGS_RETRACT", GIMBAL_MANAGER_FLAGS_NEUTRAL: "GIMBAL_MANAGER_FLAGS_NEUTRAL", GIMBAL_MANAGER_FLAGS_ROLL_LOCK: "GIMBAL_MANAGER_FLAGS_ROLL_LOCK", GIMBAL_MANAGER_FLAGS_PITCH_LOCK: "GIMBAL_MANAGER_FLAGS_PITCH_LOCK", GIMBAL_MANAGER_FLAGS_YAW_LOCK: "GIMBAL_MANAGER_FLAGS_YAW_LOCK"}[e]; ok {
		return name
	}
...
func (e GRIPPER_ACTIONS) String() string {
	if name, ok := map[GRIPPER_ACTIONS]string{GRIPPER_ACTION_RELEASE: "GRIPPER_ACTION_RELEASE", GRIPPER_ACTION_GRAB: "GRIPPER_ACTION_GRAB"}[e]; ok {
		return name
	}
...
func (e WINCH_ACTIONS) String() string {
	if name, ok := map[WINCH_ACTIONS]string{WINCH_RELAXED: "WINCH_RELAXED", WINCH_RELATIVE_LENGTH_CONTROL: "WINCH_RELATIVE_LENGTH_CONTROL", WINCH_RATE_CONTROL: "WINCH_RATE_CONTROL"}[e]; ok {
		return name
	}
...
func (e UAVCAN_NODE_HEALTH) String() string {
	if name, ok := map[UAVCAN_NODE_HEALTH]string{UAVCAN_NODE_HEALTH_OK: "UAVCAN_NODE_HEALTH_OK", UAVCAN_NODE_HEALTH_WARNING: "UAVCAN_NODE_HEALTH_WARNING", UAVCAN_NODE_HEALTH_ERROR: "UAVCAN_NODE_HEALTH_ERROR", UAVCAN_NODE_HEALTH_CRITICAL: "UAVCAN_NODE_HEALTH_CRITICAL"}[e]; ok {
		return name
	}
...
func (e UAVCAN_NODE_MODE) String() string {
	if name, ok := map[UAVCAN_NODE_MODE]string{UAVCAN_NODE_MODE_OPERATIONAL: "UAVCAN_NODE_MODE_OPERATIONAL", UAVCAN_NODE_MODE_INITIALIZATION: "UAVCAN_NODE_MODE_INITIALIZATION", UAVCAN_NODE_MODE_MAINTENANCE: "UAVCAN_NODE_MODE_MAINTENANCE", UAVCAN_NODE_MODE_SOFTWARE_UPDATE: "UAVCAN_NODE_MODE_SOFTWARE_UPDATE", UAVCAN_NODE_MODE_OFFLINE: "UAVCAN_NODE_MODE_OFFLINE"}[e]; ok {
		return name
	}
...
func (e ESC_CONNECTION_TYPE) String() string {
	if name, ok := map[ESC_CONNECTION_TYPE]string{ESC_CONNECTION_TYPE_PPM: "ESC_CONNECTION_TYPE_PPM", ESC_CONNECTION_TYPE_SERIAL: "ESC_CONNECTION_TYPE_SERIAL", ESC_CONNECTION_TYPE_ONESHOT: "ESC_CONNECTION_TYPE_ONESHOT", ESC_CONNECTION_TYPE_I2C: "ESC_CONNECTION_TYPE_I2C", ESC_CONNECTION_TYPE_CAN: "ESC_CONNECTION_TYPE_CAN", ESC_CONNECTION_TYPE_DSHOT: "ESC_CONNECTION_TYPE_DSHOT"}[e]; ok {
		return name
	}
...
func (e ESC_FAILURE_FLAGS) String() string {
	if name, ok := map[ESC_FAILURE_FLAGS]string{ESC_FAILURE_NONE: "ESC_FAILURE_NONE", ESC_FAILURE_OVER_CURRENT: "ESC_FAILURE_OVER_CURRENT", ESC_FAILURE_OVER_VOLTAGE: "ESC_FAILURE_OVER_VOLTAGE", ESC_FAILURE_OVER_TEMPERATURE: "ESC_FAILURE_OVER_TEMPERATURE", ESC_FAILURE_OVER_RPM: "ESC_FAILURE_OVER_RPM", ESC_FAILURE_INCONSISTENT_CMD: "ESC_FAILURE_INCONSISTENT_CMD", ESC_FAILURE_MOTOR_STUCK: "ESC_FAILURE_MOTOR_STUCK", ESC_FAILURE_GENERIC: "ESC_FAILURE_GENERIC"}[e]; ok {
		return name
	}
	return fmt.Sprintf("ESC_FAILURE_FLAGS_ENUM_UNDEFINED_%d", int(e))
}
...
func (e STORAGE_STATUS) String() string {
	if name, ok := map[STORAGE_STATUS]string{STORAGE_STATUS_EMPTY: "STORAGE_STATUS_EMPTY", STORAGE_STATUS_UNFORMATTED: "STORAGE_STATUS_UNFORMATTED", STORAGE_STATUS_READY: "STORAGE_STATUS_READY", STORAGE_STATUS_NOT_SUPPORTED: "STORAGE_STATUS_NOT_SUPPORTED"}[e]; ok {
		return name
	}
...
func (e STORAGE_TYPE) String() string {
	if name, ok := map[STORAGE_TYPE]string{STORAGE_TYPE_UNKNOWN: "STORAGE_TYPE_UNKNOWN", STORAGE_TYPE_USB_STICK: "STORAGE_TYPE_USB_STICK", STORAGE_TYPE_SD: "STORAGE_TYPE_SD", STORAGE_TYPE_MICROSD: "STORAGE_TYPE_MICROSD", STORAGE_TYPE_CF: "STORAGE_TYPE_CF", STORAGE_TYPE_CFE: "STORAGE_TYPE_CFE", STORAGE_TYPE_XQD: "STORAGE_TYPE_XQD", STORAGE_TYPE_HD: "STORAGE_TYPE_HD", STORAGE_TYPE_OTHER: "STORAGE_TYPE_OTHER"}[e]; ok {
		return name
	}
	return fmt.Sprintf("STORAGE_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e ORBIT_YAW_BEHAVIOUR) String() string {
	if name, ok := map[ORBIT_YAW_BEHAVIOUR]string{ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TO_CIRCLE_CENTER: "ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TO_CIRCLE_CENTER", ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING: "ORBIT_YAW_BEHAVIOUR_HOLD_INITIAL_HEADING", ORBIT_YAW_BEHAVIOUR_UNCONTROLLED: "ORBIT_YAW_BEHAVIOUR_UNCONTROLLED", ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE: "ORBIT_YAW_BEHAVIOUR_HOLD_FRONT_TANGENT_TO_CIRCLE", ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED: "ORBIT_YAW_BEHAVIOUR_RC_CONTROLLED"}[e]; ok {
		return name
	}
...
func (e WIFI_CONFIG_AP_RESPONSE) String() string {
	if name, ok := map[WIFI_CONFIG_AP_RESPONSE]string{WIFI_CONFIG_AP_RESPONSE_UNDEFINED: "WIFI_CONFIG_AP_RESPONSE_UNDEFINED", WIFI_CONFIG_AP_RESPONSE_ACCEPTED: "WIFI_CONFIG_AP_RESPONSE_ACCEPTED", WIFI_CONFIG_AP_RESPONSE_REJECTED: "WIFI_CONFIG_AP_RESPONSE_REJECTED", WIFI_CONFIG_AP_RESPONSE_MODE_ERROR: "WIFI_CONFIG_AP_RESPONSE_MODE_ERROR", WIFI_CONFIG_AP_RESPONSE_SSID_ERROR: "WIFI_CONFIG_AP_RESPONSE_SSID_ERROR", WIFI_CONFIG_AP_RESPONSE_PASSWORD_ERROR: "WIFI_CONFIG_AP_RESPONSE_PASSWORD_ERROR"}[e]; ok {
		return name
	}
	return fmt.Sprintf("WIFI_CONFIG_AP_RESPONSE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e WIFI_CONFIG_AP_MODE) String() string {
	if name, ok := map[WIFI_CONFIG_AP_MODE]string{WIFI_CONFIG_AP_MODE_UNDEFINED: "WIFI_CONFIG_AP_MODE_UNDEFINED", WIFI_CONFIG_AP_MODE_AP: "WIFI_CONFIG_AP_MODE_AP", WIFI_CONFIG_AP_MODE_STATION: "WIFI_CONFIG_AP_MODE_STATION", WIFI_CONFIG_AP_MODE_DISABLED: "WIFI_CONFIG_AP_MODE_DISABLED"}[e]; ok {
		return name
	}
	return fmt.Sprintf("WIFI_CONFIG_AP_MODE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e COMP_METADATA_TYPE) String() string {
	if name, ok := map[COMP_METADATA_TYPE]string{COMP_METADATA_TYPE_VERSION: "COMP_METADATA_TYPE_VERSION", COMP_METADATA_TYPE_PARAMETER: "COMP_METADATA_TYPE_PARAMETER", COMP_METADATA_TYPE_COMMANDS: "COMP_METADATA_TYPE_COMMANDS"}[e]; ok {
		return name
	}
	return fmt.Sprintf("COMP_METADATA_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e PARAM_TRANSACTION_TRANSPORT) String() string {
	if name, ok := map[PARAM_TRANSACTION_TRANSPORT]string{PARAM_TRANSACTION_TRANSPORT_PARAM: "PARAM_TRANSACTION_TRANSPORT_PARAM", PARAM_TRANSACTION_TRANSPORT_PARAM_EXT: "PARAM_TRANSACTION_TRANSPORT_PARAM_EXT"}[e]; ok {
		return name
	}
...
func (e PARAM_TRANSACTION_ACTION) String() string {
	if name, ok := map[PARAM_TRANSACTION_ACTION]string{PARAM_TRANSACTION_ACTION_START: "PARAM_TRANSACTION_ACTION_START", PARAM_TRANSACTION_ACTION_COMMIT: "PARAM_TRANSACTION_ACTION_COMMIT", PARAM_TRANSACTION_ACTION_CANCEL: "PARAM_TRANSACTION_ACTION_CANCEL"}[e]; ok {
		return name
	}
...
func (e MAV_ROI) String() string {
	if name, ok := map[MAV_ROI]string{MAV_ROI_NONE: "MAV_ROI_NONE", MAV_ROI_WPNEXT: "MAV_ROI_WPNEXT", MAV_ROI_WPINDEX: "MAV_ROI_WPINDEX", MAV_ROI_LOCATION: "MAV_ROI_LOCATION", MAV_ROI_TARGET: "MAV_ROI_TARGET"}[e]; ok {
		return name
	}
...
func (e MAV_CMD_ACK) String() string {
	if name, ok := map[MAV_CMD_ACK]string{MAV_CMD_ACK_OK: "MAV_CMD_ACK_OK", MAV_CMD_ACK_ERR_FAIL: "MAV_CMD_ACK_ERR_FAIL", MAV_CMD_ACK_ERR_ACCESS_DENIED: "MAV_CMD_ACK_ERR_ACCESS_DENIED", MAV_CMD_ACK_ERR_NOT_SUPPORTED: "MAV_CMD_ACK_ERR_NOT_SUPPORTED", MAV_CMD_ACK_ERR_COORDINATE_FRAME_NOT_SUPPORTED: "MAV_CMD_ACK_ERR_COORDINATE_FRAME_NOT_SUPPORTED", MAV_CMD_ACK_ERR_COORDINATES_OUT_OF_RANGE: "MAV_CMD_ACK_ERR_COORDINATES_OUT_OF_RANGE", MAV_CMD_ACK_ERR_X_LAT_OUT_OF_RANGE: "MAV_CMD_ACK_ERR_X_LAT_OUT_OF_RANGE", MAV_CMD_ACK_ERR_Y_LON_OUT_OF_RANGE: "MAV_CMD_ACK_ERR_Y_LON_OUT_OF_RANGE", MAV_CMD_ACK_ERR_Z_ALT_OUT_OF_RANGE: "MAV_CMD_ACK_ERR_Z_ALT_OUT_OF_RANGE"}[e]; ok {
		return name
	}
...
func (e MAV_PARAM_TYPE) String() string {
	if name, ok := map[MAV_PARAM_TYPE]string{MAV_PARAM_TYPE_UINT8: "MAV_PARAM_TYPE_UINT8", MAV_PARAM_TYPE_INT8: "MAV_PARAM_TYPE_INT8", MAV_PARAM_TYPE_UINT16: "MAV_PARAM_TYPE_UINT16", MAV_PARAM_TYPE_INT16: "MAV_PARAM_TYPE_INT16", MAV_PARAM_TYPE_UINT32: "MAV_PARAM_TYPE_UINT32", MAV_PARAM_TYPE_INT32: "MAV_PARAM_TYPE_INT32", MAV_PARAM_TYPE_UINT64: "MAV_PARAM_TYPE_UINT64", MAV_PARAM_TYPE_INT64: "MAV_PARAM_TYPE_INT64", MAV_PARAM_TYPE_REAL32: "MAV_PARAM_TYPE_REAL32", MAV_PARAM_TYPE_REAL64: "MAV_PARAM_TYPE_REAL64"}[e]; ok {
		return name
	}
...
func (e MAV_MISSION_RESULT) String() string {
	if name, ok := map[MAV_MISSION_RESULT]string{MAV_MISSION_ACCEPTED: "MAV_MISSION_ACCEPTED", MAV_MISSION_ERROR: "MAV_MISSION_ERROR", MAV_MISSION_UNSUPPORTED_FRAME: "MAV_MISSION_UNSUPPORTED_FRAME", MAV_MISSION_UNSUPPORTED: "MAV_MISSION_UNSUPPORTED", MAV_MISSION_NO_SPACE: "MAV_MISSION_NO_SPACE", MAV_MISSION_INVALID: "MAV_MISSION_INVALID", MAV_MISSION_INVALID_PARAM1: "MAV_MISSION_INVALID_PARAM1", MAV_MISSION_INVALID_PARAM2: "MAV_MISSION_INVALID_PARAM2", MAV_MISSION_INVALID_PARAM3: "MAV_MISSION_INVALID_PARAM3", MAV_MISSION_INVALID_PARAM4: "MAV_MISSION_INVALID_PARAM4", MAV_MISSION_INVALID_PARAM5_X: "MAV_MISSION_INVALID_PARAM5_X", MAV_MISSION_INVALID_PARAM6_Y: "MAV_MISSION_INVALID_PARAM6_Y", MAV_MISSION_INVALID_PARAM7: "MAV_MISSION_INVALID_PARAM7", MAV_MISSION_INVALID_SEQUENCE: "MAV_MISSION_INVALID_SEQUENCE", MAV_MISSION_DENIED: "MAV_MISSION_DENIED", MAV_MISSION_OPERATION_CANCELLED: "MAV_MISSION_OPERATION_CANCELLED"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_MISSION_RESULT_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_SEVERITY) String() string {
	if name, ok := map[MAV_SEVERITY]string{MAV_SEVERITY_EMERGENCY: "MAV_SEVERITY_EMERGENCY", MAV_SEVERITY_ALERT: "MAV_SEVERITY_ALERT", MAV_SEVERITY_CRITICAL: "MAV_SEVERITY_CRITICAL", MAV_SEVERITY_ERROR: "MAV_SEVERITY_ERROR", MAV_SEVERITY_WARNING: "MAV_SEVERITY_WARNING", MAV_SEVERITY_NOTICE: "MAV_SEVERITY_NOTICE", MAV_SEVERITY_INFO: "MAV_SEVERITY_INFO", MAV_SEVERITY_DEBUG: "MAV_SEVERITY_DEBUG"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_SEVERITY_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_POWER_STATUS) String() string {
	if name, ok := map[MAV_POWER_STATUS]string{MAV_POWER_STATUS_BRICK_VALID: "MAV_POWER_STATUS_BRICK_VALID", MAV_POWER_STATUS_SERVO_VALID: "MAV_POWER_STATUS_SERVO_VALID", MAV_POWER_STATUS_USB_CONNECTED: "MAV_POWER_STATUS_USB_CONNECTED", MAV_POWER_STATUS_PERIPH_OVERCURRENT: "MAV_POWER_STATUS_PERIPH_OVERCURRENT", MAV_POWER_STATUS_PERIPH_HIPOWER_OVERCURRENT: "MAV_POWER_STATUS_PERIPH_HIPOWER_OVERCURRENT", MAV_POWER_STATUS_CHANGED: "MAV_POWER_STATUS_CHANGED"}[e]; ok {
		return name
	}
...
func (e SERIAL_CONTROL_FLAG) String() string {
	if name, ok := map[SERIAL_CONTROL_FLAG]string{SERIAL_CONTROL_FLAG_REPLY: "SERIAL_CONTROL_FLAG_REPLY", SERIAL_CONTROL_FLAG_RESPOND: "SERIAL_CONTROL_FLAG_RESPOND", SERIAL_CONTROL_FLAG_EXCLUSIVE: "SERIAL_CONTROL_FLAG_EXCLUSIVE", SERIAL_CONTROL_FLAG_BLOCKING: "SERIAL_CONTROL_FLAG_BLOCKING", SERIAL_CONTROL_FLAG_MULTI: "SERIAL_CONTROL_FLAG_MULTI"}[e]; ok {
		return name
	}
	return fmt.Sprintf("SERIAL_CONTROL_FLAG_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_DISTANCE_SENSOR) String() string {
	if name, ok := map[MAV_DISTANCE_SENSOR]string{MAV_DISTANCE_SENSOR_LASER: "MAV_DISTANCE_SENSOR_LASER", MAV_DISTANCE_SENSOR_ULTRASOUND: "MAV_DISTANCE_SENSOR_ULTRASOUND", MAV_DISTANCE_SENSOR_INFRARED: "MAV_DISTANCE_SENSOR_INFRARED", MAV_DISTANCE_SENSOR_RADAR: "MAV_DISTANCE_SENSOR_RADAR", MAV_DISTANCE_SENSOR_UNKNOWN: "MAV_DISTANCE_SENSOR_UNKNOWN"}[e]; ok {
		return name
	}
...
func (e MAV_PROTOCOL_CAPABILITY) String() string {
	if name, ok := map[MAV_PROTOCOL_CAPABILITY]string{MAV_PROTOCOL_CAPABILITY_MISSION_FLOAT: "MAV_PROTOCOL_CAPABILITY_MISSION_FLOAT", MAV_PROTOCOL_CAPABILITY_PARAM_FLOAT: "MAV_PROTOCOL_CAPABILITY_PARAM_FLOAT", MAV_PROTOCOL_CAPABILITY_MISSION_INT: "MAV_PROTOCOL_CAPABILITY_MISSION_INT", MAV_PROTOCOL_CAPABILITY_COMMAND_INT: "MAV_PROTOCOL_CAPABILITY_COMMAND_INT", MAV_PROTOCOL_CAPABILITY_PARAM_UNION: "MAV_PROTOCOL_CAPABILITY_PARAM_UNION", MAV_PROTOCOL_CAPABILITY_FTP: "MAV_PROTOCOL_CAPABILITY_FTP", MAV_PROTOCOL_CAPABILITY_SET_ATTITUDE_TARGET: "MAV_PROTOCOL_CAPABILITY_SET_ATTITUDE_TARGET", MAV_PROTOCOL_CAPABILITY_SET_POSITION_TARGET_LOCAL_NED: "MAV_PROTOCOL_CAPABILITY_SET_POSITION_TARGET_LOCAL_NED", MAV_PROTOCOL_CAPABILITY_SET_POSITION_TARGET_GLOBAL_INT: "MAV_PROTOCOL_CAPABILITY_SET_POSITION_TARGET_GLOBAL_INT", MAV_PROTOCOL_CAPABILITY_TERRAIN: "MAV_PROTOCOL_CAPABILITY_TERRAIN", MAV_PROTOCOL_CAPABILITY_SET_ACTUATOR_TARGET: "MAV_PROTOCOL_CAPABILITY_SET_ACTUATOR_TARGET", MAV_PROTOCOL_CAPABILITY_FLIGHT_TERMINATION: "MAV_PROTOCOL_CAPABILITY_FLIGHT_TERMINATION", MAV_PROTOCOL_CAPABILITY_COMPASS_CALIBRATION: "MAV_PROTOCOL_CAPABILITY_COMPASS_CALIBRATION", MAV_PROTOCOL_CAPABILITY_MAVLINK2: "MAV_PROTOCOL_CAPABILITY_MAVLINK2", MAV_PROTOCOL_CAPABILITY_MISSION_FENCE: "MAV_PROTOCOL_CAPABILITY_MISSION_FENCE", MAV_PROTOCOL_CAPABILITY_MISSION_RALLY: "MAV_PROTOCOL_CAPABILITY_MISSION_RALLY", MAV_PROTOCOL_CAPABILITY_FLIGHT_INFORMATION: "MAV_PROTOCOL_CAPABILITY_FLIGHT_INFORMATION"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_PROTOCOL_CAPABILITY_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_MISSION_TYPE) String() string {
	if name, ok := map[MAV_MISSION_TYPE]string{MAV_MISSION_TYPE_MISSION: "MAV_MISSION_TYPE_MISSION", MAV_MISSION_TYPE_FENCE: "MAV_MISSION_TYPE_FENCE", MAV_MISSION_TYPE_RALLY: "MAV_MISSION_TYPE_RALLY", MAV_MISSION_TYPE_ALL: "MAV_MISSION_TYPE_ALL"}[e]; ok {
		return name
	}
...
func (e MAV_ESTIMATOR_TYPE) String() string {
	if name, ok := map[MAV_ESTIMATOR_TYPE]string{MAV_ESTIMATOR_TYPE_UNKNOWN: "MAV_ESTIMATOR_TYPE_UNKNOWN", MAV_ESTIMATOR_TYPE_NAIVE: "MAV_ESTIMATOR_TYPE_NAIVE", MAV_ESTIMATOR_TYPE_VISION: "MAV_ESTIMATOR_TYPE_VISION", MAV_ESTIMATOR_TYPE_VIO: "MAV_ESTIMATOR_TYPE_VIO", MAV_ESTIMATOR_TYPE_GPS: "MAV_ESTIMATOR_TYPE_GPS", MAV_ESTIMATOR_TYPE_GPS_INS: "MAV_ESTIMATOR_TYPE_GPS_INS", MAV_ESTIMATOR_TYPE_MOCAP: "MAV_ESTIMATOR_TYPE_MOCAP", MAV_ESTIMATOR_TYPE_LIDAR: "MAV_ESTIMATOR_TYPE_LIDAR", MAV_ESTIMATOR_TYPE_AUTOPILOT: "MAV_ESTIMATOR_TYPE_AUTOPILOT"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ESTIMATOR_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_BATTERY_TYPE) String() string {
	if name, ok := map[MAV_BATTERY_TYPE]string{MAV_BATTERY_TYPE_UNKNOWN: "MAV_BATTERY_TYPE_UNKNOWN", MAV_BATTERY_TYPE_LIPO: "MAV_BATTERY_TYPE_LIPO", MAV_BATTERY_TYPE_LIFE: "MAV_BATTERY_TYPE_LIFE", MAV_BATTERY_TYPE_LION: "MAV_BATTERY_TYPE_LION", MAV_BATTERY_TYPE_NIMH: "MAV_BATTERY_TYPE_NIMH"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_BATTERY_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_BATTERY_CHARGE_STATE) String() string {
	if name, ok := map[MAV_BATTERY_CHARGE_STATE]string{MAV_BATTERY_CHARGE_STATE_UNDEFINED: "MAV_BATTERY_CHARGE_STATE_UNDEFINED", MAV_BATTERY_CHARGE_STATE_OK: "MAV_BATTERY_CHARGE_STATE_OK", MAV_BATTERY_CHARGE_STATE_LOW: "MAV_BATTERY_CHARGE_STATE_LOW", MAV_BATTERY_CHARGE_STATE_CRITICAL: "MAV_BATTERY_CHARGE_STATE_CRITICAL", MAV_BATTERY_CHARGE_STATE_EMERGENCY: "MAV_BATTERY_CHARGE_STATE_EMERGENCY", MAV_BATTERY_CHARGE_STATE_FAILED: "MAV_BATTERY_CHARGE_STATE_FAILED", MAV_BATTERY_CHARGE_STATE_UNHEALTHY: "MAV_BATTERY_CHARGE_STATE_UNHEALTHY", MAV_BATTERY_CHARGE_STATE_CHARGING: "MAV_BATTERY_CHARGE_STATE_CHARGING"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_BATTERY_CHARGE_STATE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_BATTERY_MODE) String() string {
	if name, ok := map[MAV_BATTERY_MODE]string{MAV_BATTERY_MODE_UNKNOWN: "MAV_BATTERY_MODE_UNKNOWN", MAV_BATTERY_MODE_AUTO_DISCHARGING: "MAV_BATTERY_MODE_AUTO_DISCHARGING", MAV_BATTERY_MODE_HOT_SWAP: "MAV_BATTERY_MODE_HOT_SWAP"}[e]; ok {
		return name
	}
...
func (e MAV_VTOL_STATE) String() string {
	if name, ok := map[MAV_VTOL_STATE]string{MAV_VTOL_STATE_UNDEFINED: "MAV_VTOL_STATE_UNDEFINED", MAV_VTOL_STATE_TRANSITION_TO_FW: "MAV_VTOL_STATE_TRANSITION_TO_FW", MAV_VTOL_STATE_TRANSITION_TO_MC: "MAV_VTOL_STATE_TRANSITION_TO_MC", MAV_VTOL_STATE_MC: "MAV_VTOL_STATE_MC", MAV_VTOL_STATE_FW: "MAV_VTOL_STATE_FW"}[e]; ok {
		return name
	}
...
func (e MAV_LANDED_STATE) String() string {
	if name, ok := map[MAV_LANDED_STATE]string{MAV_LANDED_STATE_UNDEFINED: "MAV_LANDED_STATE_UNDEFINED", MAV_LANDED_STATE_ON_GROUND: "MAV_LANDED_STATE_ON_GROUND", MAV_LANDED_STATE_IN_AIR: "MAV_LANDED_STATE_IN_AIR", MAV_LANDED_STATE_TAKEOFF: "MAV_LANDED_STATE_TAKEOFF", MAV_LANDED_STATE_LANDING: "MAV_LANDED_STATE_LANDING"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_LANDED_STATE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e ADSB_ALTITUDE_TYPE) String() string {
	if name, ok := map[ADSB_ALTITUDE_TYPE]string{ADSB_ALTITUDE_TYPE_PRESSURE_QNH: "ADSB_ALTITUDE_TYPE_PRESSURE_QNH", ADSB_ALTITUDE_TYPE_GEOMETRIC: "ADSB_ALTITUDE_TYPE_GEOMETRIC"}[e]; ok {
		return name
	}
...
func (e MAV_DO_REPOSITION_FLAGS) String() string {
	if name, ok := map[MAV_DO_REPOSITION_FLAGS]string{MAV_DO_REPOSITION_FLAGS_CHANGE_MODE: "MAV_DO_REPOSITION_FLAGS_CHANGE_MODE"}[e]; ok {
		return name
	}
...
func (e ESTIMATOR_STATUS_FLAGS) String() string {
	if name, ok := map[ESTIMATOR_STATUS_FLAGS]string{ESTIMATOR_ATTITUDE: "ESTIMATOR_ATTITUDE", ESTIMATOR_VELOCITY_HORIZ: "ESTIMATOR_VELOCITY_HORIZ", ESTIMATOR_VELOCITY_VERT: "ESTIMATOR_VELOCITY_VERT", ESTIMATOR_POS_HORIZ_REL: "ESTIMATOR_POS_HORIZ_REL", ESTIMATOR_POS_HORIZ_ABS: "ESTIMATOR_POS_HORIZ_ABS", ESTIMATOR_POS_VERT_ABS: "ESTIMATOR_POS_VERT_ABS", ESTIMATOR_POS_VERT_AGL: "ESTIMATOR_POS_VERT_AGL", ESTIMATOR_CONST_POS_MODE: "ESTIMATOR_CONST_POS_MODE", ESTIMATOR_PRED_POS_HORIZ_REL: "ESTIMATOR_PRED_POS_HORIZ_REL", ESTIMATOR_PRED_POS_HORIZ_ABS: "ESTIMATOR_PRED_POS_HORIZ_ABS", ESTIMATOR_GPS_GLITCH: "ESTIMATOR_GPS_GLITCH", ESTIMATOR_ACCEL_ERROR: "ESTIMATOR_ACCEL_ERROR"}[e]; ok {
		return name
	}
	return fmt.Sprintf("ESTIMATOR_STATUS_FLAGS_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MOTOR_TEST_ORDER) String() string {
	if name, ok := map[MOTOR_TEST_ORDER]string{MOTOR_TEST_ORDER_DEFAULT: "MOTOR_TEST_ORDER_DEFAULT", MOTOR_TEST_ORDER_SEQUENCE: "MOTOR_TEST_ORDER_SEQUENCE", MOTOR_TEST_ORDER_BOARD: "MOTOR_TEST_ORDER_BOARD"}[e]; ok {
		return name
	}
...
func (e MOTOR_TEST_THROTTLE_TYPE) String() string {
	if name, ok := map[MOTOR_TEST_THROTTLE_TYPE]string{MOTOR_TEST_THROTTLE_PERCENT: "MOTOR_TEST_THROTTLE_PERCENT", MOTOR_TEST_THROTTLE_PWM: "MOTOR_TEST_THROTTLE_PWM", MOTOR_TEST_THROTTLE_PILOT: "MOTOR_TEST_THROTTLE_PILOT", MOTOR_TEST_COMPASS_CAL: "MOTOR_TEST_COMPASS_CAL"}[e]; ok {
		return name
	}
...
func (e MAV_COLLISION_ACTION) String() string {
	if name, ok := map[MAV_COLLISION_ACTION]string{MAV_COLLISION_ACTION_NONE: "MAV_COLLISION_ACTION_NONE", MAV_COLLISION_ACTION_REPORT: "MAV_COLLISION_ACTION_REPORT", MAV_COLLISION_ACTION_ASCEND_OR_DESCEND: "MAV_COLLISION_ACTION_ASCEND_OR_DESCEND", MAV_COLLISION_ACTION_MOVE_HORIZONTALLY: "MAV_COLLISION_ACTION_MOVE_HORIZONTALLY", MAV_COLLISION_ACTION_MOVE_PERPENDICULAR: "MAV_COLLISION_ACTION_MOVE_PERPENDICULAR", MAV_COLLISION_ACTION_RTL: "MAV_COLLISION_ACTION_RTL", MAV_COLLISION_ACTION_HOVER: "MAV_COLLISION_ACTION_HOVER"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_COLLISION_ACTION_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_COLLISION_THREAT_LEVEL) String() string {
	if name, ok := map[MAV_COLLISION_THREAT_LEVEL]string{MAV_COLLISION_THREAT_LEVEL_NONE: "MAV_COLLISION_THREAT_LEVEL_NONE", MAV_COLLISION_THREAT_LEVEL_LOW: "MAV_COLLISION_THREAT_LEVEL_LOW", MAV_COLLISION_THREAT_LEVEL_HIGH: "MAV_COLLISION_THREAT_LEVEL_HIGH"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_COLLISION_THREAT_LEVEL_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_COLLISION_SRC) String() string {
	if name, ok := map[MAV_COLLISION_SRC]string{MAV_COLLISION_SRC_ADSB: "MAV_COLLISION_SRC_ADSB", MAV_COLLISION_SRC_MAVLINK_GPS_GLOBAL_INT: "MAV_COLLISION_SRC_MAVLINK_GPS_GLOBAL_INT"}[e]; ok {
		return name
	}
...
func (e RTK_BASELINE_COORDINATE_SYSTEM) String() string {
	if name, ok := map[RTK_BASELINE_COORDINATE_SYSTEM]string{RTK_BASELINE_COORDINATE_SYSTEM_ECEF: "RTK_BASELINE_COORDINATE_SYSTEM_ECEF", RTK_BASELINE_COORDINATE_SYSTEM_NED: "RTK_BASELINE_COORDINATE_SYSTEM_NED"}[e]; ok {
		return name
	}
...
func (e LANDING_TARGET_TYPE) String() string {
	if name, ok := map[LANDING_TARGET_TYPE]string{LANDING_TARGET_TYPE_LIGHT_BEACON: "LANDING_TARGET_TYPE_LIGHT_BEACON", LANDING_TARGET_TYPE_RADIO_BEACON: "LANDING_TARGET_TYPE_RADIO_BEACON", LANDING_TARGET_TYPE_VISION_FIDUCIAL: "LANDING_TARGET_TYPE_VISION_FIDUCIAL", LANDING_TARGET_TYPE_VISION_OTHER: "LANDING_TARGET_TYPE_VISION_OTHER"}[e]; ok {
		return name
	}
...
func (e VIDEO_STREAM_STATUS_FLAGS) String() string {
	if name, ok := map[VIDEO_STREAM_STATUS_FLAGS]string{VIDEO_STREAM_STATUS_FLAGS_RUNNING: "VIDEO_STREAM_STATUS_FLAGS_RUNNING", VIDEO_STREAM_STATUS_FLAGS_THERMAL: "VIDEO_STREAM_STATUS_FLAGS_THERMAL"}[e]; ok {
		return name
	}
...
func (e VIDEO_STREAM_TYPE) String() string {
	if name, ok := map[VIDEO_STREAM_TYPE]string{VIDEO_STREAM_TYPE_RTSP: "VIDEO_STREAM_TYPE_RTSP", VIDEO_STREAM_TYPE_RTPUDP: "VIDEO_STREAM_TYPE_RTPUDP", VIDEO_STREAM_TYPE_TCP_MPEG: "VIDEO_STREAM_TYPE_TCP_MPEG", VIDEO_STREAM_TYPE_MPEG_TS_H264: "VIDEO_STREAM_TYPE_MPEG_TS_H264"}[e]; ok {
		return name
	}
	return fmt.Sprintf("VIDEO_STREAM_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e CAMERA_TRACKING_STATUS_FLAGS) String() string {
	if name, ok := map[CAMERA_TRACKING_STATUS_FLAGS]string{CAMERA_TRACKING_STATUS_FLAGS_IDLE: "CAMERA_TRACKING_STATUS_FLAGS_IDLE", CAMERA_TRACKING_STATUS_FLAGS_ACTIVE: "CAMERA_TRACKING_STATUS_FLAGS_ACTIVE", CAMERA_TRACKING_STATUS_FLAGS_ERROR: "CAMERA_TRACKING_STATUS_FLAGS_ERROR"}[e]; ok {
		return name
	}
	return fmt.Sprintf("CAMERA_TRACKING_STATUS_FLAGS_ENUM_UNDEFINED_%d", int(e))
}
...
func (e CAMERA_TRACKING_MODE) String() string {
	if name, ok := map[CAMERA_TRACKING_MODE]string{CAMERA_TRACKING_NONE: "CAMERA_TRACKING_NONE", CAMERA_TRACKING_POINT: "CAMERA_TRACKING_POINT", CAMERA_TRACKING_RECTANGLE: "CAMERA_TRACKING_RECTANGLE"}[e]; ok {
		return name
	}
...
func (e CAMERA_TRACKING_TARGET_DATA) String() string {
	if name, ok := map[CAMERA_TRACKING_TARGET_DATA]string{CAMERA_TRACKING_TARGET_NONE: "CAMERA_TRACKING_TARGET_NONE", CAMERA_TRACKING_TARGET_EMBEDDED: "CAMERA_TRACKING_TARGET_EMBEDDED", CAMERA_TRACKING_TARGET_RENDERED: "CAMERA_TRACKING_TARGET_RENDERED", CAMERA_TRACKING_TARGET_IN_STATUS: "CAMERA_TRACKING_TARGET_IN_STATUS"}[e]; ok {
		return name
	}
	return fmt.Sprintf("CAMERA_TRACKING_TARGET_DATA_ENUM_UNDEFINED_%d", int(e))
}
...
func (e CAMERA_ZOOM_TYPE) String() string {
	if name, ok := map[CAMERA_ZOOM_TYPE]string{ZOOM_TYPE_STEP: "ZOOM_TYPE_STEP", ZOOM_TYPE_CONTINUOUS: "ZOOM_TYPE_CONTINUOUS", ZOOM_TYPE_RANGE: "ZOOM_TYPE_RANGE", ZOOM_TYPE_FOCAL_LENGTH: "ZOOM_TYPE_FOCAL_LENGTH"}[e]; ok {
		return name
	}
...
func (e SET_FOCUS_TYPE) String() string {
	if name, ok := map[SET_FOCUS_TYPE]string{FOCUS_TYPE_STEP: "FOCUS_TYPE_STEP", FOCUS_TYPE_CONTINUOUS: "FOCUS_TYPE_CONTINUOUS", FOCUS_TYPE_RANGE: "FOCUS_TYPE_RANGE", FOCUS_TYPE_METERS: "FOCUS_TYPE_METERS"}[e]; ok {
		return name
	}
	return fmt.Sprintf("SET_FOCUS_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e PARAM_ACK) String() string {
	if name, ok := map[PARAM_ACK]string{PARAM_ACK_ACCEPTED: "PARAM_ACK_ACCEPTED", PARAM_ACK_VALUE_UNSUPPORTED: "PARAM_ACK_VALUE_UNSUPPORTED", PARAM_ACK_FAILED: "PARAM_ACK_FAILED", PARAM_ACK_IN_PROGRESS: "PARAM_ACK_IN_PROGRESS"}[e]; ok {
		return name
	}
	return fmt.Sprintf("PARAM_ACK_ENUM_UNDEFINED_%d", int(e))
}
...
func (e CAMERA_MODE) String() string {
	if name, ok := map[CAMERA_MODE]string{CAMERA_MODE_IMAGE: "CAMERA_MODE_IMAGE", CAMERA_MODE_VIDEO: "CAMERA_MODE_VIDEO", CAMERA_MODE_IMAGE_SURVEY: "CAMERA_MODE_IMAGE_SURVEY"}[e]; ok {
		return name
	}
...
func (e MAV_ARM_AUTH_DENIED_REASON) String() string {
	if name, ok := map[MAV_ARM_AUTH_DENIED_REASON]string{MAV_ARM_AUTH_DENIED_REASON_GENERIC: "MAV_ARM_AUTH_DENIED_REASON_GENERIC", MAV_ARM_AUTH_DENIED_REASON_NONE: "MAV_ARM_AUTH_DENIED_REASON_NONE", MAV_ARM_AUTH_DENIED_REASON_INVALID_WAYPOINT: "MAV_ARM_AUTH_DENIED_REASON_INVALID_WAYPOINT", MAV_ARM_AUTH_DENIED_REASON_TIMEOUT: "MAV_ARM_AUTH_DENIED_REASON_TIMEOUT", MAV_ARM_AUTH_DENIED_REASON_AIRSPACE_IN_USE: "MAV_ARM_AUTH_DENIED_REASON_AIRSPACE_IN_USE", MAV_ARM_AUTH_DENIED_REASON_BAD_WEATHER: "MAV_ARM_AUTH_DENIED_REASON_BAD_WEATHER"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ARM_AUTH_DENIED_REASON_ENUM_UNDEFINED_%d", int(e))
}
...
func (e RC_TYPE) String() string {
	if name, ok := map[RC_TYPE]string{RC_TYPE_SPEKTRUM_DSM2: "RC_TYPE_SPEKTRUM_DSM2", RC_TYPE_SPEKTRUM_DSMX: "RC_TYPE_SPEKTRUM_DSMX"}[e]; ok {
		return name
	}
...
func (e ATTITUDE_TARGET_TYPEMASK) String() string {
	if name, ok := map[ATTITUDE_TARGET_TYPEMASK]string{ATTITUDE_TARGET_TYPEMASK_BODY_ROLL_RATE_IGNORE: "ATTITUDE_TARGET_TYPEMASK_BODY_ROLL_RATE_IGNORE", ATTITUDE_TARGET_TYPEMASK_BODY_PITCH_RATE_IGNORE: "ATTITUDE_TARGET_TYPEMASK_BODY_PITCH_RATE_IGNORE", ATTITUDE_TARGET_TYPEMASK_BODY_YAW_RATE_IGNORE: "ATTITUDE_TARGET_TYPEMASK_BODY_YAW_RATE_IGNORE", ATTITUDE_TARGET_TYPEMASK_THROTTLE_IGNORE: "ATTITUDE_TARGET_TYPEMASK_THROTTLE_IGNORE", ATTITUDE_TARGET_TYPEMASK_ATTITUDE_IGNORE: "ATTITUDE_TARGET_TYPEMASK_ATTITUDE_IGNORE"}[e]; ok {
		return name
	}
	return fmt.Sprintf("ATTITUDE_TARGET_TYPEMASK_ENUM_UNDEFINED_%d", int(e))
}
...
func (e UTM_FLIGHT_STATE) String() string {
	if name, ok := map[UTM_FLIGHT_STATE]string{UTM_FLIGHT_STATE_UNKNOWN: "UTM_FLIGHT_STATE_UNKNOWN", UTM_FLIGHT_STATE_GROUND: "UTM_FLIGHT_STATE_GROUND", UTM_FLIGHT_STATE_AIRBORNE: "UTM_FLIGHT_STATE_AIRBORNE", UTM_FLIGHT_STATE_EMERGENCY: "UTM_FLIGHT_STATE_EMERGENCY", UTM_FLIGHT_STATE_NOCTRL: "UTM_FLIGHT_STATE_NOCTRL"}[e]; ok {
		return name
	}
...
func (e UTM_DATA_AVAIL_FLAGS) String() string {
	if name, ok := map[UTM_DATA_AVAIL_FLAGS]string{UTM_DATA_AVAIL_FLAGS_TIME_VALID: "UTM_DATA_AVAIL_FLAGS_TIME_VALID", UTM_DATA_AVAIL_FLAGS_UAS_ID_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_UAS_ID_AVAILABLE", UTM_DATA_AVAIL_FLAGS_POSITION_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_POSITION_AVAILABLE", UTM_DATA_AVAIL_FLAGS_ALTITUDE_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_ALTITUDE_AVAILABLE", UTM_DATA_AVAIL_FLAGS_RELATIVE_ALTITUDE_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_RELATIVE_ALTITUDE_AVAILABLE", UTM_DATA_AVAIL_FLAGS_HORIZONTAL_VELO_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_HORIZONTAL_VELO_AVAILABLE", UTM_DATA_AVAIL_FLAGS_VERTICAL_VELO_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_VERTICAL_VELO_AVAILABLE", UTM_DATA_AVAIL_FLAGS_NEXT_WAYPOINT_AVAILABLE: "UTM_DATA_AVAIL_FLAGS_NEXT_WAYPOINT_AVAILABLE"}[e]; ok {
		return name
	}
	return fmt.Sprintf("UTM_DATA_AVAIL_FLAGS_ENUM_UNDEFINED_%d", int(e))
}
...
func (e CELLULAR_NETWORK_FAILED_REASON) String() string {
	if name, ok := map[CELLULAR_NETWORK_FAILED_REASON]string{CELLULAR_NETWORK_FAILED_REASON_NONE: "CELLULAR_NETWORK_FAILED_REASON_NONE", CELLULAR_NETWORK_FAILED_REASON_UNKNOWN: "CELLULAR_NETWORK_FAILED_REASON_UNKNOWN", CELLULAR_NETWORK_FAILED_REASON_SIM_MISSING: "CELLULAR_NETWORK_FAILED_REASON_SIM_MISSING", CELLULAR_NETWORK_FAILED_REASON_SIM_ERROR: "CELLULAR_NETWORK_FAILED_REASON_SIM_ERROR"}[e]; ok {
		return name
	}
	return fmt.Sprintf("CELLULAR_NETWORK_FAILED_REASON_ENUM_UNDEFINED_%d", int(e))
}
...
func (e PRECISION_LAND_MODE) String() string {
	if name, ok := map[PRECISION_LAND_MODE]string{PRECISION_LAND_MODE_DISABLED: "PRECISION_LAND_MODE_DISABLED", PRECISION_LAND_MODE_OPPORTUNISTIC: "PRECISION_LAND_MODE_OPPORTUNISTIC", PRECISION_LAND_MODE_REQUIRED: "PRECISION_LAND_MODE_REQUIRED"}[e]; ok {
		return name
	}
	return fmt.Sprintf("PRECISION_LAND_MODE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e PARACHUTE_ACTION) String() string {
	if name, ok := map[PARACHUTE_ACTION]string{PARACHUTE_DISABLE: "PARACHUTE_DISABLE", PARACHUTE_ENABLE: "PARACHUTE_ENABLE", PARACHUTE_RELEASE: "PARACHUTE_RELEASE"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_ID_TYPE) String() string {
	if name, ok := map[MAV_ODID_ID_TYPE]string{MAV_ODID_ID_TYPE_NONE: "MAV_ODID_ID_TYPE_NONE", MAV_ODID_ID_TYPE_SERIAL_NUMBER: "MAV_ODID_ID_TYPE_SERIAL_NUMBER", MAV_ODID_ID_TYPE_CAA_REGISTRATION_ID: "MAV_ODID_ID_TYPE_CAA_REGISTRATION_ID", MAV_ODID_ID_TYPE_UTM_ASSIGNED_UUID: "MAV_ODID_ID_TYPE_UTM_ASSIGNED_UUID"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_UA_TYPE) String() string {
	if name, ok := map[MAV_ODID_UA_TYPE]string{MAV_ODID_UA_TYPE_NONE: "MAV_ODID_UA_TYPE_NONE", MAV_ODID_UA_TYPE_AEROPLANE: "MAV_ODID_UA_TYPE_AEROPLANE", MAV_ODID_UA_TYPE_HELICOPTER_OR_MULTIROTOR: "MAV_ODID_UA_TYPE_HELICOPTER_OR_MULTIROTOR", MAV_ODID_UA_TYPE_GYROPLANE: "MAV_ODID_UA_TYPE_GYROPLANE", MAV_ODID_UA_TYPE_HYBRID_LIFT: "MAV_ODID_UA_TYPE_HYBRID_LIFT", MAV_ODID_UA_TYPE_ORNITHOPTER: "MAV_ODID_UA_TYPE_ORNITHOPTER", MAV_ODID_UA_TYPE_GLIDER: "MAV_ODID_UA_TYPE_GLIDER", MAV_ODID_UA_TYPE_KITE: "MAV_ODID_UA_TYPE_KITE", MAV_ODID_UA_TYPE_FREE_BALLOON: "MAV_ODID_UA_TYPE_FREE_BALLOON", MAV_ODID_UA_TYPE_CAPTIVE_BALLOON: "MAV_ODID_UA_TYPE_CAPTIVE_BALLOON", MAV_ODID_UA_TYPE_AIRSHIP: "MAV_ODID_UA_TYPE_AIRSHIP", MAV_ODID_UA_TYPE_FREE_FALL_PARACHUTE: "MAV_ODID_UA_TYPE_FREE_FALL_PARACHUTE", MAV_ODID_UA_TYPE_ROCKET: "MAV_ODID_UA_TYPE_ROCKET", MAV_ODID_UA_TYPE_TETHERED_POWERED_AIRCRAFT: "MAV_ODID_UA_TYPE_TETHERED_POWERED_AIRCRAFT", MAV_ODID_UA_TYPE_GROUND_OBSTACLE: "MAV_ODID_UA_TYPE_GROUND_OBSTACLE", MAV_ODID_UA_TYPE_OTHER: "MAV_ODID_UA_TYPE_OTHER"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_UA_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_STATUS) String() string {
	if name, ok := map[MAV_ODID_STATUS]string{MAV_ODID_STATUS_UNDECLARED: "MAV_ODID_STATUS_UNDECLARED", MAV_ODID_STATUS_GROUND: "MAV_ODID_STATUS_GROUND", MAV_ODID_STATUS_AIRBORNE: "MAV_ODID_STATUS_AIRBORNE", MAV_ODID_STATUS_EMERGENCY: "MAV_ODID_STATUS_EMERGENCY"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_STATUS_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_HEIGHT_REF) String() string {
	if name, ok := map[MAV_ODID_HEIGHT_REF]string{MAV_ODID_HEIGHT_REF_OVER_TAKEOFF: "MAV_ODID_HEIGHT_REF_OVER_TAKEOFF", MAV_ODID_HEIGHT_REF_OVER_GROUND: "MAV_ODID_HEIGHT_REF_OVER_GROUND"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_HOR_ACC) String() string {
	if name, ok := map[MAV_ODID_HOR_ACC]string{MAV_ODID_HOR_ACC_UNKNOWN: "MAV_ODID_HOR_ACC_UNKNOWN", MAV_ODID_HOR_ACC_10NM: "MAV_ODID_HOR_ACC_10NM", MAV_ODID_HOR_ACC_4NM: "MAV_ODID_HOR_ACC_4NM", MAV_ODID_HOR_ACC_2NM: "MAV_ODID_HOR_ACC_2NM", MAV_ODID_HOR_ACC_1NM: "MAV_ODID_HOR_ACC_1NM", MAV_ODID_HOR_ACC_0_5NM: "MAV_ODID_HOR_ACC_0_5NM", MAV_ODID_HOR_ACC_0_3NM: "MAV_ODID_HOR_ACC_0_3NM", MAV_ODID_HOR_ACC_0_1NM: "MAV_ODID_HOR_ACC_0_1NM", MAV_ODID_HOR_ACC_0_05NM: "MAV_ODID_HOR_ACC_0_05NM", MAV_ODID_HOR_ACC_30_METER: "MAV_ODID_HOR_ACC_30_METER", MAV_ODID_HOR_ACC_10_METER: "MAV_ODID_HOR_ACC_10_METER", MAV_ODID_HOR_ACC_3_METER: "MAV_ODID_HOR_ACC_3_METER", MAV_ODID_HOR_ACC_1_METER: "MAV_ODID_HOR_ACC_1_METER"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_HOR_ACC_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_AUTH_TYPE) String() string {
	if name, ok := map[MAV_ODID_AUTH_TYPE]string{MAV_ODID_AUTH_TYPE_NONE: "MAV_ODID_AUTH_TYPE_NONE", MAV_ODID_AUTH_TYPE_UAS_ID_SIGNATURE: "MAV_ODID_AUTH_TYPE_UAS_ID_SIGNATURE", MAV_ODID_AUTH_TYPE_OPERATOR_ID_SIGNATURE: "MAV_ODID_AUTH_TYPE_OPERATOR_ID_SIGNATURE", MAV_ODID_AUTH_TYPE_MESSAGE_SET_SIGNATURE: "MAV_ODID_AUTH_TYPE_MESSAGE_SET_SIGNATURE", MAV_ODID_AUTH_TYPE_NETWORK_REMOTE_ID: "MAV_ODID_AUTH_TYPE_NETWORK_REMOTE_ID"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_AUTH_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_DESC_TYPE) String() string {
	if name, ok := map[MAV_ODID_DESC_TYPE]string{MAV_ODID_DESC_TYPE_TEXT: "MAV_ODID_DESC_TYPE_TEXT"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_OPERATOR_LOCATION_TYPE) String() string {
	if name, ok := map[MAV_ODID_OPERATOR_LOCATION_TYPE]string{MAV_ODID_OPERATOR_LOCATION_TYPE_TAKEOFF: "MAV_ODID_OPERATOR_LOCATION_TYPE_TAKEOFF", MAV_ODID_OPERATOR_LOCATION_TYPE_LIVE_GNSS: "MAV_ODID_OPERATOR_LOCATION_TYPE_LIVE_GNSS", MAV_ODID_OPERATOR_LOCATION_TYPE_FIXED: "MAV_ODID_OPERATOR_LOCATION_TYPE_FIXED"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_OPERATOR_LOCATION_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_CLASSIFICATION_TYPE) String() string {
	if name, ok := map[MAV_ODID_CLASSIFICATION_TYPE]string{MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED: "MAV_ODID_CLASSIFICATION_TYPE_UNDECLARED", MAV_ODID_CLASSIFICATION_TYPE_EU: "MAV_ODID_CLASSIFICATION_TYPE_EU"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_CATEGORY_EU) String() string {
	if name, ok := map[MAV_ODID_CATEGORY_EU]string{MAV_ODID_CATEGORY_EU_UNDECLARED: "MAV_ODID_CATEGORY_EU_UNDECLARED", MAV_ODID_CATEGORY_EU_OPEN: "MAV_ODID_CATEGORY_EU_OPEN", MAV_ODID_CATEGORY_EU_SPECIFIC: "MAV_ODID_CATEGORY_EU_SPECIFIC", MAV_ODID_CATEGORY_EU_CERTIFIED: "MAV_ODID_CATEGORY_EU_CERTIFIED"}[e]; ok {
		return name
	}
...
func (e MAV_ODID_CLASS_EU) String() string {
	if name, ok := map[MAV_ODID_CLASS_EU]string{MAV_ODID_CLASS_EU_UNDECLARED: "MAV_ODID_CLASS_EU_UNDECLARED", MAV_ODID_CLASS_EU_CLASS_0: "MAV_ODID_CLASS_EU_CLASS_0", MAV_ODID_CLASS_EU_CLASS_1: "MAV_ODID_CLASS_EU_CLASS_1", MAV_ODID_CLASS_EU_CLASS_2: "MAV_ODID_CLASS_EU_CLASS_2", MAV_ODID_CLASS_EU_CLASS_3: "MAV_ODID_CLASS_EU_CLASS_3", MAV_ODID_CLASS_EU_CLASS_4: "MAV_ODID_CLASS_EU_CLASS_4", MAV_ODID_CLASS_EU_CLASS_5: "MAV_ODID_CLASS_EU_CLASS_5", MAV_ODID_CLASS_EU_CLASS_6: "MAV_ODID_CLASS_EU_CLASS_6"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_ODID_CLASS_EU_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_ODID_OPERATOR_ID_TYPE) String() string {
	if name, ok := map[MAV_ODID_OPERATOR_ID_TYPE]string{MAV_ODID_OPERATOR_ID_TYPE_CAA: "MAV_ODID_OPERATOR_ID_TYPE_CAA"}[e]; ok {
		return name
	}
...
func (e TUNE_FORMAT) String() string {
	if name, ok := map[TUNE_FORMAT]string{TUNE_FORMAT_QBASIC1_1: "TUNE_FORMAT_QBASIC1_1", TUNE_FORMAT_MML_MODERN: "TUNE_FORMAT_MML_MODERN"}[e]; ok {
		return name
	}
	return fmt.Sprintf("TUNE_FORMAT_ENUM_UNDEFINED_%d", int(e))
}
...
func (e COMPONENT_CAP_FLAGS) String() string {
	if name, ok := map[COMPONENT_CAP_FLAGS]string{COMPONENT_CAP_FLAGS_PARAM: "COMPONENT_CAP_FLAGS_PARAM", COMPONENT_CAP_FLAGS_PARAM_EXT: "COMPONENT_CAP_FLAGS_PARAM_EXT"}[e]; ok {
		return name
	}
...
func (e AIS_FLAGS) String() string {
	if name, ok := map[AIS_FLAGS]string{AIS_FLAGS_POSITION_ACCURACY: "AIS_FLAGS_POSITION_ACCURACY", AIS_FLAGS_VALID_COG: "AIS_FLAGS_VALID_COG", AIS_FLAGS_VALID_VELOCITY: "AIS_FLAGS_VALID_VELOCITY", AIS_FLAGS_HIGH_VELOCITY: "AIS_FLAGS_HIGH_VELOCITY", AIS_FLAGS_VALID_TURN_RATE: "AIS_FLAGS_VALID_TURN_RATE", AIS_FLAGS_TURN_RATE_SIGN_ONLY: "AIS_FLAGS_TURN_RATE_SIGN_ONLY", AIS_FLAGS_VALID_DIMENSIONS: "AIS_FLAGS_VALID_DIMENSIONS", AIS_FLAGS_LARGE_BOW_DIMENSION: "AIS_FLAGS_LARGE_BOW_DIMENSION", AIS_FLAGS_LARGE_STERN_DIMENSION: "AIS_FLAGS_LARGE_STERN_DIMENSION", AIS_FLAGS_LARGE_PORT_DIMENSION: "AIS_FLAGS_LARGE_PORT_DIMENSION", AIS_FLAGS_LARGE_STARBOARD_DIMENSION: "AIS_FLAGS_LARGE_STARBOARD_DIMENSION", AIS_FLAGS_VALID_CALLSIGN: "AIS_FLAGS_VALID_CALLSIGN", AIS_FLAGS_VALID_NAME: "AIS_FLAGS_VALID_NAME"}[e]; ok {
		return name
	}
...
func (e FAILURE_TYPE) String() string {
	if name, ok := map[FAILURE_TYPE]string{FAILURE_TYPE_OK: "FAILURE_TYPE_OK", FAILURE_TYPE_OFF: "FAILURE_TYPE_OFF", FAILURE_TYPE_STUCK: "FAILURE_TYPE_STUCK", FAILURE_TYPE_GARBAGE: "FAILURE_TYPE_GARBAGE", FAILURE_TYPE_WRONG: "FAILURE_TYPE_WRONG", FAILURE_TYPE_SLOW: "FAILURE_TYPE_SLOW", FAILURE_TYPE_DELAYED: "FAILURE_TYPE_DELAYED", FAILURE_TYPE_INTERMITTENT: "FAILURE_TYPE_INTERMITTENT"}[e]; ok {
		return name
	}
	return fmt.Sprintf("FAILURE_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_WINCH_STATUS_FLAG) String() string {
	if name, ok := map[MAV_WINCH_STATUS_FLAG]string{MAV_WINCH_STATUS_HEALTHY: "MAV_WINCH_STATUS_HEALTHY", MAV_WINCH_STATUS_FULLY_RETRACTED: "MAV_WINCH_STATUS_FULLY_RETRACTED", MAV_WINCH_STATUS_MOVING: "MAV_WINCH_STATUS_MOVING", MAV_WINCH_STATUS_CLUTCH_ENGAGED: "MAV_WINCH_STATUS_CLUTCH_ENGAGED"}[e]; ok {
		return name
	}
...
func (e MAG_CAL_STATUS) String() string {
	if name, ok := map[MAG_CAL_STATUS]string{MAG_CAL_NOT_STARTED: "MAG_CAL_NOT_STARTED", MAG_CAL_WAITING_TO_START: "MAG_CAL_WAITING_TO_START", MAG_CAL_RUNNING_STEP_ONE: "MAG_CAL_RUNNING_STEP_ONE", MAG_CAL_RUNNING_STEP_TWO: "MAG_CAL_RUNNING_STEP_TWO", MAG_CAL_SUCCESS: "MAG_CAL_SUCCESS", MAG_CAL_FAILED: "MAG_CAL_FAILED", MAG_CAL_BAD_ORIENTATION: "MAG_CAL_BAD_ORIENTATION", MAG_CAL_BAD_RADIUS: "MAG_CAL_BAD_RADIUS"}[e]; ok {
		return name
	}
...
func (e MAV_AUTOPILOT) String() string {
	if name, ok := map[MAV_AUTOPILOT]string{MAV_AUTOPILOT_GENERIC: "MAV_AUTOPILOT_GENERIC", MAV_AUTOPILOT_RESERVED: "MAV_AUTOPILOT_RESERVED", MAV_AUTOPILOT_SLUGS: "MAV_AUTOPILOT_SLUGS", MAV_AUTOPILOT_ARDUPILOTMEGA: "MAV_AUTOPILOT_ARDUPILOTMEGA", MAV_AUTOPILOT_OPENPILOT: "MAV_AUTOPILOT_OPENPILOT", MAV_AUTOPILOT_GENERIC_WAYPOINTS_ONLY: "MAV_AUTOPILOT_GENERIC_WAYPOINTS_ONLY", MAV_AUTOPILOT_GENERIC_WAYPOINTS_AND_SIMPLE_NAVIGATION_ONLY: "MAV_AUTOPILOT_GENERIC_WAYPOINTS_AND_SIMPLE_NAVIGATION_ONLY", MAV_AUTOPILOT_GENERIC_MISSION_FULL: "MAV_AUTOPILOT_GENERIC_MISSION_FULL", MAV_AUTOPILOT_INVALID: "MAV_AUTOPILOT_INVALID", MAV_AUTOPILOT_PPZ: "MAV_AUTOPILOT_PPZ", MAV_AUTOPILOT_UDB: "MAV_AUTOPILOT_UDB", MAV_AUTOPILOT_FP: "MAV_AUTOPILOT_FP", MAV_AUTOPILOT_PX4: "MAV_AUTOPILOT_PX4", MAV_AUTOPILOT_SMACCMPILOT: "MAV_AUTOPILOT_SMACCMPILOT", MAV_AUTOPILOT_AUTOQUAD: "MAV_AUTOPILOT_AUTOQUAD", MAV_AUTOPILOT_ARMAZILA: "MAV_AUTOPILOT_ARMAZILA", MAV_AUTOPILOT_AEROB: "MAV_AUTOPILOT_AEROB", MAV_AUTOPILOT_ASLUAV: "MAV_AUTOPILOT_ASLUAV", MAV_AUTOPILOT_SMARTAP: "MAV_AUTOPILOT_SMARTAP", MAV_AUTOPILOT_AIRRAILS: "MAV_AUTOPILOT_AIRRAILS"}[e]; ok {
		return name
	}
...
func (e MAV_TYPE) String() string {
	if name, ok := map[MAV_TYPE]string{MAV_TYPE_GENERIC: "MAV_TYPE_GENERIC", MAV_TYPE_FIXED_WING: "MAV_TYPE_FIXED_WING", MAV_TYPE_QUADROTOR: "MAV_TYPE_QUADROTOR", MAV_TYPE_COAXIAL: "MAV_TYPE_COAXIAL", MAV_TYPE_HELICOPTER: "MAV_TYPE_HELICOPTER", MAV_TYPE_ANTENNA_TRACKER: "MAV_TYPE_ANTENNA_TRACKER", MAV_TYPE_GCS: "MAV_TYPE_GCS", MAV_TYPE_AIRSHIP: "MAV_TYPE_AIRSHIP", MAV_TYPE_FREE_BALLOON: "MAV_TYPE_FREE_BALLOON", MAV_TYPE_ROCKET: "MAV_TYPE_ROCKET", MAV_TYPE_GROUND_ROVER: "MAV_TYPE_GROUND_ROVER", MAV_TYPE_SURFACE_BOAT: "MAV_TYPE_SURFACE_BOAT", MAV_TYPE_SUBMARINE: "MAV_TYPE_SUBMARINE", MAV_TYPE_HEXAROTOR: "MAV_TYPE_HEXAROTOR", MAV_TYPE_OCTOROTOR: "MAV_TYPE_OCTOROTOR", MAV_TYPE_TRICOPTER: "MAV_TYPE_TRICOPTER", MAV_TYPE_FLAPPING_WING: "MAV_TYPE_FLAPPING_WING", MAV_TYPE_KITE: "MAV_TYPE_KITE", MAV_TYPE_ONBOARD_CONTROLLER: "MAV_TYPE_ONBOARD_CONTROLLER", MAV_TYPE_VTOL_DUOROTOR: "MAV_TYPE_VTOL_DUOROTOR", MAV_TYPE_VTOL_QUADROTOR: "MAV_TYPE_VTOL_QUADROTOR", MAV_TYPE_VTOL_TILTROTOR: "MAV_TYPE_VTOL_TILTROTOR", MAV_TYPE_VTOL_RESERVED2: "MAV_TYPE_VTOL_RESERVED2", MAV_TYPE_VTOL_RESERVED3: "MAV_TYPE_VTOL_RESERVED3", MAV_TYPE_VTOL_RESERVED4: "MAV_TYPE_VTOL_RESERVED4", MAV_TYPE_VTOL_RESERVED5: "MAV_TYPE_VTOL_RESERVED5", MAV_TYPE_GIMBAL: "MAV_TYPE_GIMBAL", MAV_TYPE_ADSB: "MAV_TYPE_ADSB", MAV_TYPE_PARAFOIL: "MAV_TYPE_PARAFOIL", MAV_TYPE_DODECAROTOR: "MAV_TYPE_DODECAROTOR", MAV_TYPE_CAMERA: "MAV_TYPE_CAMERA", MAV_TYPE_CHARGING_STATION: "MAV_TYPE_CHARGING_STATION", MAV_TYPE_FLARM: "MAV_TYPE_FLARM", MAV_TYPE_SERVO: "MAV_TYPE_SERVO", MAV_TYPE_ODID: "MAV_TYPE_ODID", MAV_TYPE_DECAROTOR: "MAV_TYPE_DECAROTOR"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_TYPE_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_MODE_FLAG) String() string {
	if name, ok := map[MAV_MODE_FLAG]string{MAV_MODE_FLAG_SAFETY_ARMED: "MAV_MODE_FLAG_SAFETY_ARMED", MAV_MODE_FLAG_MANUAL_INPUT_ENABLED: "MAV_MODE_FLAG_MANUAL_INPUT_ENABLED", MAV_MODE_FLAG_HIL_ENABLED: "MAV_MODE_FLAG_HIL_ENABLED", MAV_MODE_FLAG_STABILIZE_ENABLED: "MAV_MODE_FLAG_STABILIZE_ENABLED", MAV_MODE_FLAG_GUIDED_ENABLED: "MAV_MODE_FLAG_GUIDED_ENABLED", MAV_MODE_FLAG_AUTO_ENABLED: "MAV_MODE_FLAG_AUTO_ENABLED", MAV_MODE_FLAG_TEST_ENABLED: "MAV_MODE_FLAG_TEST_ENABLED", MAV_MODE_FLAG_CUSTOM_MODE_ENABLED: "MAV_MODE_FLAG_CUSTOM_MODE_ENABLED"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_MODE_FLAG_ENUM_UNDEFINED_%d", int(e))
}
...
func (e MAV_MODE_FLAG_DECODE_POSITION) String() string {
	if name, ok := map[MAV_MODE_FLAG_DECODE_POSITION]string{MAV_MODE_FLAG_DECODE_POSITION_SAFETY: "MAV_MODE_FLAG_DECODE_POSITION_SAFETY", MAV_MODE_FLAG_DECODE_POSITION_MANUAL: "MAV_MODE_FLAG_DECODE_POSITION_MANUAL", MAV_MODE_FLAG_DECODE_POSITION_HIL: "MAV_MODE_FLAG_DECODE_POSITION_HIL", MAV_MODE_FLAG_DECODE_POSITION_STABILIZE: "MAV_MODE_FLAG_DECODE_POSITION_STABILIZE", MAV_MODE_FLAG_DECODE_POSITION_GUIDED: "MAV_MODE_FLAG_DECODE_POSITION_GUIDED", MAV_MODE_FLAG_DECODE_POSITION_AUTO: "MAV_MODE_FLAG_DECODE_POSITION_AUTO", MAV_MODE_FLAG_DECODE_POSITION_TEST: "MAV_MODE_FLAG_DECODE_POSITION_TEST", MAV_MODE_FLAG_DECODE_POSITION_CUSTOM_MODE: "MAV_MODE_FLAG_DECODE_POSITION_CUSTOM_MODE"}[e]; ok {
		return name
	}
...
func (e MAV_STATE) String() string {
	if name, ok := map[MAV_STATE]string{MAV_STATE_UNINIT: "MAV_STATE_UNINIT", MAV_STATE_BOOT: "MAV_STATE_BOOT", MAV_STATE_CALIBRATING: "MAV_STATE_CALIBRATING", MAV_STATE_STANDBY: "MAV_STATE_STANDBY", MAV_STATE_ACTIVE: "MAV_STATE_ACTIVE", MAV_STATE_CRITICAL: "MAV_STATE_CRITICAL", MAV_STATE_EMERGENCY: "MAV_STATE_EMERGENCY", MAV_STATE_POWEROFF: "MAV_STATE_POWEROFF", MAV_STATE_FLIGHT_TERMINATION: "MAV_STATE_FLIGHT_TERMINATION"}[e]; ok {
		return name
	}
...
func (e MAV_COMPONENT) String() string {
	if name, ok := map[MAV_COMPONENT]string{MAV_COMP_ID_ALL: "MAV_COMP_ID_ALL", MAV_COMP_ID_AUTOPILOT1: "MAV_COMP_ID_AUTOPILOT1", MAV_COMP_ID_USER1: "MAV_COMP_ID_USER1", MAV_COMP_ID_USER2: "MAV_COMP_ID_USER2", MAV_COMP_ID_USER3: "MAV_COMP_ID_USER3", MAV_COMP_ID_USER4: "MAV_COMP_ID_USER4", MAV_COMP_ID_USER5: "MAV_COMP_ID_USER5", MAV_COMP_ID_USER6: "MAV_COMP_ID_USER6", MAV_COMP_ID_USER7: "MAV_COMP_ID_USER7", MAV_COMP_ID_USER8: "MAV_COMP_ID_USER8", MAV_COMP_ID_USER9: "MAV_COMP_ID_USER9", MAV_COMP_ID_USER10: "MAV_COMP_ID_USER10", MAV_COMP_ID_USER11: "MAV_COMP_ID_USER11", MAV_COMP_ID_USER12: "MAV_COMP_ID_USER12", MAV_COMP_ID_USER13: "MAV_COMP_ID_USER13", MAV_COMP_ID_USER14: "MAV_COMP_ID_USER14", MAV_COMP_ID_USER15: "MAV_COMP_ID_USER15", MAV_COMP_ID_USER16: "MAV_COMP_ID_USER16", MAV_COMP_ID_USER17: "MAV_COMP_ID_USER17", MAV_COMP_ID_USER18: "MAV_COMP_ID_USER18", MAV_COMP_ID_USER19: "MAV_COMP_ID_USER19", MAV_COMP_ID_USER20: "MAV_COMP_ID_USER20", MAV_COMP_ID_USER21: "MAV_COMP_ID_USER21", MAV_COMP_ID_USER22: "MAV_COMP_ID_USER22", MAV_COMP_ID_USER23: "MAV_COMP_ID_USER23", MAV_COMP_ID_USER24: "MAV_COMP_ID_USER24", MAV_COMP_ID_USER25: "MAV_COMP_ID_USER25", MAV_COMP_ID_USER26: "MAV_COMP_ID_USER26", MAV_COMP_ID_USER27: "MAV_COMP_ID_USER27", MAV_COMP_ID_USER28: "MAV_COMP_ID_USER28", MAV_COMP_ID_USER29: "MAV_COMP_ID_USER29", MAV_COMP_ID_USER30: "MAV_COMP_ID_USER30", MAV_COMP_ID_USER31: "MAV_COMP_ID_USER31", MAV_COMP_ID_USER32: "MAV_COMP_ID_USER32", MAV_COMP_ID_USER33: "MAV_COMP_ID_USER33", MAV_COMP_ID_USER34: "MAV_COMP_ID_USER34", MAV_COMP_ID_USER35: "MAV_COMP_ID_USER35", MAV_COMP_ID_USER36: "MAV_COMP_ID_USER36", MAV_COMP_ID_USER37: "MAV_COMP_ID_USER37", MAV_COMP_ID_USER38: "MAV_COMP_ID_USER38", MAV_COMP_ID_USER39: "MAV_COMP_ID_USER39", MAV_COMP_ID_USER40: "MAV_COMP_ID_USER40", MAV_COMP_ID_USER41: "MAV_COMP_ID_USER41", MAV_COMP_ID_USER42: "MAV_COMP_ID_USER42", MAV_COMP_ID_USER43: "MAV_COMP_ID_USER43", MAV_COMP_ID_TELEMETRY_RADIO: "MAV_COMP_ID_TELEMETRY_RADIO", MAV_COMP_ID_USER45: "MAV_COMP_ID_USER45", MAV_COMP_ID_USER46: "MAV_COMP_ID_USER46", MAV_COMP_ID_USER47: "MAV_COMP_ID_USER47", MAV_COMP_ID_USER48: "MAV_COMP_ID_USER48", MAV_COMP_ID_USER49: "MAV_COMP_ID_USER49", MAV_COMP_ID_USER50: "MAV_COMP_ID_USER50", MAV_COMP_ID_USER51: "MAV_COMP_ID_USER51", MAV_COMP_ID_USER52: "MAV_COMP_ID_USER52", MAV_COMP_ID_USER53: "MAV_COMP_ID_USER53", MAV_COMP_ID_USER54: "MAV_COMP_ID_USER54", MAV_COMP_ID_USER55: "MAV_COMP_ID_USER55", MAV_COMP_ID_USER56: "MAV_COMP_ID_USER56", MAV_COMP_ID_USER57: "MAV_COMP_ID_USER57", MAV_COMP_ID_USER58: "MAV_COMP_ID_USER58", MAV_COMP_ID_USER59: "MAV_COMP_ID_USER59", MAV_COMP_ID_USER60: "MAV_COMP_ID_USER60", MAV_COMP_ID_USER61: "MAV_COMP_ID_USER61", MAV_COMP_ID_USER62: "MAV_COMP_ID_USER62", MAV_COMP_ID_USER63: "MAV_COMP_ID_USER63", MAV_COMP_ID_USER64: "MAV_COMP_ID_USER64", MAV_COMP_ID_USER65: "MAV_COMP_ID_USER65", MAV_COMP_ID_USER66: "MAV_COMP_ID_USER66", MAV_COMP_ID_USER67: "MAV_COMP_ID_USER67", MAV_COMP_ID_USER68: "MAV_COMP_ID_USER68", MAV_COMP_ID_USER69: "MAV_COMP_ID_USER69", MAV_COMP_ID_USER70: "MAV_COMP_ID_USER70", MAV_COMP_ID_USER71: "MAV_COMP_ID_USER71", MAV_COMP_ID_USER72: "MAV_COMP_ID_USER72", MAV_COMP_ID_USER73: "MAV_COMP_ID_USER73", MAV_COMP_ID_USER74: "MAV_COMP_ID_USER74", MAV_COMP_ID_USER75: "MAV_COMP_ID_USER75", MAV_COMP_ID_CAMERA: "MAV_COMP_ID_CAMERA", MAV_COMP_ID_CAMERA2: "MAV_COMP_ID_CAMERA2", MAV_COMP_ID_CAMERA3: "MAV_COMP_ID_CAMERA3", MAV_COMP_ID_CAMERA4: "MAV_COMP_ID_CAMERA4", MAV_COMP_ID_CAMERA5: "MAV_COMP_ID_CAMERA5", MAV_COMP_ID_CAMERA6: "MAV_COMP_ID_CAMERA6", MAV_COMP_ID_SERVO1: "MAV_COMP_ID_SERVO1", MAV_COMP_ID_SERVO2: "MAV_COMP_ID_SERVO2", MAV_COMP_ID_SERVO3: "MAV_COMP_ID_SERVO3", MAV_COMP_ID_SERVO4: "MAV_COMP_ID_SERVO4", MAV_COMP_ID_SERVO5: "MAV_COMP_ID_SERVO5", MAV_COMP_ID_SERVO6: "MAV_COMP_ID_SERVO6", MAV_COMP_ID_SERVO7: "MAV_COMP_ID_SERVO7", MAV_COMP_ID_SERVO8: "MAV_COMP_ID_SERVO8", MAV_COMP_ID_SERVO9: "MAV_COMP_ID_SERVO9", MAV_COMP_ID_SERVO10: "MAV_COMP_ID_SERVO10", MAV_COMP_ID_SERVO11: "MAV_COMP_ID_SERVO11", MAV_COMP_ID_SERVO12: "MAV_COMP_ID_SERVO12", MAV_COMP_ID_SERVO13: "MAV_COMP_ID_SERVO13", MAV_COMP_ID_SERVO14: "MAV_COMP_ID_SERVO14", MAV_COMP_ID_GIMBAL: "MAV_COMP_ID_GIMBAL", MAV_COMP_ID_LOG: "MAV_COMP_ID_LOG", MAV_COMP_ID_ADSB: "MAV_COMP_ID_ADSB", MAV_COMP_ID_OSD: "MAV_COMP_ID_OSD", MAV_COMP_ID_PERIPHERAL: "MAV_COMP_ID_PERIPHERAL", MAV_COMP_ID_QX1_GIMBAL: "MAV_COMP_ID_QX1_GIMBAL", MAV_COMP_ID_FLARM: "MAV_COMP_ID_FLARM", MAV_COMP_ID_GIMBAL2: "MAV_COMP_ID_GIMBAL2", MAV_COMP_ID_GIMBAL3: "MAV_COMP_ID_GIMBAL3", MAV_COMP_ID_GIMBAL4: "MAV_COMP_ID_GIMBAL4", MAV_COMP_ID_GIMBAL5: "MAV_COMP_ID_GIMBAL5", MAV_COMP_ID_GIMBAL6: "MAV_COMP_ID_GIMBAL6", MAV_COMP_ID_MISSIONPLANNER: "MAV_COMP_ID_MISSIONPLANNER", MAV_COMP_ID_ONBOARD_COMPUTER: "MAV_COMP_ID_ONBOARD_COMPUTER", MAV_COMP_ID_PATHPLANNER: "MAV_COMP_ID_PATHPLANNER", MAV_COMP_ID_OBSTACLE_AVOIDANCE: "MAV_COMP_ID_OBSTACLE_AVOIDANCE", MAV_COMP_ID_VISUAL_INERTIAL_ODOMETRY: "MAV_COMP_ID_VISUAL_INERTIAL_ODOMETRY", MAV_COMP_ID_PAIRING_MANAGER: "MAV_COMP_ID_PAIRING_MANAGER", MAV_COMP_ID_IMU: "MAV_COMP_ID_IMU", MAV_COMP_ID_IMU_2: "MAV_COMP_ID_IMU_2", MAV_COMP_ID_IMU_3: "MAV_COMP_ID_IMU_3", MAV_COMP_ID_GPS: "MAV_COMP_ID_GPS", MAV_COMP_ID_GPS2: "MAV_COMP_ID_GPS2", MAV_COMP_ID_ODID_TXRX_1: "MAV_COMP_ID_ODID_TXRX_1", MAV_COMP_ID_ODID_TXRX_2: "MAV_COMP_ID_ODID_TXRX_2", MAV_COMP_ID_ODID_TXRX_3: "MAV_COMP_ID_ODID_TXRX_3", MAV_COMP_ID_UDP_BRIDGE: "MAV_COMP_ID_UDP_BRIDGE", MAV_COMP_ID_UART_BRIDGE: "MAV_COMP_ID_UART_BRIDGE", MAV_COMP_ID_TUNNEL_NODE: "MAV_COMP_ID_TUNNEL_NODE", MAV_COMP_ID_SYSTEM_CONTROL: "MAV_COMP_ID_SYSTEM_CONTROL"}[e]; ok {
		return name
	}
	return fmt.Sprintf("MAV_COMPONENT_ENUM_UNDEFINED_%d", int(e))
}
...
type CommandIntStamped struct {
	...
	Command          MAV_CMD   `raw:"uint16"` // The scheduled action for the mission item, as defined by MAV_CMD enum
	TargetSystem     uint8     // System ID
	TargetComponent  uint8     // Component ID
	Frame            MAV_FRAME `raw:"uint8"` // The coordinate system of the COMMAND, as defined by MAV_FRAME enum
...
type CommandLongStamped struct {
	...
	Command          MAV_CMD `raw:"uint16"` // Command ID, as defined by MAV_CMD enum.
...
type GsmLinkStatus struct {
	...
	GsmModemType GSM_MODEM_TYPE `raw:"uint8"` // GSM modem used
	GsmLinkType  GSM_LINK_TYPE  `raw:"uint8"` // GSM link type
