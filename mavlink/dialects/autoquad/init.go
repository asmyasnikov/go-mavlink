...
func init() {
	register.Register(MSG_ID_AQ_TELEMETRY_F, "MSG_ID_AQ_TELEMETRY_F", 82, 241, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_AQ_ESC_TELEMETRY, "MSG_ID_AQ_ESC_TELEMETRY", 55, 115, func(p packet.Packet) (message.Message, error) {
