...
// AqTelemetryF struct (generated typeinfo)
// Sends up to 20 raw float values.
type AqTelemetryF struct {
	Value1  float32 `json:"Value1" `  // value1
	Value2  float32 `json:"Value2" `  // value2
	Value3  float32 `json:"Value3" `  // value3
	Value4  float32 `json:"Value4" `  // value4
	Value5  float32 `json:"Value5" `  // value5
	Value6  float32 `json:"Value6" `  // value6
	Value7  float32 `json:"Value7" `  // value7
	Value8  float32 `json:"Value8" `  // value8
	Value9  float32 `json:"Value9" `  // value9
	Value10 float32 `json:"Value10" ` // value10
	Value11 float32 `json:"Value11" ` // value11
	Value12 float32 `json:"Value12" ` // value12
	Value13 float32 `json:"Value13" ` // value13
	Value14 float32 `json:"Value14" ` // value14
	Value15 float32 `json:"Value15" ` // value15
	Value16 float32 `json:"Value16" ` // value16
	Value17 float32 `json:"Value17" ` // value17
	Value18 float32 `json:"Value18" ` // value18
	Value19 float32 `json:"Value19" ` // value19
	Value20 float32 `json:"Value20" ` // value20
	Index   uint16  `json:"Index" `   // Index of message
}

// MsgID (generated function)
func (m *AqTelemetryF) MsgID() message.MessageID {
	return MSG_ID_AQ_TELEMETRY_F
}

// String (generated function)
func (m *AqTelemetryF) String() string {
	return fmt.Sprintf(
		"&autoquad.AqTelemetryF{ Value1: %+v, Value2: %+v, Value3: %+v, Value4: %+v, Value5: %+v, Value6: %+v, Value7: %+v, Value8: %+v, Value9: %+v, Value10: %+v, Value11: %+v, Value12: %+v, Value13: %+v, Value14: %+v, Value15: %+v, Value16: %+v, Value17: %+v, Value18: %+v, Value19: %+v, Value20: %+v, Index: %+v }",
		m.Value1,
		m.Value2,
		m.Value3,
		m.Value4,
...
const (
	AQ_TELEMETRY_F_FIELD_VALUE1  = "AqTelemetryF.Value1"
	AQ_TELEMETRY_F_FIELD_VALUE2  = "AqTelemetryF.Value2"
	AQ_TELEMETRY_F_FIELD_VALUE3  = "AqTelemetryF.Value3"
	AQ_TELEMETRY_F_FIELD_VALUE4  = "AqTelemetryF.Value4"
	AQ_TELEMETRY_F_FIELD_VALUE5  = "AqTelemetryF.Value5"
	AQ_TELEMETRY_F_FIELD_VALUE6  = "AqTelemetryF.Value6"
	AQ_TELEMETRY_F_FIELD_VALUE7  = "AqTelemetryF.Value7"
	AQ_TELEMETRY_F_FIELD_VALUE8  = "AqTelemetryF.Value8"
	AQ_TELEMETRY_F_FIELD_VALUE9  = "AqTelemetryF.Value9"
	AQ_TELEMETRY_F_FIELD_VALUE10 = "AqTelemetryF.Value10"
	AQ_TELEMETRY_F_FIELD_VALUE11 = "AqTelemetryF.Value11"
	AQ_TELEMETRY_F_FIELD_VALUE12 = "AqTelemetryF.Value12"
	AQ_TELEMETRY_F_FIELD_VALUE13 = "AqTelemetryF.Value13"
	AQ_TELEMETRY_F_FIELD_VALUE14 = "AqTelemetryF.Value14"
	AQ_TELEMETRY_F_FIELD_VALUE15 = "AqTelemetryF.Value15"
	AQ_TELEMETRY_F_FIELD_VALUE16 = "AqTelemetryF.Value16"
	AQ_TELEMETRY_F_FIELD_VALUE17 = "AqTelemetryF.Value17"
	AQ_TELEMETRY_F_FIELD_VALUE18 = "AqTelemetryF.Value18"
	AQ_TELEMETRY_F_FIELD_VALUE19 = "AqTelemetryF.Value19"
	AQ_TELEMETRY_F_FIELD_VALUE20 = "AqTelemetryF.Value20"
	AQ_TELEMETRY_F_FIELD_INDEX   = "AqTelemetryF.Index"
)

// ToMap (generated function)
func (m *AqTelemetryF) Dict() map[string]interface{} {
	return map[string]interface{}{
		AQ_TELEMETRY_F_FIELD_VALUE1:  m.Value1,
		AQ_TELEMETRY_F_FIELD_VALUE2:  m.Value2,
		AQ_TELEMETRY_F_FIELD_VALUE3:  m.Value3,
		AQ_TELEMETRY_F_FIELD_VALUE4:  m.Value4,
		AQ_TELEMETRY_F_FIELD_VALUE5:  m.Value5,
		AQ_TELEMETRY_F_FIELD_VALUE6:  m.Value6,
		AQ_TELEMETRY_F_FIELD_VALUE7:  m.Value7,
		AQ_TELEMETRY_F_FIELD_VALUE8:  m.Value8,
		AQ_TELEMETRY_F_FIELD_VALUE9:  m.Value9,
		AQ_TELEMETRY_F_FIELD_VALUE10: m.Value10,
		AQ_TELEMETRY_F_FIELD_VALUE11: m.Value11,
		AQ_TELEMETRY_F_FIELD_VALUE12: m.Value12,
		AQ_TELEMETRY_F_FIELD_VALUE13: m.Value13,
		AQ_TELEMETRY_F_FIELD_VALUE14: m.Value14,
		AQ_TELEMETRY_F_FIELD_VALUE15: m.Value15,
		AQ_TELEMETRY_F_FIELD_VALUE16: m.Value16,
		AQ_TELEMETRY_F_FIELD_VALUE17: m.Value17,
		AQ_TELEMETRY_F_FIELD_VALUE18: m.Value18,
		AQ_TELEMETRY_F_FIELD_VALUE19: m.Value19,
		AQ_TELEMETRY_F_FIELD_VALUE20: m.Value20,
		AQ_TELEMETRY_F_FIELD_INDEX:   m.Index,
	}
}
...
func (m *AqTelemetryF) Marshal() ([]byte, error) {
	...
	binary.LittleEndian.PutUint32(payload[0:], math.Float32bits(m.Value1))
	binary.LittleEndian.PutUint32(payload[4:], math.Float32bits(m.Value2))
	binary.LittleEndian.PutUint32(payload[8:], math.Float32bits(m.Value3))
	binary.LittleEndian.PutUint32(payload[12:], math.Float32bits(m.Value4))
	binary.LittleEndian.PutUint32(payload[16:], math.Float32bits(m.Value5))
	binary.LittleEndian.PutUint32(payload[20:], math.Float32bits(m.Value6))
	binary.LittleEndian.PutUint32(payload[24:], math.Float32bits(m.Value7))
	binary.LittleEndian.PutUint32(payload[28:], math.Float32bits(m.Value8))
	binary.LittleEndian.PutUint32(payload[32:], math.Float32bits(m.Value9))
	binary.LittleEndian.PutUint32(payload[36:], math.Float32bits(m.Value10))
	binary.LittleEndian.PutUint32(payload[40:], math.Float32bits(m.Value11))
	binary.LittleEndian.PutUint32(payload[44:], math.Float32bits(m.Value12))
	binary.LittleEndian.PutUint32(payload[48:], math.Float32bits(m.Value13))
	binary.LittleEndian.PutUint32(payload[52:], math.Float32bits(m.Value14))
	binary.LittleEndian.PutUint32(payload[56:], math.Float32bits(m.Value15))
	binary.LittleEndian.PutUint32(payload[60:], math.Float32bits(m.Value16))
	binary.LittleEndian.PutUint32(payload[64:], math.Float32bits(m.Value17))
	binary.LittleEndian.PutUint32(payload[68:], math.Float32bits(m.Value18))
	binary.LittleEndian.PutUint32(payload[72:], math.Float32bits(m.Value19))
	binary.LittleEndian.PutUint32(payload[76:], math.Float32bits(m.Value20))
	binary.LittleEndian.PutUint16(payload[80:], uint16(m.Index))
	return payload, nil
}

// Unmarshal (generated function)
func (m *AqTelemetryF) Unmarshal(data []byte) error {
	payload := make([]byte, 82)
	copy(payload[0:], data)
	m.Value1 = math.Float32frombits(binary.LittleEndian.Uint32(payload[0:]))
	m.Value2 = math.Float32frombits(binary.LittleEndian.Uint32(payload[4:]))
	m.Value3 = math.Float32frombits(binary.LittleEndian.Uint32(payload[8:]))
	m.Value4 = math.Float32frombits(binary.LittleEndian.Uint32(payload[12:]))
	m.Value5 = math.Float32frombits(binary.LittleEndian.Uint32(payload[16:]))
	m.Value6 = math.Float32frombits(binary.LittleEndian.Uint32(payload[20:]))
	m.Value7 = math.Float32frombits(binary.LittleEndian.Uint32(payload[24:]))
	m.Value8 = math.Float32frombits(binary.LittleEndian.Uint32(payload[28:]))
	m.Value9 = math.Float32frombits(binary.LittleEndian.Uint32(payload[32:]))
	m.Value10 = math.Float32frombits(binary.LittleEndian.Uint32(payload[36:]))
	m.Value11 = math.Float32frombits(binary.LittleEndian.Uint32(payload[40:]))
	m.Value12 = math.Float32frombits(binary.LittleEndian.Uint32(payload[44:]))
	m.Value13 = math.Float32frombits(binary.LittleEndian.Uint32(payload[48:]))
	m.Value14 = math.Float32frombits(binary.LittleEndian.Uint32(payload[52:]))
	m.Value15 = math.Float32frombits(binary.LittleEndian.Uint32(payload[56:]))
	m.Value16 = math.Float32frombits(binary.LittleEndian.Uint32(payload[60:]))
	m.Value17 = math.Float32frombits(binary.LittleEndian.Uint32(payload[64:]))
	m.Value18 = math.Float32frombits(binary.LittleEndian.Uint32(payload[68:]))
	m.Value19 = math.Float32frombits(binary.LittleEndian.Uint32(payload[72:]))
	m.Value20 = math.Float32frombits(binary.LittleEndian.Uint32(payload[76:]))
	m.Index = uint16(binary.LittleEndian.Uint16(payload[80:]))
	return nil
}

// AqEscTelemetry struct (generated typeinfo)
...
type AqEscTelemetry struct {
	TimeBootMs  uint32   `json:"TimeBootMs" `          // Timestamp of the component clock since boot time in ms.
	Data0       []uint32 `json:"Data0" len:"4" `       // Data bits 1-32 for each ESC.
	Data1       []uint32 `json:"Data1" len:"4" `       // Data bits 33-64 for each ESC.
	StatusAge   []uint16 `json:"StatusAge" len:"4" `   // Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no data.
	Seq         uint8    `json:"Seq" `                 // Sequence number of message (first set of 4 motors is #1, next 4 is #2, etc).
	NumMotors   uint8    `json:"NumMotors" `           // Total number of active ESCs/motors on the system.
	NumInSeq    uint8    `json:"NumInSeq" `            // Number of active ESCs in this sequence (1 through this many array members will be populated with data)
	Escid       []uint8  `json:"Escid" len:"4" `       // ESC/Motor ID
	DataVersion []uint8  `json:"DataVersion" len:"4" ` // Version of data structure (determines contents).
}

// MsgID (generated function)
func (m *AqEscTelemetry) MsgID() message.MessageID {
	return MSG_ID_AQ_ESC_TELEMETRY
}

// String (generated function)
func (m *AqEscTelemetry) String() string {
	return fmt.Sprintf(
		"&autoquad.AqEscTelemetry{ TimeBootMs: %+v, Data0: %+v, Data1: %+v, StatusAge: %+v, Seq: %+v, NumMotors: %+v, NumInSeq: %+v, Escid: %0X (\"%s\"), DataVersion: %0X (\"%s\") }",
		m.TimeBootMs,
		m.Data0,
		m.Data1,
		m.StatusAge,
		...
		m.NumMotors,
		m.NumInSeq,
		m.Escid, string(m.Escid[:]),
		m.DataVersion, string(m.DataVersion[:]),
	)
}

const (
	AQ_ESC_TELEMETRY_FIELD_TIME_BOOT_MS = "AqEscTelemetry.TimeBootMs"
	AQ_ESC_TELEMETRY_FIELD_DATA0        = "AqEscTelemetry.Data0"
	AQ_ESC_TELEMETRY_FIELD_DATA1        = "AqEscTelemetry.Data1"
	AQ_ESC_TELEMETRY_FIELD_STATUS_AGE   = "AqEscTelemetry.StatusAge"
	AQ_ESC_TELEMETRY_FIELD_SEQ          = "AqEscTelemetry.Seq"
	AQ_ESC_TELEMETRY_FIELD_NUM_MOTORS   = "AqEscTelemetry.NumMotors"
	AQ_ESC_TELEMETRY_FIELD_NUM_IN_SEQ   = "AqEscTelemetry.NumInSeq"
	AQ_ESC_TELEMETRY_FIELD_ESCID        = "AqEscTelemetry.Escid"
	AQ_ESC_TELEMETRY_FIELD_DATA_VERSION = "AqEscTelemetry.DataVersion"
)

// ToMap (generated function)
func (m *AqEscTelemetry) Dict() map[string]interface{} {
	return map[string]interface{}{
		AQ_ESC_TELEMETRY_FIELD_TIME_BOOT_MS: m.TimeBootMs,
		AQ_ESC_TELEMETRY_FIELD_DATA0:        m.Data0,
		AQ_ESC_TELEMETRY_FIELD_DATA1:        m.Data1,
		AQ_ESC_TELEMETRY_FIELD_STATUS_AGE:   m.StatusAge,
		AQ_ESC_TELEMETRY_FIELD_SEQ:          m.Seq,
		AQ_ESC_TELEMETRY_FIELD_NUM_MOTORS:   m.NumMotors,
		AQ_ESC_TELEMETRY_FIELD_NUM_IN_SEQ:   m.NumInSeq,
		AQ_ESC_TELEMETRY_FIELD_ESCID:        m.Escid,
		AQ_ESC_TELEMETRY_FIELD_DATA_VERSION: m.DataVersion,
	}
}
...
func (m *AqEscTelemetry) Marshal() ([]byte, error) {
	...
	for i, v := range m.Data0 {
		binary.LittleEndian.PutUint32(payload[4+i*4:], uint32(v))
	}
	for i, v := range m.Data1 {
		binary.LittleEndian.PutUint32(payload[20+i*4:], uint32(v))
	}
	for i, v := range m.StatusAge {
		binary.LittleEndian.PutUint16(payload[36+i*2:], uint16(v))
	}
	payload[44] = byte(m.Seq)
	payload[45] = byte(m.NumMotors)
	payload[46] = byte(m.NumInSeq)
	copy(payload[47:], m.Escid)
	copy(payload[51:], m.DataVersion)
	return payload, nil
}

// Unmarshal (generated function)
func (m *AqEscTelemetry) Unmarshal(data []byte) error {
	payload := make([]byte, 55)
	copy(payload[0:], data)
	m.TimeBootMs = uint32(binary.LittleEndian.Uint32(payload[0:]))
	for i := 0; i < len(m.Data0); i++ {
		m.Data0[i] = uint32(binary.LittleEndian.Uint32(payload[4+i*4:]))
	}
	for i := 0; i < len(m.Data1); i++ {
		m.Data1[i] = uint32(binary.LittleEndian.Uint32(payload[20+i*4:]))
	}
	for i := 0; i < len(m.StatusAge); i++ {
		m.StatusAge[i] = uint16(binary.LittleEndian.Uint16(payload[36+i*2:]))
	}
	m.Seq = uint8(payload[44])
	m.NumMotors = uint8(payload[45])
	m.NumInSeq = uint8(payload[46])
	copy(m.Escid[:], payload[47:51])
	copy(m.DataVersion[:], payload[51:55])
	return nil
}
