...
type ScriptItem struct {
	...
	Name            string `json:"Name" len:"50" `   // The name of the mission script, NULL terminated.
}
...
const (
	SCRIPT_ITEM_FIELD_SEQ              = "ScriptItem.Seq"
	SCRIPT_ITEM_FIELD_TARGET_SYSTEM    = "ScriptItem.TargetSystem"
	SCRIPT_ITEM_FIELD_TARGET_COMPONENT = "ScriptItem.TargetComponent"
	SCRIPT_ITEM_FIELD_NAME             = "ScriptItem.Name"
)

// ToMap (generated function)
func (m *ScriptItem) Dict() map[string]interface{} {
	return map[string]interface{}{
		SCRIPT_ITEM_FIELD_SEQ:              m.Seq,
		SCRIPT_ITEM_FIELD_TARGET_SYSTEM:    m.TargetSystem,
		SCRIPT_ITEM_FIELD_TARGET_COMPONENT: m.TargetComponent,
		SCRIPT_ITEM_FIELD_NAME:             m.Name,
	}
}
...
const (
	SCRIPT_REQUEST_FIELD_SEQ              = "ScriptRequest.Seq"
	SCRIPT_REQUEST_FIELD_TARGET_SYSTEM    = "ScriptRequest.TargetSystem"
	SCRIPT_REQUEST_FIELD_TARGET_COMPONENT = "ScriptRequest.TargetComponent"
)

// ToMap (generated function)
func (m *ScriptRequest) Dict() map[string]interface{} {
	return map[string]interface{}{
		SCRIPT_REQUEST_FIELD_SEQ:              m.Seq,
		SCRIPT_REQUEST_FIELD_TARGET_SYSTEM:    m.TargetSystem,
		SCRIPT_REQUEST_FIELD_TARGET_COMPONENT: m.TargetComponent,
	}
}
...
const (
	SCRIPT_REQUEST_LIST_FIELD_TARGET_SYSTEM    = "ScriptRequestList.TargetSystem"
	SCRIPT_REQUEST_LIST_FIELD_TARGET_COMPONENT = "ScriptRequestList.TargetComponent"
)

// ToMap (generated function)
func (m *ScriptRequestList) Dict() map[string]interface{} {
	return map[string]interface{}{
		SCRIPT_REQUEST_LIST_FIELD_TARGET_SYSTEM:    m.TargetSystem,
		SCRIPT_REQUEST_LIST_FIELD_TARGET_COMPONENT: m.TargetComponent,
	}
}
...
type ScriptCount struct {
	Count           uint16 `json:"Count" `           // Number of script items in the sequence
	TargetSystem    uint8  `json:"TargetSystem" `    // System ID
	TargetComponent uint8  `json:"TargetComponent" ` // Component ID
}
...
const (
	SCRIPT_COUNT_FIELD_COUNT            = "ScriptCount.Count"
	SCRIPT_COUNT_FIELD_TARGET_SYSTEM    = "ScriptCount.TargetSystem"
	SCRIPT_COUNT_FIELD_TARGET_COMPONENT = "ScriptCount.TargetComponent"
)

// ToMap (generated function)
func (m *ScriptCount) Dict() map[string]interface{} {
	return map[string]interface{}{
		SCRIPT_COUNT_FIELD_COUNT:            m.Count,
		SCRIPT_COUNT_FIELD_TARGET_SYSTEM:    m.TargetSystem,
		SCRIPT_COUNT_FIELD_TARGET_COMPONENT: m.TargetComponent,
	}
}
...
type ScriptCurrent struct {
	Seq uint16 `json:"Seq" ` // Active Sequence
}
...
const (
	SCRIPT_CURRENT_FIELD_SEQ = "ScriptCurrent.Seq"
)

// ToMap (generated function)
func (m *ScriptCurrent) Dict() map[string]interface{} {
	return map[string]interface{}{
		SCRIPT_CURRENT_FIELD_SEQ: m.Seq,
	}
}
