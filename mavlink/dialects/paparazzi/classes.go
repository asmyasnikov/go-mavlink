...
func (m *ScriptItem) Dict() map[string]interface{} {
	return map[string]interface{}{
		"ScriptItem.Seq":             m.Seq,
		"ScriptItem.TargetSystem":    m.TargetSystem,
		"ScriptItem.TargetComponent": m.TargetComponent,
		"ScriptItem.Name":            m.Name,
	}
}
...
func (m *ScriptRequest) Dict() map[string]interface{} {
	return map[string]interface{}{
		"ScriptRequest.Seq":             m.Seq,
		"ScriptRequest.TargetSystem":    m.TargetSystem,
		"ScriptRequest.TargetComponent": m.TargetComponent,
	}
}
...
func (m *ScriptRequestList) Dict() map[string]interface{} {
	return map[string]interface{}{
		"ScriptRequestList.TargetSystem":    m.TargetSystem,
		"ScriptRequestList.TargetComponent": m.TargetComponent,
	}
}
...
func (m *ScriptCount) Dict() map[string]interface{} {
	return map[string]interface{}{
		"ScriptCount.Count":           m.Count,
		"ScriptCount.TargetSystem":    m.TargetSystem,
		"ScriptCount.TargetComponent": m.TargetComponent,
	}
}
