...
func init() {
	register.Register(MSG_ID_SCRIPT_ITEM, "MSG_ID_SCRIPT_ITEM", 54, 231, func(p packet.Packet) (message.Message, error) {
		msg := new(ScriptItem)
	...
	register.Register(MSG_ID_SCRIPT_REQUEST, "MSG_ID_SCRIPT_REQUEST", 4, 129, func(p packet.Packet) (message.Message, error) {
		msg := new(ScriptRequest)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
		return msg, nil
	})
	register.Register(MSG_ID_SCRIPT_REQUEST_LIST, "MSG_ID_SCRIPT_REQUEST_LIST", 2, 115, func(p packet.Packet) (message.Message, error) {
		msg := new(ScriptRequestList)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
		return msg, nil
	})
	register.Register(MSG_ID_SCRIPT_COUNT, "MSG_ID_SCRIPT_COUNT", 4, 186, func(p packet.Packet) (message.Message, error) {
		msg := new(ScriptCount)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_SCRIPT_CURRENT, "MSG_ID_SCRIPT_CURRENT", 2, 40, func(p packet.Packet) (message.Message, error) {
		msg := new(ScriptCurrent)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
		return msg, nil
