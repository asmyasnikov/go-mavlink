...
// MarshalBinary generic func
func (e GSM_LINK_TYPE) MarshalBinary() (data []byte, err error) {
	return []byte(strconv.Itoa(int(e))), nil
}

// UnmarshalBinary generic func
func (e *GSM_LINK_TYPE) UnmarshalBinary(data []byte) error {
	v, err := strconv.Atoi(string(data))
	if err != nil {
		return err
	}
...
// MarshalBinary generic func
func (e GSM_MODEM_TYPE) MarshalBinary() (data []byte, err error) {
	return []byte(strconv.Itoa(int(e))), nil
}

// UnmarshalBinary generic func
func (e *GSM_MODEM_TYPE) UnmarshalBinary(data []byte) error {
	v, err := strconv.Atoi(string(data))
	if err != nil {
		return err
	}
