...
func init() {
	register.Register(MSG_ID_COMMAND_INT_STAMPED, "MSG_ID_COMMAND_INT_STAMPED", 47, 119, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_COMMAND_LONG_STAMPED, "MSG_ID_COMMAND_LONG_STAMPED", 45, 102, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SENS_POWER, "MSG_ID_SENS_POWER", 16, 218, func(p packet.Packet) (message.Message, error) {
		msg := new(SensPower)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_SENS_MPPT, "MSG_ID_SENS_MPPT", 41, 231, func(p packet.Packet) (message.Message, error) {
		msg := new(SensMppt)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_ASLCTRL_DATA, "MSG_ID_ASLCTRL_DATA", 98, 172, func(p packet.Packet) (message.Message, error) {
		msg := new(AslctrlData)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_ASLCTRL_DEBUG, "MSG_ID_ASLCTRL_DEBUG", 38, 251, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_ASLUAV_STATUS, "MSG_ID_ASLUAV_STATUS", 14, 97, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_EKF_EXT, "MSG_ID_EKF_EXT", 32, 64, func(p packet.Packet) (message.Message, error) {
		msg := new(EkfExt)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_ASL_OBCTRL, "MSG_ID_ASL_OBCTRL", 33, 234, func(p packet.Packet) (message.Message, error) {
		msg := new(AslObctrl)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_SENS_ATMOS, "MSG_ID_SENS_ATMOS", 16, 144, func(p packet.Packet) (message.Message, error) {
		msg := new(SensAtmos)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_SENS_BATMON, "MSG_ID_SENS_BATMON", 41, 155, func(p packet.Packet) (message.Message, error) {
		msg := new(SensBatmon)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_FW_SOARING_DATA, "MSG_ID_FW_SOARING_DATA", 102, 20, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SENSORPOD_STATUS, "MSG_ID_SENSORPOD_STATUS", 16, 54, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SENS_POWER_BOARD, "MSG_ID_SENS_POWER_BOARD", 46, 222, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_GSM_LINK_STATUS, "MSG_ID_GSM_LINK_STATUS", 14, 200, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SATCOM_LINK_STATUS, "MSG_ID_SATCOM_LINK_STATUS", 24, 23, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SENSOR_AIRFLOW_ANGLES, "MSG_ID_SENSOR_AIRFLOW_ANGLES", 18, 149, func(p packet.Packet) (message.Message, error) {
