...
// Message IDs
const (
	MSG_ID_FLEXIFUNCTION_SET                       message.MessageID = 150
	MSG_ID_FLEXIFUNCTION_READ_REQ                  message.MessageID = 151
	MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION           message.MessageID = 152
	MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION_ACK       message.MessageID = 153
	MSG_ID_FLEXIFUNCTION_DIRECTORY                 message.MessageID = 155
	MSG_ID_FLEXIFUNCTION_DIRECTORY_ACK             message.MessageID = 156
	MSG_ID_FLEXIFUNCTION_COMMAND                   message.MessageID = 157
	MSG_ID_FLEXIFUNCTION_COMMAND_ACK               message.MessageID = 158
	MSG_ID_SERIAL_UDB_EXTRA_F2_A                   message.MessageID = 170
	MSG_ID_SERIAL_UDB_EXTRA_F2_B                   message.MessageID = 171
	MSG_ID_SERIAL_UDB_EXTRA_F4                     message.MessageID = 172
	MSG_ID_SERIAL_UDB_EXTRA_F5                     message.MessageID = 173
	MSG_ID_SERIAL_UDB_EXTRA_F6                     message.MessageID = 174
	MSG_ID_SERIAL_UDB_EXTRA_F7                     message.MessageID = 175
	MSG_ID_SERIAL_UDB_EXTRA_F8                     message.MessageID = 176
	MSG_ID_SERIAL_UDB_EXTRA_F13                    message.MessageID = 177
	MSG_ID_SERIAL_UDB_EXTRA_F14                    message.MessageID = 178
	MSG_ID_SERIAL_UDB_EXTRA_F15                    message.MessageID = 179
	MSG_ID_SERIAL_UDB_EXTRA_F16                    message.MessageID = 180
	MSG_ID_ALTITUDES                               message.MessageID = 181
	MSG_ID_AIRSPEEDS                               message.MessageID = 182
	MSG_ID_SERIAL_UDB_EXTRA_F17                    message.MessageID = 183
	MSG_ID_SERIAL_UDB_EXTRA_F18                    message.MessageID = 184
	MSG_ID_SERIAL_UDB_EXTRA_F19                    message.MessageID = 185
	MSG_ID_SERIAL_UDB_EXTRA_F20                    message.MessageID = 186
	MSG_ID_SERIAL_UDB_EXTRA_F21                    message.MessageID = 187
	MSG_ID_SERIAL_UDB_EXTRA_F22                    message.MessageID = 188
