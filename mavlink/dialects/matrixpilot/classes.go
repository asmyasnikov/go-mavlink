...
type FlexifunctionReadReq struct {
	ReadReqType     int16 `json:"ReadReqType" `     // Type of flexifunction data requested
	DataIndex       int16 `json:"DataIndex" `       // index into data where needed
	TargetSystem    uint8 `json:"TargetSystem" `    // System ID
	TargetComponent uint8 `json:"TargetComponent" ` // Component ID
}
...
type FlexifunctionBufferFunction struct {
	FuncIndex       uint16 `json:"FuncIndex" `       // Function index
	FuncCount       uint16 `json:"FuncCount" `       // Total count of functions
	DataAddress     uint16 `json:"DataAddress" `     // Address in the flexifunction data, Set to 0xFFFF to use address in target memory
	DataSize        uint16 `json:"DataSize" `        // Size of the
	TargetSystem    uint8  `json:"TargetSystem" `    // System ID
	TargetComponent uint8  `json:"TargetComponent" ` // Component ID
	Data            []int8 `json:"Data" len:"48" `   // Settings data
}
...
type FlexifunctionBufferFunctionAck struct {
	FuncIndex       uint16 `json:"FuncIndex" `       // Function index
	Result          uint16 `json:"Result" `          // result of acknowledge, 0=fail, 1=good
	TargetSystem    uint8  `json:"TargetSystem" `    // System ID
	TargetComponent uint8  `json:"TargetComponent" ` // Component ID
}
...
type FlexifunctionDirectory struct {
	TargetSystem    uint8  `json:"TargetSystem" `           // System ID
	TargetComponent uint8  `json:"TargetComponent" `        // Component ID
	DirectoryType   uint8  `json:"DirectoryType" `          // 0=inputs, 1=outputs
	StartIndex      uint8  `json:"StartIndex" `             // index of first directory entry to write
	Count           uint8  `json:"Count" `                  // count of directory entries to write
	DirectoryData   []int8 `json:"DirectoryData" len:"48" ` // Settings data
}
...
type FlexifunctionCommand struct {
	TargetSystem    uint8 `json:"TargetSystem" `    // System ID
	TargetComponent uint8 `json:"TargetComponent" ` // Component ID
	CommandType     uint8 `json:"CommandType" `     // Flexifunction command type
}
...
type FlexifunctionCommandAck struct {
	CommandType uint16 `json:"CommandType" ` // Command acknowledged
	Result      uint16 `json:"Result" `      // result of acknowledge
}
...
type SerialUdbExtraF2A struct {
	SueTime           uint32 `json:"SueTime" `           // Serial UDB Extra Time
	SueLatitude       int32  `json:"SueLatitude" `       // Serial UDB Extra Latitude
	SueLongitude      int32  `json:"SueLongitude" `      // Serial UDB Extra Longitude
	SueAltitude       int32  `json:"SueAltitude" `       // Serial UDB Extra Altitude
	SueWaypointIndex  uint16 `json:"SueWaypointIndex" `  // Serial UDB Extra Waypoint Index
	SueRmat0          int16  `json:"SueRmat0" `          // Serial UDB Extra Rmat 0
	SueRmat1          int16  `json:"SueRmat1" `          // Serial UDB Extra Rmat 1
	SueRmat2          int16  `json:"SueRmat2" `          // Serial UDB Extra Rmat 2
	SueRmat3          int16  `json:"SueRmat3" `          // Serial UDB Extra Rmat 3
	SueRmat4          int16  `json:"SueRmat4" `          // Serial UDB Extra Rmat 4
	SueRmat5          int16  `json:"SueRmat5" `          // Serial UDB Extra Rmat 5
	SueRmat6          int16  `json:"SueRmat6" `          // Serial UDB Extra Rmat 6
	SueRmat7          int16  `json:"SueRmat7" `          // Serial UDB Extra Rmat 7
	SueRmat8          int16  `json:"SueRmat8" `          // Serial UDB Extra Rmat 8
	SueCog            uint16 `json:"SueCog" `            // Serial UDB Extra GPS Course Over Ground
	SueSog            int16  `json:"SueSog" `            // Serial UDB Extra Speed Over Ground
	SueCPULoad        uint16 `json:"SueCPULoad" `        // Serial UDB Extra CPU Load
	SueAirSpeed3dimu  uint16 `json:"SueAirSpeed3dimu" `  // Serial UDB Extra 3D IMU Air Speed
	SueEstimatedWind0 int16  `json:"SueEstimatedWind0" ` // Serial UDB Extra Estimated Wind 0
	SueEstimatedWind1 int16  `json:"SueEstimatedWind1" ` // Serial UDB Extra Estimated Wind 1
	SueEstimatedWind2 int16  `json:"SueEstimatedWind2" ` // Serial UDB Extra Estimated Wind 2
	SueMagfieldearth0 int16  `json:"SueMagfieldearth0" ` // Serial UDB Extra Magnetic Field Earth 0
	SueMagfieldearth1 int16  `json:"SueMagfieldearth1" ` // Serial UDB Extra Magnetic Field Earth 1
	SueMagfieldearth2 int16  `json:"SueMagfieldearth2" ` // Serial UDB Extra Magnetic Field Earth 2
	SueSvs            int16  `json:"SueSvs" `            // Serial UDB Extra Number of Sattelites in View
	SueHdop           int16  `json:"SueHdop" `           // Serial UDB Extra GPS Horizontal Dilution of Precision
	SueStatus         uint8  `json:"SueStatus" `         // Serial UDB Extra Status
}
...
type SerialUdbExtraF2B struct {
	SueTime                uint32 `json:"SueTime" `                // Serial UDB Extra Time
	SueFlags               uint32 `json:"SueFlags" `               // Serial UDB Extra Status Flags
	SueBaromPress          int32  `json:"SueBaromPress" `          // SUE barometer pressure
	SueBaromAlt            int32  `json:"SueBaromAlt" `            // SUE barometer altitude
	SuePwmInput1           int16  `json:"SuePwmInput1" `           // Serial UDB Extra PWM Input Channel 1
	SuePwmInput2           int16  `json:"SuePwmInput2" `           // Serial UDB Extra PWM Input Channel 2
	SuePwmInput3           int16  `json:"SuePwmInput3" `           // Serial UDB Extra PWM Input Channel 3
	SuePwmInput4           int16  `json:"SuePwmInput4" `           // Serial UDB Extra PWM Input Channel 4
	SuePwmInput5           int16  `json:"SuePwmInput5" `           // Serial UDB Extra PWM Input Channel 5
	SuePwmInput6           int16  `json:"SuePwmInput6" `           // Serial UDB Extra PWM Input Channel 6
	SuePwmInput7           int16  `json:"SuePwmInput7" `           // Serial UDB Extra PWM Input Channel 7
	SuePwmInput8           int16  `json:"SuePwmInput8" `           // Serial UDB Extra PWM Input Channel 8
	SuePwmInput9           int16  `json:"SuePwmInput9" `           // Serial UDB Extra PWM Input Channel 9
	SuePwmInput10          int16  `json:"SuePwmInput10" `          // Serial UDB Extra PWM Input Channel 10
	SuePwmInput11          int16  `json:"SuePwmInput11" `          // Serial UDB Extra PWM Input Channel 11
	SuePwmInput12          int16  `json:"SuePwmInput12" `          // Serial UDB Extra PWM Input Channel 12
	SuePwmOutput1          int16  `json:"SuePwmOutput1" `          // Serial UDB Extra PWM Output Channel 1
	SuePwmOutput2          int16  `json:"SuePwmOutput2" `          // Serial UDB Extra PWM Output Channel 2
	SuePwmOutput3          int16  `json:"SuePwmOutput3" `          // Serial UDB Extra PWM Output Channel 3
	SuePwmOutput4          int16  `json:"SuePwmOutput4" `          // Serial UDB Extra PWM Output Channel 4
	SuePwmOutput5          int16  `json:"SuePwmOutput5" `          // Serial UDB Extra PWM Output Channel 5
	SuePwmOutput6          int16  `json:"SuePwmOutput6" `          // Serial UDB Extra PWM Output Channel 6
	SuePwmOutput7          int16  `json:"SuePwmOutput7" `          // Serial UDB Extra PWM Output Channel 7
	SuePwmOutput8          int16  `json:"SuePwmOutput8" `          // Serial UDB Extra PWM Output Channel 8
	SuePwmOutput9          int16  `json:"SuePwmOutput9" `          // Serial UDB Extra PWM Output Channel 9
	SuePwmOutput10         int16  `json:"SuePwmOutput10" `         // Serial UDB Extra PWM Output Channel 10
	SuePwmOutput11         int16  `json:"SuePwmOutput11" `         // Serial UDB Extra PWM Output Channel 11
	SuePwmOutput12         int16  `json:"SuePwmOutput12" `         // Serial UDB Extra PWM Output Channel 12
	SueImuLocationX        int16  `json:"SueImuLocationX" `        // Serial UDB Extra IMU Location X
	SueImuLocationY        int16  `json:"SueImuLocationY" `        // Serial UDB Extra IMU Location Y
	SueImuLocationZ        int16  `json:"SueImuLocationZ" `        // Serial UDB Extra IMU Location Z
	SueLocationErrorEarthX int16  `json:"SueLocationErrorEarthX" ` // Serial UDB Location Error Earth X
	SueLocationErrorEarthY int16  `json:"SueLocationErrorEarthY" ` // Serial UDB Location Error Earth Y
	SueLocationErrorEarthZ int16  `json:"SueLocationErrorEarthZ" ` // Serial UDB Location Error Earth Z
	SueOscFails            int16  `json:"SueOscFails" `            // Serial UDB Extra Oscillator Failure Count
	SueImuVelocityX        int16  `json:"SueImuVelocityX" `        // Serial UDB Extra IMU Velocity X
	SueImuVelocityY        int16  `json:"SueImuVelocityY" `        // Serial UDB Extra IMU Velocity Y
	SueImuVelocityZ        int16  `json:"SueImuVelocityZ" `        // Serial UDB Extra IMU Velocity Z
	SueWaypointGoalX       int16  `json:"SueWaypointGoalX" `       // Serial UDB Extra Current Waypoint Goal X
	SueWaypointGoalY       int16  `json:"SueWaypointGoalY" `       // Serial UDB Extra Current Waypoint Goal Y
	SueWaypointGoalZ       int16  `json:"SueWaypointGoalZ" `       // Serial UDB Extra Current Waypoint Goal Z
	SueAeroX               int16  `json:"SueAeroX" `               // Aeroforce in UDB X Axis
	SueAeroY               int16  `json:"SueAeroY" `               // Aeroforce in UDB Y Axis
	SueAeroZ               int16  `json:"SueAeroZ" `               // Aeroforce in UDB Z axis
	SueBaromTemp           int16  `json:"SueBaromTemp" `           // SUE barometer temperature
	SueBatVolt             int16  `json:"SueBatVolt" `             // SUE battery voltage
	SueBatAmp              int16  `json:"SueBatAmp" `              // SUE battery current
	SueBatAmpHours         int16  `json:"SueBatAmpHours" `         // SUE battery milli amp hours used
	SueDesiredHeight       int16  `json:"SueDesiredHeight" `       // Sue autopilot desired height
	SueMemoryStackFree     int16  `json:"SueMemoryStackFree" `     // Serial UDB Extra Stack Memory Free
}
...
type SerialUdbExtraF4 struct {
	SueRollStabilizationAilerons uint8 `json:"SueRollStabilizationAilerons" ` // Serial UDB Extra Roll Stabilization with Ailerons Enabled
	SueRollStabilizationRudder   uint8 `json:"SueRollStabilizationRudder" `   // Serial UDB Extra Roll Stabilization with Rudder Enabled
	SuePitchStabilization        uint8 `json:"SuePitchStabilization" `        // Serial UDB Extra Pitch Stabilization Enabled
	SueYawStabilizationRudder    uint8 `json:"SueYawStabilizationRudder" `    // Serial UDB Extra Yaw Stabilization using Rudder Enabled
	SueYawStabilizationAileron   uint8 `json:"SueYawStabilizationAileron" `   // Serial UDB Extra Yaw Stabilization using Ailerons Enabled
	SueAileronNavigation         uint8 `json:"SueAileronNavigation" `         // Serial UDB Extra Navigation with Ailerons Enabled
	SueRudderNavigation          uint8 `json:"SueRudderNavigation" `          // Serial UDB Extra Navigation with Rudder Enabled
	SueAltitudeholdStabilized    uint8 `json:"SueAltitudeholdStabilized" `    // Serial UDB Extra Type of Alitude Hold when in Stabilized Mode
	SueAltitudeholdWaypoint      uint8 `json:"SueAltitudeholdWaypoint" `      // Serial UDB Extra Type of Alitude Hold when in Waypoint Mode
	SueRacingMode                uint8 `json:"SueRacingMode" `                // Serial UDB Extra Firmware racing mode enabled
}
...
type SerialUdbExtraF5 struct {
	SueYawkpAileron float32 `json:"SueYawkpAileron" ` // Serial UDB YAWKP_AILERON Gain for Proporional control of navigation
	SueYawkdAileron float32 `json:"SueYawkdAileron" ` // Serial UDB YAWKD_AILERON Gain for Rate control of navigation
	SueRollkp       float32 `json:"SueRollkp" `       // Serial UDB Extra ROLLKP Gain for Proportional control of roll stabilization
	SueRollkd       float32 `json:"SueRollkd" `       // Serial UDB Extra ROLLKD Gain for Rate control of roll stabilization
}
...
type SerialUdbExtraF6 struct {
	SuePitchgain     float32 `json:"SuePitchgain" `     // Serial UDB Extra PITCHGAIN Proportional Control
	SuePitchkd       float32 `json:"SuePitchkd" `       // Serial UDB Extra Pitch Rate Control
	SueRudderElevMix float32 `json:"SueRudderElevMix" ` // Serial UDB Extra Rudder to Elevator Mix
	SueRollElevMix   float32 `json:"SueRollElevMix" `   // Serial UDB Extra Roll to Elevator Mix
	SueElevatorBoost float32 `json:"SueElevatorBoost" ` // Gain For Boosting Manual Elevator control When Plane Stabilized
}
...
type SerialUdbExtraF7 struct {
	SueYawkpRudder  float32 `json:"SueYawkpRudder" `  // Serial UDB YAWKP_RUDDER Gain for Proporional control of navigation
	SueYawkdRudder  float32 `json:"SueYawkdRudder" `  // Serial UDB YAWKD_RUDDER Gain for Rate control of navigation
	SueRollkpRudder float32 `json:"SueRollkpRudder" ` // Serial UDB Extra ROLLKP_RUDDER Gain for Proportional control of roll stabilization
	SueRollkdRudder float32 `json:"SueRollkdRudder" ` // Serial UDB Extra ROLLKD_RUDDER Gain for Rate control of roll stabilization
	SueRudderBoost  float32 `json:"SueRudderBoost" `  // SERIAL UDB EXTRA Rudder Boost Gain to Manual Control when stabilized
	SueRtlPitchDown float32 `json:"SueRtlPitchDown" ` // Serial UDB Extra Return To Landing - Angle to Pitch Plane Down
}
...
type SerialUdbExtraF8 struct {
	SueHeightTargetMax    float32 `json:"SueHeightTargetMax" `    // Serial UDB Extra HEIGHT_TARGET_MAX
	SueHeightTargetMin    float32 `json:"SueHeightTargetMin" `    // Serial UDB Extra HEIGHT_TARGET_MIN
	SueAltHoldThrottleMin float32 `json:"SueAltHoldThrottleMin" ` // Serial UDB Extra ALT_HOLD_THROTTLE_MIN
	SueAltHoldThrottleMax float32 `json:"SueAltHoldThrottleMax" ` // Serial UDB Extra ALT_HOLD_THROTTLE_MAX
	SueAltHoldPitchMin    float32 `json:"SueAltHoldPitchMin" `    // Serial UDB Extra ALT_HOLD_PITCH_MIN
	SueAltHoldPitchMax    float32 `json:"SueAltHoldPitchMax" `    // Serial UDB Extra ALT_HOLD_PITCH_MAX
	SueAltHoldPitchHigh   float32 `json:"SueAltHoldPitchHigh" `   // Serial UDB Extra ALT_HOLD_PITCH_HIGH
}
...
type SerialUdbExtraF13 struct {
	SueLatOrigin int32 `json:"SueLatOrigin" ` // Serial UDB Extra MP Origin Latitude
	SueLonOrigin int32 `json:"SueLonOrigin" ` // Serial UDB Extra MP Origin Longitude
	SueAltOrigin int32 `json:"SueAltOrigin" ` // Serial UDB Extra MP Origin Altitude Above Sea Level
	SueWeekNo    int16 `json:"SueWeekNo" `    // Serial UDB Extra GPS Week Number
}
...
type SerialUdbExtraF14 struct {
	SueTrapSource     uint32 `json:"SueTrapSource" `     // Serial UDB Extra Type Program Address of Last Trap
	SueRcon           int16  `json:"SueRcon" `           // Serial UDB Extra Reboot Register of DSPIC
	SueTrapFlags      int16  `json:"SueTrapFlags" `      // Serial UDB Extra  Last dspic Trap Flags
	SueOscFailCount   int16  `json:"SueOscFailCount" `   // Serial UDB Extra Number of Ocillator Failures
	SueWindEstimation uint8  `json:"SueWindEstimation" ` // Serial UDB Extra Wind Estimation Enabled
	SueGpsType        uint8  `json:"SueGpsType" `        // Serial UDB Extra Type of GPS Unit
	SueDr             uint8  `json:"SueDr" `             // Serial UDB Extra Dead Reckoning Enabled
	SueBoardType      uint8  `json:"SueBoardType" `      // Serial UDB Extra Type of UDB Hardware
	SueAirframe       uint8  `json:"SueAirframe" `       // Serial UDB Extra Type of Airframe
	SueClockConfig    uint8  `json:"SueClockConfig" `    // Serial UDB Extra UDB Internal Clock Configuration
	SueFlightPlanType uint8  `json:"SueFlightPlanType" ` // Serial UDB Extra Type of Flight Plan
}
...
type SerialUdbExtraF15 struct {
	SueIDVehicleModelName    []uint8 `json:"SueIDVehicleModelName" len:"40" `    // Serial UDB Extra Model Name Of Vehicle
	SueIDVehicleRegistration []uint8 `json:"SueIDVehicleRegistration" len:"20" ` // Serial UDB Extra Registraton Number of Vehicle
}
...
type SerialUdbExtraF16 struct {
	SueIDLeadPilot    []uint8 `json:"SueIDLeadPilot" len:"40" `    // Serial UDB Extra Name of Expected Lead Pilot
	SueIDDiyDronesURL []uint8 `json:"SueIDDiyDronesURL" len:"70" ` // Serial UDB Extra URL of Lead Pilot or Team
}
...
type Altitudes struct {
	TimeBootMs     uint32 `json:"TimeBootMs" `     // Timestamp (milliseconds since system boot)
	AltGps         int32  `json:"AltGps" `         // GPS altitude (MSL) in meters, expressed as * 1000 (millimeters)
	AltImu         int32  `json:"AltImu" `         // IMU altitude above ground in meters, expressed as * 1000 (millimeters)
	AltBarometric  int32  `json:"AltBarometric" `  // barometeric altitude above ground in meters, expressed as * 1000 (millimeters)
	AltOpticalFlow int32  `json:"AltOpticalFlow" ` // Optical flow altitude above ground in meters, expressed as * 1000 (millimeters)
	AltRangeFinder int32  `json:"AltRangeFinder" ` // Rangefinder Altitude above ground in meters, expressed as * 1000 (millimeters)
	AltExtra       int32  `json:"AltExtra" `       // Extra altitude above ground in meters, expressed as * 1000 (millimeters)
}
...
type Airspeeds struct {
	TimeBootMs         uint32 `json:"TimeBootMs" `         // Timestamp (milliseconds since system boot)
	AirspeedImu        int16  `json:"AirspeedImu" `        // Airspeed estimate from IMU, cm/s
	AirspeedPitot      int16  `json:"AirspeedPitot" `      // Pitot measured forward airpseed, cm/s
	AirspeedHotWire    int16  `json:"AirspeedHotWire" `    // Hot wire anenometer measured airspeed, cm/s
	AirspeedUltrasonic int16  `json:"AirspeedUltrasonic" ` // Ultrasonic measured airspeed, cm/s
	Aoa                int16  `json:"Aoa" `                // Angle of attack sensor, degrees * 10
	Aoy                int16  `json:"Aoy" `                // Yaw angle sensor, degrees * 10
}
...
type SerialUdbExtraF17 struct {
	SueFeedForward float32 `json:"SueFeedForward" ` // SUE Feed Forward Gain
	SueTurnRateNav float32 `json:"SueTurnRateNav" ` // SUE Max Turn Rate when Navigating
	SueTurnRateFbw float32 `json:"SueTurnRateFbw" ` // SUE Max Turn Rate in Fly By Wire Mode
}
...
type SerialUdbExtraF18 struct {
	AngleOfAttackNormal   float32 `json:"AngleOfAttackNormal" `   // SUE Angle of Attack Normal
	AngleOfAttackInverted float32 `json:"AngleOfAttackInverted" ` // SUE Angle of Attack Inverted
	ElevatorTrimNormal    float32 `json:"ElevatorTrimNormal" `    // SUE Elevator Trim Normal
	ElevatorTrimInverted  float32 `json:"ElevatorTrimInverted" `  // SUE Elevator Trim Inverted
	ReferenceSpeed        float32 `json:"ReferenceSpeed" `        // SUE reference_speed
}
...
type SerialUdbExtraF19 struct {
	SueAileronOutputChannel  uint8 `json:"SueAileronOutputChannel" `  // SUE aileron output channel
	SueAileronReversed       uint8 `json:"SueAileronReversed" `       // SUE aileron reversed
	SueElevatorOutputChannel uint8 `json:"SueElevatorOutputChannel" ` // SUE elevator output channel
	SueElevatorReversed      uint8 `json:"SueElevatorReversed" `      // SUE elevator reversed
	SueThrottleOutputChannel uint8 `json:"SueThrottleOutputChannel" ` // SUE throttle output channel
	SueThrottleReversed      uint8 `json:"SueThrottleReversed" `      // SUE throttle reversed
	SueRudderOutputChannel   uint8 `json:"SueRudderOutputChannel" `   // SUE rudder output channel
	SueRudderReversed        uint8 `json:"SueRudderReversed" `        // SUE rudder reversed
}
...
type SerialUdbExtraF20 struct {
	SueTrimValueInput1  int16 `json:"SueTrimValueInput1" `  // SUE UDB PWM Trim Value on Input 1
	SueTrimValueInput2  int16 `json:"SueTrimValueInput2" `  // SUE UDB PWM Trim Value on Input 2
	SueTrimValueInput3  int16 `json:"SueTrimValueInput3" `  // SUE UDB PWM Trim Value on Input 3
	SueTrimValueInput4  int16 `json:"SueTrimValueInput4" `  // SUE UDB PWM Trim Value on Input 4
	SueTrimValueInput5  int16 `json:"SueTrimValueInput5" `  // SUE UDB PWM Trim Value on Input 5
	SueTrimValueInput6  int16 `json:"SueTrimValueInput6" `  // SUE UDB PWM Trim Value on Input 6
	SueTrimValueInput7  int16 `json:"SueTrimValueInput7" `  // SUE UDB PWM Trim Value on Input 7
	SueTrimValueInput8  int16 `json:"SueTrimValueInput8" `  // SUE UDB PWM Trim Value on Input 8
	SueTrimValueInput9  int16 `json:"SueTrimValueInput9" `  // SUE UDB PWM Trim Value on Input 9
	SueTrimValueInput10 int16 `json:"SueTrimValueInput10" ` // SUE UDB PWM Trim Value on Input 10
	SueTrimValueInput11 int16 `json:"SueTrimValueInput11" ` // SUE UDB PWM Trim Value on Input 11
	SueTrimValueInput12 int16 `json:"SueTrimValueInput12" ` // SUE UDB PWM Trim Value on Input 12
	SueNumberOfInputs   uint8 `json:"SueNumberOfInputs" `   // SUE Number of Input Channels
}
...
type SerialUdbExtraF21 struct {
	SueAccelXOffset int16 `json:"SueAccelXOffset" ` // SUE X accelerometer offset
	SueAccelYOffset int16 `json:"SueAccelYOffset" ` // SUE Y accelerometer offset
	SueAccelZOffset int16 `json:"SueAccelZOffset" ` // SUE Z accelerometer offset
	SueGyroXOffset  int16 `json:"SueGyroXOffset" `  // SUE X gyro offset
	SueGyroYOffset  int16 `json:"SueGyroYOffset" `  // SUE Y gyro offset
	SueGyroZOffset  int16 `json:"SueGyroZOffset" `  // SUE Z gyro offset
}
...
type SerialUdbExtraF22 struct {
	SueAccelXAtCalibration int16 `json:"SueAccelXAtCalibration" ` // SUE X accelerometer at calibration time
	SueAccelYAtCalibration int16 `json:"SueAccelYAtCalibration" ` // SUE Y accelerometer at calibration time
	SueAccelZAtCalibration int16 `json:"SueAccelZAtCalibration" ` // SUE Z accelerometer at calibration time
	SueGyroXAtCalibration  int16 `json:"SueGyroXAtCalibration" `  // SUE X gyro at calibration time
	SueGyroYAtCalibration  int16 `json:"SueGyroYAtCalibration" `  // SUE Y gyro at calibration time
	SueGyroZAtCalibration  int16 `json:"SueGyroZAtCalibration" `  // SUE Z gyro at calibration time
}
