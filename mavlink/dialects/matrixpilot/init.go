...
func init() {
	register.Register(MSG_ID_FLEXIFUNCTION_SET, "MSG_ID_FLEXIFUNCTION_SET", 2, 181, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_READ_REQ, "MSG_ID_FLEXIFUNCTION_READ_REQ", 6, 26, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION, "MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION", 58, 101, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION_ACK, "MSG_ID_FLEXIFUNCTION_BUFFER_FUNCTION_ACK", 6, 109, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_DIRECTORY, "MSG_ID_FLEXIFUNCTION_DIRECTORY", 53, 12, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_DIRECTORY_ACK, "MSG_ID_FLEXIFUNCTION_DIRECTORY_ACK", 7, 218, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_COMMAND, "MSG_ID_FLEXIFUNCTION_COMMAND", 3, 133, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_FLEXIFUNCTION_COMMAND_ACK, "MSG_ID_FLEXIFUNCTION_COMMAND_ACK", 4, 208, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F2_A, "MSG_ID_SERIAL_UDB_EXTRA_F2_A", 61, 103, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F2_B, "MSG_ID_SERIAL_UDB_EXTRA_F2_B", 108, 245, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F4, "MSG_ID_SERIAL_UDB_EXTRA_F4", 10, 191, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F5, "MSG_ID_SERIAL_UDB_EXTRA_F5", 16, 54, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F6, "MSG_ID_SERIAL_UDB_EXTRA_F6", 20, 54, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F7, "MSG_ID_SERIAL_UDB_EXTRA_F7", 24, 171, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F8, "MSG_ID_SERIAL_UDB_EXTRA_F8", 28, 142, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F13, "MSG_ID_SERIAL_UDB_EXTRA_F13", 14, 249, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F14, "MSG_ID_SERIAL_UDB_EXTRA_F14", 17, 123, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F15, "MSG_ID_SERIAL_UDB_EXTRA_F15", 60, 7, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F16, "MSG_ID_SERIAL_UDB_EXTRA_F16", 110, 222, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_ALTITUDES, "MSG_ID_ALTITUDES", 28, 55, func(p packet.Packet) (message.Message, error) {
		msg := new(Altitudes)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_AIRSPEEDS, "MSG_ID_AIRSPEEDS", 16, 154, func(p packet.Packet) (message.Message, error) {
		msg := new(Airspeeds)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F17, "MSG_ID_SERIAL_UDB_EXTRA_F17", 12, 175, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F18, "MSG_ID_SERIAL_UDB_EXTRA_F18", 20, 41, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F19, "MSG_ID_SERIAL_UDB_EXTRA_F19", 8, 87, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F20, "MSG_ID_SERIAL_UDB_EXTRA_F20", 25, 144, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F21, "MSG_ID_SERIAL_UDB_EXTRA_F21", 12, 134, func(p packet.Packet) (message.Message, error) {
	...
	register.Register(MSG_ID_SERIAL_UDB_EXTRA_F22, "MSG_ID_SERIAL_UDB_EXTRA_F22", 12, 91, func(p packet.Packet) (message.Message, error) {
