...
func (e GSM_LINK_TYPE) String() string {
	if name, ok := map[GSM_LINK_TYPE]string{
...
func (e GSM_LINK_TYPE) Bitmask() string {
	bitmap := ""
	for _, entry := range []GSM_LINK_TYPE{
		GSM_LINK_TYPE_NONE,
...
func (e GSM_MODEM_TYPE) String() string {
	if name, ok := map[GSM_MODEM_TYPE]string{
...
func (e GSM_MODEM_TYPE) Bitmask() string {
	bitmap := ""
	for _, entry := range []GSM_MODEM_TYPE{
...
type CommandIntStamped struct {
	...
	Command          MAV_CMD   // The scheduled action for the mission item, as defined by MAV_CMD enum
	TargetSystem     uint8     // System ID
	TargetComponent  uint8     // Component ID
	Frame            MAV_FRAME // The coordinate system of the COMMAND, as defined by MAV_FRAME enum
...
func (m *CommandIntStamped) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 47), payload...)
...
type CommandLongStamped struct {
	...
	Command          MAV_CMD // Command ID, as defined by MAV_CMD enum.
...
// Unmarshal (generated function)
func (m *CommandLongStamped) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 45), payload...)
	m.VehicleTimestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
	m.UtcTime = uint32(binary.LittleEndian.Uint32(payload[8:]))
	m.Param1 = math.Float32frombits(binary.LittleEndian.Uint32(payload[12:]))
	m.Param2 = math.Float32frombits(binary.LittleEndian.Uint32(payload[16:]))
...
// Unmarshal (generated function)
func (m *SensPower) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *SensMppt) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *AslctrlData) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 98), payload...)
...
// Unmarshal (generated function)
func (m *AslctrlDebug) Unmarshal(payload []byte) error {
...
type AsluavStatus struct {
	...
	ServoStatus  []uint8 `len:"8" ` //  Status vector for up to 8 servos
}
...
func (m *AsluavStatus) Marshal() ([]byte, error) {
	...
	copy(payload[6:], m.ServoStatus[:func(l, m int) int {
		if l < m {
			return l
		}
		return m
...
// Unmarshal (generated function)
func (m *AsluavStatus) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *EkfExt) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *AslObctrl) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *SensAtmos) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 16), payload...)
	m.Timestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
...
// Unmarshal (generated function)
func (m *SensBatmon) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 41), payload...)
...
// Unmarshal (generated function)
func (m *FwSoaringData) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 102), payload...)
	m.Timestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
...
// Unmarshal (generated function)
func (m *SensorpodStatus) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 16), payload...)
	m.Timestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
...
// Unmarshal (generated function)
func (m *SensPowerBoard) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 46), payload...)
	m.Timestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
...
type GsmLinkStatus struct {
	...
	GsmModemType GSM_MODEM_TYPE // GSM modem used
	GsmLinkType  GSM_LINK_TYPE  // GSM link type
...
// Unmarshal (generated function)
func (m *GsmLinkStatus) Unmarshal(payload []byte) error {
	payload = append(make([]byte, 14), payload...)
	m.Timestamp = uint64(binary.LittleEndian.Uint64(payload[0:]))
...
// Unmarshal (generated function)
func (m *SatcomLinkStatus) Unmarshal(payload []byte) error {
...
// Unmarshal (generated function)
func (m *SensorAirflowAngles) Unmarshal(payload []byte) error {
...
func init() {
	mavlink.Register(MSG_ID_COMMAND_INT_STAMPED, "MSG_ID_COMMAND_INT_STAMPED", 47, 119, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_COMMAND_LONG_STAMPED, "MSG_ID_COMMAND_LONG_STAMPED", 45, 102, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_SENS_POWER, "MSG_ID_SENS_POWER", 16, 218, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(SensPower)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_SENS_MPPT, "MSG_ID_SENS_MPPT", 41, 231, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(SensMppt)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_ASLCTRL_DATA, "MSG_ID_ASLCTRL_DATA", 98, 172, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(AslctrlData)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_ASLCTRL_DEBUG, "MSG_ID_ASLCTRL_DEBUG", 38, 251, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_ASLUAV_STATUS, "MSG_ID_ASLUAV_STATUS", 14, 97, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_EKF_EXT, "MSG_ID_EKF_EXT", 32, 64, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(EkfExt)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_ASL_OBCTRL, "MSG_ID_ASL_OBCTRL", 33, 234, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(AslObctrl)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_SENS_ATMOS, "MSG_ID_SENS_ATMOS", 16, 144, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(SensAtmos)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_SENS_BATMON, "MSG_ID_SENS_BATMON", 41, 155, func(p mavlink.Packet) (mavlink.Message, error) {
		msg := new(SensBatmon)
		if err := msg.Unmarshal(p.Payload()); err != nil {
			return nil, err
		}
	...
	mavlink.Register(MSG_ID_FW_SOARING_DATA, "MSG_ID_FW_SOARING_DATA", 102, 20, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_SENSORPOD_STATUS, "MSG_ID_SENSORPOD_STATUS", 16, 54, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_SENS_POWER_BOARD, "MSG_ID_SENS_POWER_BOARD", 46, 222, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_GSM_LINK_STATUS, "MSG_ID_GSM_LINK_STATUS", 14, 200, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_SATCOM_LINK_STATUS, "MSG_ID_SATCOM_LINK_STATUS", 24, 23, func(p mavlink.Packet) (mavlink.Message, error) {
	...
	mavlink.Register(MSG_ID_SENSOR_AIRFLOW_ANGLES, "MSG_ID_SENSOR_AIRFLOW_ANGLES", 18, 149, func(p mavlink.Packet) (mavlink.Message, error) {
